...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Wl(){return new wi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Xl(){return new wi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
...
VINASSE`,a,5.5,s,16752736)}function Dg(n){const e=new Me({color:1728544}),t=new Me({color:2785344,transparent:!0,opacity:.8}),i=[[-7,-4],[-8,0],[-7,3],[-9,-2]];for(const[r,o]of i){const l=new C(new _t(2+Math.random()*1.5,1.2+Math.random()),t);l.rotation.x=-Math.PI/2,l.position.set(r,.85,o),n.add(l)}const a=[[-24,-18],[-20,18],[22,-14],[26,8],[-28,4],[16,20],[-12,-20],[18,-20]];for(const[r,o]of a)Ig(n,r,o,e);const s=new Me({color:9089088});for(let r=-3;r<=3;r++){const o=new C(new ge(.07,.09,3.5+Math.random(),6),s);o.position.set(-28+r*.4,1.75,-22+Math.random()*2),n.add(o)}}function Ig(n,e,t,i){const a=.6+Math.random()*.5,s=new C(new Bn(.6+Math.random()*.3,a,6),i);s.position.set(e,a/2,t),n.add(s)}function Ug(n){const e=new wt({color:6993128,side:Ht}),t=new C(new at(120,20,14),e);n.add(t);const i=new wt({color:16776672,side:At}),a=new C(new cn(8,24),i);a.position.set(30,22,-88),a.lookAt(0,14,0),n.add(a);const s=new wt({color:16774560,transparent:!0,opacity:.35,side:At}),r=new C(new cn(13,24),s);r.position.copy(a.position),r.rotation.copy(a.rotation),n.add(r);const o=new wt({color:16448250,transparent:!0,opacity:.88,side:At});[[0,22,-85,1.1],[-35,20,-78,.9],[50,21,-80,1],[-30,22,85,1],[35,20,80,.85],[-90,21,10,.9],[90,20,-5,.8]].forEach(([l,d,c,h])=>{const f=new L(l,d,c).normalize();[-1,0,1].forEach(p=>{const x=new L().crossVectors(f,new L(0,1,0)).normalize().clone().multiplyScalar(p*7*h),m=new C(new at(5*h,8,6),o);m.position.set(l+x.x,d+(p===0?2*h:0),c+x.z),n.add(m)})})}function Ng(n){const e=new wt({color:16744480,transparent:!0,opacity:.6,side:At}),t=new C(new xn(1.2,.25,10,32),e);t.position.set(_n.x,5.5,_n.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(_n.x,7,_n.z),a.visible=!1,n.add(a),{idx:0,pos:{x:_n.x,z:_n.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isValve:!0}}function Og(n,e){!n||n.done||(n.glowMat.opacity=.4+.35*Math.sin(e*3.5),n.glowMesh.rotation.z=e*1.2)}function _d(n,e,t,i,a,s){const r=new C(new oe(2.5,.8,.1),new wt({color:s}));r.position.set(t,i,a),n.add(r)}const ji=56,Ki=44,yn=new L(0,0,-14);function Fg(){const n=new da;n.background=new Ge(1715780),n.fog=new za(1583168,.012),n.add(new Bs(10537192,1));const e=new Mn(15267071,1.6);e.position.set(0,20,5),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.near=.5,e.shadow.camera.far=80,e.shadow.camera.left=-30,e.shadow.camera.right=30,e.shadow.camera.top=30,e.shadow.camera.bottom=-30,n.add(e);const t=new ti(6343935,2,28);t.position.set(yn.x,4,yn.z),n.add(t);const i=new Mn(9482448,.8);return i.position.set(-18,10,-10),n.add(i),{scene:n}}function zg(n){Bg(n),Hg(n),Gg(n),Vg(n),Wg(n)}function Bg(n){const e=new ae({color:1712688,roughness:.9,metalness:.05}),t=new ae({color:1846332,roughness:.85,metalness:0}),i=new ae({color:1120288,roughness:1,metalness:0}),a=ji/2,s=Ki/2,r=10,o=new C(new _t(ji,Ki),e);o.rotation.x=-Math.PI/2,o.receiveShadow=!0,n.add(o);const l=new C(new _t(ji,Ki),i);l.rotation.x=Math.PI/2,l.position.y=r,n.add(l);const d=[{pos:[0,r/2,-s],rot:[0,0,0],size:[ji,r]},{pos:[0,r/2,s],rot:[0,Math.PI,0],size:[ji,r]},{pos:[-a,r/2,0],rot:[0,Math.PI/2,0],size:[Ki,r]},{pos:[a,r/2,0],rot:[0,-Math.PI/2,0],size:[Ki,r]}];for(const f of d){const p=new C(new _t(...f.size),t);p.position.set(...f.pos),p.rotation.set(...f.rot),n.add(p)}const c=new wt({color:9488639});for(let f=-18;f<=18;f+=12){const p=new C(new oe(.3,.08,18),c);p.position.set(f,r-.05,0),n.add(p)}const h=new ua({color:1716304});for(let f=-a;f<=a;f+=4){const p=[new L(f,.01,-s),new L(f,.01,s)];n.add(new zn(new xt().setFromPoints(p),h))}for(let f=-s;f<=s;f+=4){const p=[new L(-a,.01,f),new L(a,.01,f)];n.add(new zn(new xt().setFromPoints(p),h))}}function Hg(n){const e=new ae({color:2767434,roughness:.7}),t=new ae({color:1714224,roughness:.8}),i=new ae({color:2130080,transparent:!0,opacity:.35,roughness:.1,metalness:.1}),a=new ae({color:2099712,transparent:!0,opacity:.85,roughness:.3}),s=new ae({color:4213328,roughness:.5,metalness:.3});[{x:-16,z:2},{x:0,z:2},{x:16,z:2}].forEach(({x:o,z:l})=>{const d=new C(new oe(8,.15,3.5),e);d.position.set(o,3.1,l),d.castShadow=!0,d.receiveShadow=!0,n.add(d);for(const[x,m]of[[-3.5,-1.4],[3.5,-1.4],[-3.5,1.4],[3.5,1.4]]){const u=new C(new oe(.15,3.1,.15),t);u.position.set(o+x,1.55,l+m),n.add(u)}const c=new C(new oe(3,1.6,1.6),i);c.position.set(o-1,4.1,l),n.add(c);const h=new C(new _t(2.8,1.5),a);h.rotation.x=-Math.PI/2,h.position.set(o-1,3.42,l),n.add(h);const f=new C(new oe(.5,.4,.4),s);f.position.set(o+2.2,3.35,l-.5),n.add(f);const p=new ae({color:8429712,roughness:.6}),g=new C(new ge(.04,.04,.9,8),p);g.position.set(o+1.8,3.75,l-.5),n.add(g)})}function Gg(n){const e=new ae({color:2767402,roughness:.8}),t=new ae({color:4214880,roughness:.6,metalness:.2}),i=new ae({color:6303776,roughness:.7}),a=new wt({color:4259788});for(let s=-18;s<=18;s+=18){const r=new C(new oe(8,6,.2),e);r.position.set(s,3,-22+.15),n.add(r);for(let o=0;o<3;o++){const l=new C(new oe(7.6,.08,.5),e);l.position.set(s,1.2+o*2,-22+.45),n.add(l);for(let c=-2;c<=2;c++){const h=.3+Math.random()*.5,f=new C(new ge(.18,.18,h,8),c%2===0?t:i);f.position.set(s+c*1.4,1.25+o*2+h/2,-22+.5),n.add(f)}const d=new C(new oe(6,.06,.08),a);d.position.set(s,1.18+o*2,-22+.6),n.add(d)}}}function Vg(n){const e=new ae({color:1714224,roughness:.6,metalness:.3}),t=new ae({color:6192,roughness:.1,metalness:.2,emissive:new Ge(16544),emissiveIntensity:.5}),i=new ae({color:3160128,roughness:.5,metalness:.5}),a=new ae({color:2765376,roughness:.8}),s=yn.x,r=yn.z,o=new C(new ge(.5,.65,3.4,16),e);o.position.set(s,1.7,r),o.castShadow=!0,n.add(o);const l=new C(new oe(2.4,1.8,.12),i);l.position.set(s,4.4,r),n.add(l);const d=new C(new oe(2.2,1.6,.06),t);d.position.set(s,4.4,r-.04),n.add(d);const c=new C(new oe(1.8,.06,.7),a);c.position.set(s,3.55,r+.3),n.add(c);const h=new wt({color:4245759});for(let m=0;m<3;m++){const u=new C(new oe(1.5,.02,.08),h);u.position.set(s,3.59,r+.12+m*.16),n.add(u)}const f=new wt({color:43775}),p=new C(new oe(2.8,.5,.08),f);p.position.set(s,5.7,r),n.add(p);const g=new wt({color:4259839}),x=new C(new oe(.3,.3,.1),g);x.position.set(s-1.3,4.4,r-.1),n.add(x)}function Wg(n){const e=ji/2,t=Ki/2,i=new ae({color:3689016,roughness:.8});for(const[l,d]of[[e-1.5,-t+1.2],[e-1.5,t-1.2]]){const c=new C(new oe(2.4,5,1.6),i);c.position.set(l,2.5,d),c.castShadow=!0,n.add(c);const h=new C(new oe(.06,.4,.06),new ae({color:10526816,metalness:.8,roughness:.2}));h.position.set(l-.7,2.5,d-.85),n.add(h)}const a=new ae({color:1720416,roughness:.9}),s=new wt({color:54527});for(const l of[-10,0,10]){const d=new C(new oe(.08,3,2.2),a);d.position.set(-e+.08,4.5,l),n.add(d);const c=new C(new oe(.04,2.4,.08),s);c.position.set(-e+.1,5.2,l),n.add(c)}const r=new ae({color:6963232,roughness:.9}),o=new ae({color:1728544,roughness:1});for(const[l,d]of[[-e+2,t-2],[-e+2,-t+2]]){const c=new C(new ge(.4,.3,.7,12),r);c.position.set(l,.35,d),n.add(c);const h=new C(new Bn(.7,1.4,8),o);h.position.set(l,1.4,d),n.add(h)}}function Xg(n){const e=new wt({color:52479,transparent:!0,opacity:.65,side:At}),t=new C(new xn(1.1,.2,10,32),e);t.position.set(yn.x,6.2,yn.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(yn.x,7.2,yn.z),a.visible=!1,n.add(a),{idx:0,pos:{x:yn.x,z:yn.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isTerminal:!0}}function qg(n,e){!n||n.done||(n.glowMat.opacity=.4+.3*Math.sin(e*4),n.glowMesh.rotation.z=e*1.5)}const $n=52,Yn=40,wn=new L(0,0,-12);function $g(){const n=new da;n.background=new Ge(1714748),n.fog=new za(1450032,.01),n.add(new Bs(11585760,1));const e=new Mn(14741759,1.6);e.position.set(5,18,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.near=.5,e.shadow.camera.far=80,e.shadow.camera.left=-28,e.shadow.camera.right=28,e.shadow.camera.top=28,e.shadow.camera.bottom=-28,n.add(e);const t=new ti(16768384,2.2,22);t.position.set(wn.x,5,wn.z),n.add(t);const i=new Mn(8425664,.7);return i.position.set(-15,8,-5),n.add(i),{scene:n}}function Yg(n){jg(n),Kg(n),Jg(n),Zg(n),Qg(n)}function jg(n){const e=new ae({color:1450030,roughness:.85,metalness:.05}),t=new ae({color:1582132,roughness:.9}),i=new ae({color:924200,roughness:1}),a=$n/2,s=Yn/2,r=9,o=new C(new _t($n,Yn),e);o.rotation.x=-Math.PI/2,o.receiveShadow=!0,n.add(o);const l=new C(new _t($n,Yn),i);l.rotation.x=Math.PI/2,l.position.y=r,n.add(l);const d=[{pos:[0,r/2,-s],rot:[0,0,0],size:[$n,r]},{pos:[0,r/2,s],rot:[0,Math.PI,0],size:[$n,r]},{pos:[-a,r/2,0],rot:[0,Math.PI/2,0],size:[Yn,r]},{pos:[a,r/2,0],rot:[0,-Math.PI/2,0],size:[Yn,r]}];for(const f of d){const p=new C(new _t(...f.size),t);p.position.set(...f.pos),p.rotation.set(...f.rot),n.add(p)}const c=new ua({color:1714746});for(let f=-a;f<=a;f+=3){const p=[new L(f,.01,-s),new L(f,.01,s)];n.add(new zn(new xt().setFromPoints(p),c))}for(let f=-s;f<=s;f+=3){const p=[new L(-a,.01,f),new L(a,.01,f)];n.add(new zn(new xt().setFromPoints(p),c))}const h=new wt({color:6334719});for(const[f,p,g,x]of[[0,-s+.1,$n,.1],[0,s-.1,$n,.1],[-a+.1,0,.1,Yn],[a-.1,0,.1,Yn]]){const m=new C(new oe(g,.06,x),h);m.position.set(f,r-.05,p),n.add(m)}}function Kg(n){const e=new ae({color:2635848,roughness:.7}),t=new ae({color:1581104,roughness:.8}),i=[new ae({color:1705216,transparent:!0,opacity:.9}),new ae({color:5908480,transparent:!0,opacity:.8}),new ae({color:8435776,transparent:!0,opacity:.7})],a=new ae({color:8965375,transparent:!0,opacity:.3,roughness:.05,metalness:.05});[[-14,6],[0,6],[14,6]].forEach(([r,o],l)=>{const d=new C(new oe(7,.12,3),e);d.position.set(r,3.1,o),d.castShadow=!0,d.receiveShadow=!0,n.add(d);for(const[g,x]of[[-3,-1.2],[3,-1.2],[-3,1.2],[3,1.2]]){const m=new C(new oe(.12,3.1,.12),t);m.position.set(r+g,1.55,o+x),n.add(m)}for(let g=0;g<3;g++){const x=new C(new ge(.3,.28,.8,12),a);x.position.set(r-1.8+g*1.8,3.56,o-.5),n.add(x);const m=.3+g*.1,u=new C(new ge(.27,.25,m,12),i[g]);u.position.set(r-1.8+g*1.8,3.17+m/2,o-.5),n.add(u)}const c=new ae({color:2113642,roughness:.9}),h=new C(new oe(1.2,.04,.9),c);h.position.set(r+2.5,3.18,o+.5),n.add(h);const f=new ae({color:4243616,roughness:.5,metalness:.3}),p=new C(new ge(.05,.05,1,8),f);p.position.set(r-2.8,3.75,o),p.rotation.z=.3,n.add(p)})}function Jg(n){const e=new ae({color:1579552,roughness:.5,metalness:.5}),t=new ae({color:2107440,roughness:.5,metalness:.6}),i=new ae({color:4227264,roughness:.1,metalness:.8}),a=new ae({color:2113696,roughness:.1,metalness:.9}),s=wn.x,r=wn.z,o=new C(new oe(3.5,.5,3),e);o.position.set(s,.25,r),o.castShadow=!0,n.add(o);const l=new C(new oe(.4,4,.4),t);l.position.set(s-.8,2.25,r),l.castShadow=!0,n.add(l);const d=new C(new oe(1.8,.35,.35),t);d.position.set(s+.1,4.1,r),n.add(d);const c=new C(new ge(.3,.35,1.2,16),i);c.position.set(s+.8,3.4,r),n.add(c);const h=new C(new ge(.1,.2,.5,12),i);h.position.set(s+.8,2.55,r),n.add(h);const f=new C(new ge(.18,.22,.6,12),a);f.position.set(s+.8,4.85,r),n.add(f);const p=new C(new oe(1.2,.06,1),e);p.position.set(s+.8,2.3,r),n.add(p);const g=new wt({color:16763968,transparent:!0,opacity:.7}),x=new C(new cn(.25,16),g);x.rotation.x=-Math.PI/2,x.position.set(s+.8,2.34,r),n.add(x)}function Zg(n){const e=new ae({color:794688,roughness:.9}),t=new wt({color:54527}),i=[new wt({color:16728128}),new wt({color:4259712})],a=new C(new oe(18,5.5,.1),e);a.position.set(0,4.5,-20+.12),n.add(a);const s=new C(new oe(17.6,.35,.08),t);s.position.set(0,6.95,-20+.17),n.add(s);for(let r=0;r<2;r++){const o=new C(new oe(15,.25,.06),i[r]);o.position.set(0,6-r*1.2,-20+.17),n.add(o);const l=r===0?[8,6.4,.4]:[.6,.5,.1];for(let d=0;d<3;d++){const c=new C(new oe(l[d],.55,.06),i[r]);c.position.set(-7.5+l[d]/2+d*5.2,5-r*1.2,-20+.17),n.add(c)}}}function Qg(n){const e=$n/2,t=Yn/2,i=new ae({color:2636344,roughness:.85});for(const s of[-12,0,12]){const r=new C(new oe(1.8,5,2),i);r.position.set(e-1,2.5,s),r.castShadow=!0,n.add(r)}const a=new ae({color:3817520,roughness:.9});for(const s of[-8,8]){const r=new C(new ge(.4,.35,.9,10),a);r.position.set(s,.45,t-2),n.add(r)}}function ex(n){const e=new wt({color:16763904,transparent:!0,opacity:.65,side:At}),t=new C(new xn(1,.2,10,32),e);t.position.set(wn.x+.8,5.8,wn.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(wn.x+.8,7,wn.z),a.visible=!1,n.add(a),{idx:0,pos:{x:wn.x+.8,z:wn.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isScope:!0}}function tx(n,e){!n||n.done||(n.glowMat.opacity=.4+.28*Math.sin(e*3.8),n.glowMesh.rotation.z=e*1.3)}const nx=.65;function Ie(n,e,t,i){return{minX:n-t,maxX:n+t,minZ:e-i,maxZ:e+i}}const xs=60,Or=40,Fr=70,zr=50,ix=[Ie(0,-20,xs/2+2,1.5),Ie(0,Or/2,xs/2+2,1.5),Ie(-30,0,1.5,Or/2+2),Ie(xs/2,0,1.5,Or/2+2),Ie(-16,5,3.6,1.8),Ie(0,-6,3.6,1.8),Ie(16,5,3.6,1.8),Ie(-28,0,2,11.5),Ie(xs/2-2,0,2,11.5),Ie(-20,-18.4,3.5,1.6)],ax=[Ie(0,-25,Fr/2+2,1.5),Ie(0,zr/2,Fr/2+2,1.5),Ie(-35,0,1.5,zr/2+2),Ie(Fr/2,0,1.5,zr/2+2),Ie(-18,6,2.8,2.8),Ie(0,-12,2,2.5),Ie(18,6,2.5,2.5),Ie(-26,-12,4,6),Ie(28,-13,3,6)],Br=60,Hr=50,sx=[Ie(0,-25,Br/2+2,1.5),Ie(0,Hr/2,Br/2+2,1.5),Ie(-30,0,1.5,Hr/2+2),Ie(Br/2,0,1.5,Hr/2+2),Ie(0,-8,11.6,.8),Ie(0,8,11.6,.8),Ie(-11,0,.8,8.6),Ie(11,0,.8,8.6),Ie(0,-10,.8,.8)];let sa=ix;function rx(){sa=ax}function ox(){sa=sx}const ya=56,Gr=44,lx=[Ie(0,-22,ya/2+2,1.5),Ie(0,Gr/2,ya/2+2,1.5),Ie(-28,0,1.5,Gr/2+2),Ie(ya/2,0,1.5,Gr/2+2),Ie(-16,2,4.5,2),Ie(0,2,4.5,2),Ie(16,2,4.5,2),Ie(0,-14,1.4,1.4),Ie(-18,-21.5,4.5,.8),Ie(0,-21.5,4.5,.8),Ie(18,-21.5,4.5,.8),Ie(ya/2-1.5,-10,1.5,1.5),Ie(ya/2-1.5,10,1.5,1.5)],Yi=52,Vr=40,cx=[Ie(0,-20,Yi/2+2,1.5),Ie(0,Vr/2,Yi/2+2,1.5),Ie(-26,0,1.5,Vr/2+2),Ie(Yi/2,0,1.5,Vr/2+2),Ie(-14,6,4,2),Ie(0,6,4,2),Ie(14,6,4,2),Ie(.8,-12,1.8,1.8),Ie(Yi/2-1,-12,1.5,1.5),Ie(Yi/2-1,0,1.5,1.5),Ie(Yi/2-1,12,1.5,1.5)];function dx(){sa=lx}function ux(){sa=cx}function hx(n,e,t){const i=nx;let a=n.x+e;for(const r of sa)a+i>r.minX&&a-i<r.maxX&&n.z+i>r.minZ&&n.z-i<r.maxZ&&(e>0?a=r.minX-i:a=r.maxX+i,e=a-n.x);let s=n.z+t;for(const r of sa)a+i>r.minX&&a-i<r.maxX&&s+i>r.minZ&&s-i<r.maxZ&&(t>0?s=r.minZ-i:s=r.maxZ+i,t=s-n.z);return{dx:e,dz:t}}const ee={playerName:"",currentLevel:1,totalPoints:0,levelAttempts:0,levelPoints:0,phenomenonIndex:0,answered:!1,wrongAnswers:0,levelBreakdown:[],pointsAtLevelStart:0,stage3:{valveOpened:!1},stage4:{selectedItems:[],reactorResult:null,terminalDone:!1},stage5:{scopeDone:!1},completedRooms:[]};function px(){ee.levelAttempts=0,ee.levelPoints=0,ee.phenomenonIndex=0,ee.answered=!1,ee.wrongAnswers=0}const fx={1:"Level 1 – Lab Sains",2:"Level 2 – Pabrik Etanol",3:"Level 3 – Kolam Remediasi",4:"Level 4 – Membuat Reaktor Sederhana",5:"Level 5 – Lab Observasi"};function yd(n){const e=ee.totalPoints-ee.pointsAtLevelStart;ee.levelBreakdown.push({level:n,label:fx[n]||`Level ${n}`,points:e})}class mx{constructor(e){this.scene=e,this.group=new Yt,this._build(),e.add(this.group),this.group.position.set(0,0,12),this.speed=.12,this.keys={},this._moving=!1,this._walkCycle=0,this._legAngle=0,this._armAngle=0,this._facingAngle=0,this._bindKeys(),this._bindTouch()}_bindKeys(){window.addEventListener("keydown",e=>{this.keys[e.code]=!0}),window.addEventListener("keyup",e=>{this.keys[e.code]=!1})}_bindTouch(){if(this._touchAxis={x:0,y:0},!(/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1))return;const t=document.getElementById("mobile-controls");t&&(t.style.display="block");const i=document.getElementById("joystick-base"),a=document.getElementById("joystick-knob");if(!i||!a)return;const s=32;let r=null,o=null,l=0,d=0;const c=p=>{if(r!==null)return;r=p.changedTouches[0].identifier,o=i.getBoundingClientRect(),l=o.left+o.width/2,d=o.top+o.height/2,p.preventDefault()},h=p=>{for(const g of p.changedTouches){if(g.identifier!==r)continue;const x=g.clientX-l,m=g.clientY-d,u=Math.sqrt(x*x+m*m),v=Math.min(u,s),b=Math.atan2(m,x),_=Math.cos(b)*v,k=Math.sin(b)*v;a.style.transform=`translate(calc(-50% + ${_}px), calc(-50% + ${k}px))`,this._touchAxis.x=_/s,this._touchAxis.y=-k/s,p.preventDefault()}},f=p=>{for(const g of p.changedTouches)g.identifier===r&&(r=null,a.style.transform="translate(-50%, -50%)",this._touchAxis.x=0,this._touchAxis.y=0)};i.addEventListener("touchstart",c,{passive:!1}),window.addEventListener("touchmove",h,{passive:!1}),window.addEventListener("touchend",f,{passive:!1}),window.addEventListener("touchcancel",f,{passive:!1})}_build(){const e=new ae({color:16108455,roughness:.7,metalness:0}),t=new ae({color:2719929,roughness:.6,metalness:.05}),i=new ae({color:2899536,roughness:.65,metalness:.05}),a=new ae({color:2890254,roughness:.8,metalness:0}),s=new ae({color:1710618,roughness:.6,metalness:.1}),r=new ae({color:16448250,roughness:.7,metalness:0}),o=new C(new ge(.48,.52,1.6,16),t);o.position.y=2.2,o.castShadow=!0,this.group.add(o),this._torso=o;const l=new C(new ge(.5,.54,1.58,16),r);l.position.y=2.2,this.group.add(l),this._coat=l;for(const g of[-1,1]){const x=new C(new at(.28,12,10),r);x.position.set(g*.62,2.9,0),this.group.add(x)}const d=new C(new at(.52,20,16),e);d.position.y=3.62,d.scale.set(1,1.05,1),d.castShadow=!0,this.group.add(d),this._head=d;const c=new C(new at(.54,16,10,0,Math.PI*2,0,Math.PI*.55),a);c.position.y=3.85,this.group.add(c);for(const g of[-1,1]){const x=new C(new at(.1,8,8),e);x.position.set(g*.53,3.65,0),this.group.add(x)}const h=new ae({color:1710618});for(const g of[-1,1]){const x=new C(new at(.07,8,8),h);x.position.set(g*.2,3.72,.47),this.group.add(x)}const f=new ae({color:13936778}),p=new C(new at(.05,8,8),f);p.position.set(0,3.58,.52),this.group.add(p),this._legs=[];for(const[g,x]of[[-1,-1],[1,1]]){const m=new Yt;m.position.set(x*.3,1.55,0);const u=new C(new ge(.2,.18,.72,12),i);u.position.y=-.36,u.castShadow=!0,m.add(u);const v=new Yt;v.position.y=-.72,m.add(v);const b=new C(new ge(.16,.14,.64,12),i);b.position.y=-.32,b.castShadow=!0,v.add(b);const _=new C(new So(.13,.3,6,10),s);_.rotation.x=Math.PI/2,_.position.set(0,-.68,.12),v.add(_),this.group.add(m),this._legs.push({pivot:m,kneePivot:v,side:x,i:g===-1?0:1})}this._arms=[];for(const[g,x]of[[-1,-1],[1,1]]){const m=new Yt;m.position.set(x*.76,2.92,0);const u=new C(new ge(.16,.14,.62,12),r);u.position.y=-.31,u.castShadow=!0,m.add(u);const v=new Yt;v.position.y=-.62,m.add(v);const b=new C(new ge(.13,.12,.56,12),e);b.position.y=-.28,v.add(b);const _=new C(new at(.13,10,8),e);_.position.y=-.6,v.add(_),this.group.add(m),this._arms.push({pivot:m,elbowPivot:v,side:x,i:g===-1?0:1})}this._nameLabel=null}setName(e){if(this._nameLabel&&this.group.remove(this._nameLabel),!e)return;const t=document.createElement("canvas");t.width=256,t.height=64;const i=t.getContext("2d");i.clearRect(0,0,256,64),i.fillStyle="rgba(15,25,40,0.8)",i.roundRect(4,4,248,56,12),i.fill(),i.fillStyle="#2ecc71",i.font="bold 26px Segoe UI, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(e,128,32);const a=new Fs(t),s=new ai({map:a,transparent:!0}),r=new Ai(s);r.scale.set(3.5,.9,1),r.position.y=5.2,this._nameLabel=r,this.group.add(r)}update(e,t=!1,i=null){const a=this.keys;let s=0,r=0;if((a.KeyW||a.ArrowUp)&&(s+=1),(a.KeyS||a.ArrowDown)&&(s-=1),(a.KeyA||a.ArrowLeft)&&(r-=1),(a.KeyD||a.ArrowRight)&&(r+=1),this._touchAxis&&(s+=this._touchAxis.y,r+=this._touchAxis.x,s=Math.max(-1,Math.min(1,s)),r=Math.max(-1,Math.min(1,r))),this._moving=s!==0||r!==0,this._moving&&!t){let o=0,l=0;const d=s<0;if(d&&i){o=i.fwd.x*s+i.right.x*r,l=i.fwd.z*s+i.right.z*r;const p=Math.sqrt(o*o+l*l)||1;o=o/p*this.speed,l=l/p*this.speed}else if(d)o=-Math.sin(this._facingAngle)*this.speed,l=-Math.cos(this._facingAngle)*this.speed;else if(i){o=i.fwd.x*s+i.right.x*r,l=i.fwd.z*s+i.right.z*r;const p=Math.sqrt(o*o+l*l)||1;o=o/p*this.speed,l=l/p*this.speed}else{o=r,l=-s;const p=Math.sqrt(o*o+l*l)||1;o=o/p*this.speed,l=l/p*this.speed}({dx:o,dz:l}=hx(this.group.position,o,l)),this.group.position.x+=o,this.group.position.z+=l;const c=ee.currentLevel===2?33:ee.currentLevel===3?27:28,h=ee.currentLevel===2?23:ee.currentLevel===3?22:18;this.group.position.x=Math.max(-c,Math.min(c,this.group.position.x)),this.group.position.z=Math.max(-h,Math.min(h,this.group.position.z)),d||(this._facingAngle=Math.atan2(o,l)),this.group.rotation.y=this._facingAngle,this._walkCycle+=.18;const f=this._walkCycle;for(const{pivot:p,kneePivot:g,i:x}of this._legs){const m=f+x*Math.PI,u=Math.sin(m)*.55;p.rotation.x=u;const v=Math.max(0,-Math.sin(m)*.45);g.rotation.x=v}for(const{pivot:p,elbowPivot:g,side:x,i:m}of this._arms){const u=f+(1-m)*Math.PI,v=Math.sin(u)*.42;p.rotation.x=v,p.rotation.z=x*(.08+Math.sin(u+Math.PI*.5)*.06),g.rotation.x=Math.max(0,Math.sin(u+.4)*.28)}this._torso&&(this._torso.rotation.y=Math.sin(f+Math.PI)*.08),this._coat&&(this._coat.rotation.y=Math.sin(f+Math.PI)*.08),this._head&&(this._head.position.y=3.62+Math.abs(Math.sin(f*2))*.06),this.group.position.y=Math.abs(Math.sin(f*2))*.055}else{this._walkCycle=0;for(const{pivot:o,kneePivot:l}of this._legs)o.rotation.x*=.75,l.rotation.x*=.75;for(const{pivot:o,elbowPivot:l,side:d}of this._arms)o.rotation.x*=.75,o.rotation.z+=(d*.08-o.rotation.z)*.15,l.rotation.x*=.75;this._torso&&(this._torso.rotation.y*=.8),this._coat&&(this._coat.rotation.y*=.8),this._head&&(this._head.position.y=3.62+Math.sin(e*1.2)*.02),this.group.position.y=Math.sin(e*1.4)*.04}return{x:this.group.position.x,z:this.group.position.z}}get position(){return this.group.position}removeFromScene(e){e.remove(this.group)}addToScene(e){this.scene=e,e.add(this.group)}}const gx=[{id:1,title:"Fenomena 1",image:null,tableData:{headers:["Stasiun","Suhu (°C)","pH","DO (mg/L)","COD (mg/L)","TDS (mg/L)"],rows:[{label:"Hulu",values:["30,39","7,26","8,38","635","777"],classes:["","","blue","",""]},{label:"Tengah",values:["31,17","6,96","1,90","775","1.343"],classes:["","","red","","red"]},{label:"Hilir",values:["29,63","7,36","11,12","879","1.300"],classes:["","","","red",""]}],note:"Biru: rata-rata terendah | Merah: rata-rata tertinggi. Sumber: Zahra, 2023"},context:"Seorang peneliti lingkungan mengamati data kualitas air sungai di stasiun berbeda, yaitu: hulu, tengah, dan hilir dari aliran anak Sungai Bengawan solo yang berdekatan dengan pabrik etanol. Data menunjukkan:",question:"Berdasarkan data, Stasiun Tengah menunjukkan nilai TDS melonjak drastis menjadi 1.343 mg/L, namun nilai DO justru berada di angka 1,90 mg/L dengan COD 90.000 mg/L. Jika diketahui sumber pencemar adalah limbah vinasse yang kaya bahan organik, manakah evaluasi paling kritis mengenai data tersebut?",options:[{label:"A",text:"Tingginya TDS disebabkan oleh mineral anorganik, sedangkan seluruh bakteri telah terurai oleh bakteri dari hulu ke tengah.",correct:!1},{label:"B",text:"Masuknya limbah vinasse seharusnya meningkatkan TDS, DO, dan COD secara simultan.",correct:!0},{label:"C",text:"TDS, COD, dan DO memiliki hubungan yang terbalik, semakin banyak zat terlarut, semakin sedikit oksigen yang dibutuhkan.",correct:!1}],correctKey:"B",explanation:"✅ <strong>Jawaban benar!</strong><br>Limbah organik vinasse seharusnya berkontribusi pada TDS dan COD. Jika TDS dan COD naik tajam karena limbah masuk, DO seharusnya tidak turun drastis."},{id:2,title:"Fenomena 2",image:null,tableData:null,standardTable:{title:"Baku Mutu Air Limbah Industri Bir/Etanol (Permen LH No.5/2014)",headers:["Parameter","Kadar Maks (mg/L)","Beban Maks (g/hL)"],rows:[["BOD₅","40","24,0"],["COD","100","60,0"],["TSS","40","24,0"],["pH","6,0 – 9,0","—"],["Debit limbah maks","—","6 hL/hL produk"]]},context:"Berdasarkan data Stasiun Tengah nilai TDS 1.343 mg/L, COD 90.000 mg/L dan DO 1,90 mg/L, komponen apakah yang paling dominan menyusun nilai TDS tersebut?",question:"Berdasarkan data Stasiun Tengah nilai TDS 1.343 mg/L, COD 90.000 mg/L dan DO 1,90 mg/L, komponen apakah yang paling dominan menyusun nilai TDS tersebut?",options:[{label:"A",text:"Adanya bakteri coliform dan mikroorganisme pengurai.",correct:!1},{label:"B",text:"Ion anorganik seperti K, Ca dan Cl yang tidak dapat dioksidasi.",correct:!0},{label:"C",text:"Suspensi padatan lumpur yang belum mengendap.",correct:!1}],correctKey:"B",explanation:"✅ <strong>Jawaban benar!</strong><br>Ion anorganik seperti K, Ca dan Cl yang tidak dapat dioksidasi mendominasi nilai TDS di Stasiun Tengah."},{id:3,title:"Fenomena 3",image:null,riceGraph:!0,tableData:null,context:"Perhatikan grafik produktivitas lahan persawahan padi berikut:",question:"Manakah interpretasi ilmiah yang paling tepat menjelaskan mekanisme penyebab fenomena penurunan hasil panen padi tersebut?",options:[{label:"A",text:"Kenaikan hasil panen di Tahun ke-2 terjadi karena suplai bahan organik berada di bawah ambang batas pencemaran sehingga justru memperkaya hara tanah, namun pada Tahun ke-3 akumulasi pH dan COD telah menyebabkan kerusakan pada jaringan akar padi.",correct:!0},{label:"B",text:"Penurunan hasil panen pada Tahun ke-3 disebabkan oleh kurangnya pasokan air, karena tingginya nilai COD menyebabkan air menjadi kental dan sulit diserap oleh akar tanaman.",correct:!1},{label:"C",text:"Peningkatan hasil panen pada Tahun ke-2 disebabkan oleh bakteri patogen dalam limbah yang memicu mutasi genetik pada padi menjadi varietas unggul, sedangkan penurunan di Tahun ke-3 adalah fase kematian alami bakteri tersebut.",correct:!1}],correctKey:"A",explanation:"✅ <strong>Jawaban benar!</strong><br>Meskipun COD naik menjadi 80, pH tanah sebesar 8,6 masih dalam rentang toleransi padi. Bahan organik dalam limbah vinasse mengandung N, P, dan K. Pada tahap ini, efek negatif belum mendominasi, sehingga tanaman justru merespons positif terhadap tambahan nutrisi tersebut. Ketika COD mencapai >100 mg/L dan pH >9 kondisi tanah menjadi toksik. pH yang tinggi menyebabkan ion logam di tanah menjadi larut dan meracuni akar, serta menghambat penyerapan Fosfor. Hal ini menyebabkan tanaman gagal tumbuh."}],wa={phenomena:gx},xx=879,vx=635,vs=1e3;function bx(n){const e=Math.max(0,Math.min(vs,n)),t=vs-e,i=e/vs,a=Math.round(xx*i),s=Math.round(vx*i),r=Math.pow(10,-3.8),o=Math.pow(10,-7),l=(r*e+o*t)/vs,d=Math.max(3.5,Math.min(7,-Math.log10(l)));return{cod:a,bod:s,ph:parseFloat(d.toFixed(2)),dilutionFactor:i}}function _x(n,e){const t=Math.max(0,Math.min(72,e)),i=Math.round(n.bod*Math.exp(-.08*t)),a=n.bod-i,s=n.cod*.55,r=n.cod*.45,o=s*Math.exp(-.08*t),l=Math.round(o+r),d=parseFloat(Math.min(6.8,n.ph+(6.8-n.ph)*(1-Math.exp(-.08*.5*t))).toFixed(2)),c=n.bod>0?Math.round(a/n.bod*100):0,h=n.cod>0?Math.round((n.cod-l)/n.cod*100):0,f=i<=40&&l<=100;return{cod:l,bod:i,ph:d,bodRemovalPct:c,codRemovalPct:h,compliant:f}}const wd="biovine_scores",Ao="biovine_checkpoint";function yx({playerName:n,totalPoints:e,levelBreakdown:t,completedAt:i,essayAnswer:a}){const s=wx();s.push({playerName:n,totalPoints:e,levelBreakdown:t,completedAt:i,essayAnswer:a}),s.length>200&&s.splice(0,s.length-200);try{localStorage.setItem(wd,JSON.stringify(s))}catch(r){console.warn("[db] saveScore failed:",r)}}function wx(){try{return JSON.parse(localStorage.getItem(wd)||"[]")}catch{return[]}}function Mx({playerName:n,currentLevel:e,totalPoints:t,levelBreakdown:i,completedRooms:a}){const s={playerName:n,currentLevel:e,totalPoints:t,levelBreakdown:i||[],completedRooms:a||[],savedAt:new Date().toISOString()};try{localStorage.setItem(Ao,JSON.stringify(s))}catch(r){console.warn("[db] saveCheckpoint failed:",r)}}function Lo(){try{const n=localStorage.getItem(Ao);return n?JSON.parse(n):null}catch{return null}}function Md(){localStorage.removeItem(Ao)}const ko="https://script.google.com/macros/s/AKfycbys_sNNVIFJCQGmvNHUMuiLpZGINttOvNN5LnIJ8z5Gak8h8KQ8BdTo342_K5H05RxbXw/exec";function Sx(n){const{playerName:e,totalPoints:t,levelBreakdown:i,completedRooms:a}=ee,s={1:null,2:null,3:null,4:null,5:null};i.forEach(l=>{s[l.level]=l.points});const r=s[n]??0,o={playerName:e,totalPoints:t,completedLevel:n,thisLevelPoints:r,level1Points:s[1],level2Points:s[2],level3Points:s[3],level4Points:s[4],level5Points:s[5],completedRooms:a,timestamp:new Date().toISOString()};fetch(ko,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(o)}).catch(l=>{console.warn("[sheets] Upload failed (network error):",l)})}function Ex(n){const e={sheet:"Kelompok",...n};return fetch(ko,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(e)}).catch(t=>{throw console.warn("[sheets] Experiment upload failed (network error):",t),t})}function Tx(n){const e={sheet:"Esai",playerName:n.playerName||"",essayAnswer:n.essayAnswer||"",timestamp:n.timestamp||new Date().toISOString()};fetch(ko,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(e)}).catch(t=>{console.warn("[sheets] Essay upload failed (network error):",t)})}const pn=n=>document.getElementById(n),Co="experiment-form-overlay",vc="experiment-form-css";function Ax(){if(document.getElementById(vc))return;const n=document.createElement("style");n.id=vc,n.textContent=`
  ...
  `,document.head.appendChild(n)}function Lx(){const n=document.createElement("div");return n.id=Co,n}function Wr(){var n;(n=document.getElementById(Co))==null||n.remove()}function bs(n){return["warna","bau","keruh","ph","sal","tds","cod","bod","do"].map(t=>`<td><input type="text" class="exp-cell" id="${n}-${t}" /></td>`).join("")}function Ro(){Ax(),Wr();const n=Lx();n.innerHTML=`
    <div class="exp-card">
  ...
  `,document.body.appendChild(n),pn("exp-close").onclick=Wr,n.addEventListener("click",t=>{t.target===n&&Wr()}),pn("exp-submit").onclick=()=>{const t=pn("exp-kelompok").value.trim(),i=pn("exp-kelas").value.trim();if(!t||!i){e("⚠️ Nomor Kelompok dan Kelas wajib diisi!",!1);return}const a=["warna","bau","keruh","ph","sal","tds","cod","bod","do"];function s(l){return Object.fromEntries(a.map(d=>{var c;return[d,((c=pn(`${l}-${d}`))==null?void 0:c.value.trim())||"–"]}))}const r={nomorKelompok:t,kelas:i,namaAnggota:pn("exp-nama").value.trim()||"–",playerName:ee.playerName||"–",timestamp:new Date().toISOString(),mikroorganisme:pn("t1-mikro").value.trim()||"–",intensitasCahaya:pn("t1-cahaya").value.trim()||"–",suhuRuang:pn("t1-suhu").value.trim()||"–",awalDengan:s("awal-dg"),awalTanpa:s("awal-tp"),akhirDengan:s("akhir-dg"),akhirTanpa:s("akhir-tp")},o=pn("exp-submit");o.disabled=!0,o.textContent="⏳ Mengirim…",Ex(r).then(()=>{e("✅ Berhasil! Data percobaan kelompokmu telah dikirimkan.",!0),o.textContent="✅ Terkirim"}).catch(()=>{e("❌ Gagal mengirim. Periksa koneksi internet dan coba lagi.",!1),o.disabled=!1,o.textContent="📤 Kirim Ulang"})};function e(t,i){const a=pn("exp-status");a.className="exp-status "+(i?"ok":"err"),a.innerHTML=t,a.scrollIntoView({behavior:"smooth",block:"nearest"})}}const _e=n=>document.getElementById(n);let oo=null,Xr=null;function kx(n,e){oo=n,Xr=e||null;const t=Lo(),i=_e("resume-section");if(t&&i&&Xr){const a=new Date(t.savedAt),s=a.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})+" "+a.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"});i.classList.remove("hidden"),i.innerHTML=`
    ...
    `).join("")}_e("btn-start-game").onclick=()=>{_e("instructions-screen").classList.add("hidden"),n()}}function bc(){Ad(()=>{});const n=_e("btn-start-game");n.textContent="✕ Tutup Petunjuk"}function Ix(){jt(),_e("btn-glossary").onclick=()=>lo(),_e("btn-instructions-hud").onclick=()=>bc();const n=document.getElementById("btn-instructions-hud-mobile"),e=document.getElementById("btn-glossary-mobile"),t=document.getElementById("btn-pause-menu-mobile");n&&n.addEventListener("touchstart",i=>{i.preventDefault(),bc()},{passive:!1}),e&&e.addEventListener("touchstart",i=>{i.preventDefault(),lo()},{passive:!1}),t&&t.addEventListener("touchstart",i=>{i.preventDefault(),_e("btn-pause-menu").click()},{passive:!1})}function Ux(n,e,t){const i=_e("pause-menu-overlay");_e("btn-pause-menu").onclick=()=>{const a=Lo(),s=_e("pause-checkpoint-info"),r=_e("btn-pm-resume");if(a){const o=new Date(a.savedAt),l=o.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})+" "+o.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"});s.innerHTML=`💾 Checkpoint tersimpan: <strong>${a.playerName}</strong> · Level ${a.currentLevel} · ${a.totalPoints} poin<br><small style="color:#aaa">${l}</small>`,r.disabled=!1,r.title=""}else s.innerHTML='<span style="color:#aaa">Belum ada checkpoint tersimpan.</span>',r.disabled=!0,r.title="Tidak ada checkpoint tersimpan";i.classList.remove("hidden")},_e("btn-pm-continue").onclick=()=>{i.classList.add("hidden")},_e("btn-pm-resume").onclick=()=>{i.classList.add("hidden"),n()},_e("btn-pm-newgame").onclick=()=>{confirm("Yakin ingin memulai ulang? Semua progres sesi ini akan hilang.")&&(i.classList.add("hidden"),e())},_e("btn-pm-experiment").onclick=()=>{i.classList.add("hidden"),Ro()},_e("btn-pm-change-level").onclick=()=>{i.classList.add("hidden"),Fx(a=>{t&&t(a)})},i.addEventListener("click",a=>{a.target===i&&i.classList.add("hidden")})}function jt(){_e("hud-player").textContent=ee.playerName||"Pemain",_e("hud-level").textContent=`Level ${ee.currentLevel}`,_e("hud-points").textContent=ee.totalPoints;const n=_e("hud-attempts");n.innerHTML="";for(let e=0;e<3;e++){const t=document.createElement("div");t.className="attempt-dot"+(e<ee.levelAttempts?" used":""),n.appendChild(t)}}function Po(n){const e=/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1;let t=_e("interact-prompt");t||(t=document.createElement("div"),t.id="interact-prompt",t.style.cssText=`
  ...
  `,document.body.appendChild(e),e.querySelector("#btn-gc-close").onclick=()=>{e.remove(),jt()},e.querySelector("#btn-gc-restart").onclick=()=>{e.remove(),window.location.reload()},e.querySelector("#btn-gc-experiment").onclick=()=>{Ro()}}function Ld(n,e,t,i=!1){const a=wa.phenomena[n],s=_e("stage-screen");ee.wrongAnswers=0;const r=s.querySelector(".stage-panel");r&&r.remove();const o=document.createElement("div");o.className="stage-panel fade-in",o.innerHTML=`
  ...
  `,_e("btn-profile-start").onclick=()=>{const t=_e("input-name").value.trim();if(!t){_e("input-name").style.borderColor="#e74c3c",_e("input-name").focus();return}ee.playerName=t,Sd(),oo&&oo(t)},_e("input-name").addEventListener("keydown",t=>{t.key==="Enter"&&_e("btn-profile-start").click()}),setTimeout(()=>{const t=_e("btn-close-glossary");t&&(t.onclick=()=>lo());let i=1;const a=2;function s(){_e("glossary-page-1").classList.toggle("hidden",i!==1),_e("glossary-page-2").classList.toggle("hidden",i!==2),_e("glossary-page-indicator").textContent=`${i} / ${a}`,_e("btn-glossary-prev").disabled=i===1,_e("btn-glossary-next").disabled=i===a;const l=_e("glossary-modal").querySelector(".glossary-card");l&&(l.scrollTop=0)}_e("btn-glossary-next").onclick=()=>{i<a&&(i++,s())},_e("btn-glossary-prev").onclick=()=>{i>1&&(i--,s())};const r=_e("glossary-modal");new MutationObserver(()=>{r.classList.contains("hidden")||(i=1,s())}).observe(r,{attributes:!0,attributeFilter:["class"]})},100)}const Qe=n=>document.getElementById(n);function qx(n){Qx();const e=Qe("sim-overlay");e&&e.remove();const t=document.createElement("div");t.id="sim-overlay",t.className="sim-overlay",t.innerHTML=$x(),document.body.appendChild(t),requestAnimationFrame(()=>{Yx(t,n)})}function $x(){return`
    <div class="sim-card">
      <!-- Header -->
  ...
  `}function Yx(n,e){let t=0,i=null,a=null,s=!1,r=null;{let se=function(){document.getElementById("vol-display-num").textContent=t,document.getElementById("vol-display-water").textContent=1e3-t},P=function(Y){const me=document.getElementById(`vglass-liq-${Y}`),fe=document.getElementById(`vglass-${Y}`);!me||!fe||(me.style.height=E[Y]/200*100+"%",E[Y]<=0&&(fe.classList.add("empty"),fe.classList.remove("dragging")))},F=function(){const Y=document.getElementById("beaker-drops");if(!Y)return;const me=document.createElement("div");me.className="sim-drop",me.style.setProperty("--spread",(Math.random()-.5)*10+"px"),me.style.setProperty("--dur",.28+Math.random()*.24+"s"),Y.appendChild(me),setTimeout(()=>me.remove(),600)},X=function(){T||y===null||(T=setInterval(()=>{if(y===null||E[y]<=0||t>=1e3){ne();return}const Y=Math.min(25,E[y],1e3-t);E[y]-=Y,t=Math.min(1e3,t+Y),qr(t),se(),Qe("btn-titrate").disabled=!1;const me=document.getElementById("vg-ghost-liquid");me&&(me.style.height=E[y]/200*100+"%"),P(y)},80),N=setInterval(F,55))},ne=function(){clearInterval(T),clearInterval(N),T=N=null},$=function(Y,me){I.style.left=Y-18+"px",I.style.top=me-64+"px";const fe=document.getElementById("beaker-drop-zone");if(!fe)return;const Ce=fe.getBoundingClientRect(),Ue=Y>=Ce.left&&Y<=Ce.right&&me>=Ce.top&&me<=Ce.bottom;Ue!==H&&(H=Ue,fe.classList.toggle("active",Ue),I.classList.toggle("tilting",Ue),Ue?X():ne())},K=function(Y,me,fe){var Ue;if(E[Y]<=0)return;y=Y,H=!1,(Ue=document.getElementById(`vglass-${Y}`))==null||Ue.classList.add("dragging"),I.classList.remove("hidden");const Ce=document.getElementById("vg-ghost-liquid");Ce&&(Ce.style.height=E[Y]/200*100+"%"),$(me,fe)},J=function(){var me,fe;if(y===null)return;ne(),P(y),(me=document.getElementById(`vglass-${y}`))==null||me.classList.remove("dragging"),y=null,H=!1,I.classList.add("hidden"),I.classList.remove("tilting"),(fe=document.getElementById("beaker-drop-zone"))==null||fe.classList.remove("active");const Y=document.getElementById("beaker-drop-label");Y&&(Y.textContent=t>0?`✓ ${t} mL dituang — seret gelas lagi untuk menambah`:"Jatuhkan di sini")},V=function(Y){y!==null&&$(Y.clientX,Y.clientY)},Z=function(){J()},O=function(Y){y!==null&&($(Y.touches[0].clientX,Y.touches[0].clientY),Y.preventDefault())},te=function(){J()};var o=se,l=P,d=F,c=X,h=ne,f=$,p=K,g=J,x=V,m=Z,u=O,v=te;const E=Array(5).fill(200);t=0,qr(0);const I=document.createElement("div");I.id="vg-ghost",I.className="vg-ghost hidden",I.innerHTML='<div class="vg-ghost-liquid" id="vg-ghost-liquid"></div>',document.body.appendChild(I);let y=null,T=null,N=null,H=!1;for(let Y=0;Y<5;Y++){const me=document.getElementById(`vglass-${Y}`);me&&(me.addEventListener("mousedown",fe=>{K(Y,fe.clientX,fe.clientY),fe.preventDefault()}),me.addEventListener("touchstart",fe=>{K(Y,fe.touches[0].clientX,fe.touches[0].clientY),fe.preventDefault()},{passive:!1}))}window.addEventListener("mousemove",V),window.addEventListener("mouseup",Z),window.addEventListener("touchmove",O,{passive:!1}),window.addEventListener("touchend",te),document.getElementById("btn-reset-pour").onclick=()=>{var me;J(),t=0;for(let fe=0;fe<5;fe++)E[fe]=200,P(fe),(me=document.getElementById(`vglass-${fe}`))==null||me.classList.remove("empty");qr(0),se(),Qe("btn-titrate").disabled=!0;const Y=document.getElementById("beaker-drop-label");Y&&(Y.textContent="Jatuhkan di sini")},r=()=>{J(),window.removeEventListener("mousemove",V),window.removeEventListener("mouseup",Z),window.removeEventListener("touchmove",O),window.removeEventListener("touchend",te);const Y=document.getElementById("vg-ghost");Y&&Y.remove()}}Qe("btn-titrate").onclick=()=>{r&&(r(),r=null),i=bx(t),$r("sim-step-1","sim-step-2"),jx(t)},Qe("btn-go-aerate").onclick=()=>{$r("sim-step-2","sim-step-3"),Kx(i)},Qe("aerator-toggle").onchange=function(){s=this.checked;const b=Qe("aerator-status");b.textContent=s?"NYALA":"MATI",b.className=s?"status-on":"status-off",Qe("aerator-machine").classList.toggle("running",s),Jx(s),s?Qe("duration-wrap").classList.remove("locked"):(Qe("duration-wrap").classList.add("locked"),a=null,n.querySelectorAll(".dur-btn").forEach(_=>_.classList.remove("active")),Qe("btn-calc-result").classList.add("hidden"))},n.querySelectorAll(".dur-btn").forEach(b=>{b.onclick=()=>{s&&(n.querySelectorAll(".dur-btn").forEach(_=>_.classList.remove("active")),b.classList.add("active"),a=parseInt(b.dataset.hours),Qe("btn-calc-result").classList.remove("hidden"))}}),Qe("btn-calc-result").onclick=()=>{const b=_x(i,a);$r("sim-step-3","sim-step-4"),Zx(i,b,t,a),Qe("btn-sim-finish").classList.remove("hidden"),Qe("btn-sim-finish").onclick=()=>{Qe("sim-overlay").remove(),e&&e()}}}const ys={200:{doVal:1.8,tds:22,ph:2.2,sal:13},400:{doVal:2.3,tds:26,ph:2.8,sal:13.8},600:{doVal:3.2,tds:27,ph:3,sal:14},800:{doVal:4,tds:30.1,ph:3.7,sal:15}};function kd(n){const e=[200,400,600,800];if(n<=200)return{...ys[200]};if(n>=800)return{...ys[800]};let t=200,i=800;for(let o=0;o<e.length-1;o++)if(n>e[o]&&n<=e[o+1]){t=e[o],i=e[o+1];break}const a=(n-t)/(i-t),s=ys[t],r=ys[i];return{doVal:parseFloat((s.doVal+(r.doVal-s.doVal)*a).toFixed(1)),tds:parseFloat((s.tds+(r.tds-s.tds)*a).toFixed(1)),ph:parseFloat((s.ph+(r.ph-s.ph)*a).toFixed(1)),sal:parseFloat((s.sal+(r.sal-s.sal)*a).toFixed(1))}}function jx(n,e){const t=n/1e3*100,i=Qe("meter-bk-vinasse");i&&(i.style.height=t+"%");const a=Qe("meter-vol-label");a&&(a.textContent=n+" mL");const s=Qe("meter-bk-ripple"),r=kd(n),o=Qe("meter-probe-stick"),l=Qe("meter-beaker");let d=!1,c=null;function h(){c&&(c.remove(),c=null),window.removeEventListener("mousemove",p),window.removeEventListener("mouseup",x),window.removeEventListener("touchmove",g),window.removeEventListener("touchend",x)}function f(v){return v.changedTouches?{x:v.changedTouches[0].clientX,y:v.changedTouches[0].clientY}:v.touches?{x:v.touches[0].clientX,y:v.touches[0].clientY}:{x:v.clientX,y:v.clientY}}function p(v){if(!c)return;const{x:b,y:_}=f(v);c.style.left=b-15+"px",c.style.top=_-12+"px";const k=l.getBoundingClientRect();l.classList.toggle("drop-hover",b>=k.left&&b<=k.right&&_>=k.top&&_<=k.bottom)}function g(v){v.preventDefault(),p(v)}function x(v){if(!c)return;const{x:b,y:_}=f(v),k=l.getBoundingClientRect(),M=b>=k.left&&b<=k.right&&_>=k.top&&_<=k.bottom;h(),l.classList.remove("drop-hover"),M&&!d?(d=!0,o.classList.add("probe-dipped"),u()):o.style.opacity="1"}function m(v){if(d)return;v.preventDefault(),o.style.opacity="0.35",c=document.createElement("div"),c.className="meter-probe-ghost",c.innerHTML='<div class="mps-handle">⊕</div><div class="mps-shaft"></div><div class="mps-tip"></div>';const{x:b,y:_}=f(v);c.style.left=b-15+"px",c.style.top=_-12+"px",document.body.appendChild(c),window.addEventListener("mousemove",p),window.addEventListener("mouseup",x),window.addEventListener("touchmove",g,{passive:!1}),window.addEventListener("touchend",x)}function u(){Qe("meter-instruction").textContent="Sensor mendeteksi parameter larutan…",setTimeout(()=>{s&&(s.classList.remove("ripple-active"),s.offsetWidth,s.classList.add("ripple-active"))},300),setTimeout(()=>{ws("mr-do",r.doVal,1200,1),ws("mr-tds",r.tds,1200,1),ws("mr-ph",r.ph,1200,2),ws("mr-sal",r.sal,1200,1)},500),setTimeout(()=>{Qe("meter-instruction").textContent="✅ Pengukuran selesai — catat hasil parameter!";const v=Qe("meter-result-grid");v.innerHTML=[{icon:"💧",label:"DO",value:r.doVal.toFixed(1)+" ppm",sub:"Dissolved Oxygen",status:r.doVal<2?"danger":r.doVal<4?"warn":"good"},{icon:"📊",label:"TDS",value:r.tds.toFixed(1)+" ppm",sub:"Total Dissolved Solids",status:r.tds>30?"danger":r.tds>25?"warn":"good"},{icon:"⚗️",label:"pH",value:r.ph.toFixed(1),sub:r.ph<4?"Sangat Asam ⚠️":r.ph<6?"Asam":"Mendekati Netral",status:r.ph<4?"danger":r.ph<6?"warn":"good"},{icon:"🧂",label:"Salinometer",value:r.sal.toFixed(1)+" ‰",sub:"Kadar salinitas",status:r.sal>15?"danger":r.sal>13?"warn":"good"}].map(_=>`
      ...
      `).join(""),v.classList.remove("hidden");const b=Qe("meter-note");b.innerHTML=`⚗️ <strong>Interpretasi:</strong> Dengan ${n} mL vinasse,
        ...
        <div class="meter-source">📄 Sumber: Irmanto, et al. (2013)</div>`,b.classList.remove("hidden"),Qe("btn-go-aerate").classList.remove("hidden"),setTimeout(()=>Qe("btn-go-aerate").scrollIntoView({behavior:"smooth",block:"nearest"}),100)},1800)}o.addEventListener("mousedown",m),o.addEventListener("touchstart",m,{passive:!1})}function ws(n,e,t,i){const a=Qe(n);if(!a)return;const s=performance.now(),r=l=>1-(1-l)**2;function o(l){const d=Math.min(1,(l-s)/t);a.textContent=(e*r(d)).toFixed(i),d<1&&requestAnimationFrame(o)}requestAnimationFrame(o)}function qr(n){const t=n/1e3*100,i=100-t,a=Qe("beaker-vinasse"),s=Qe("beaker-water");a.style.height=t+"%",a.style.bottom="0%",s.style.height=i+"%",s.style.bottom=t+"%"}function Kx(n){const e=Qe("aerator-liquid");if(!e)return;const t=Math.min(1,n.cod/45e3),i=Math.round(60+t*60),a=Math.round(20+t*5),s=0;e.style.background=`rgb(${i},${a},${s})`}function Jx(n){const e=Qe("bubble-container");if(e&&(e.innerHTML="",!!n))for(let t=0;t<14;t++){const i=document.createElement("div");i.className="bubble",i.style.left=5+Math.random()*85+"%",i.style.animationDuration=1.2+Math.random()*2+"s",i.style.animationDelay=Math.random()*2+"s",i.style.width=i.style.height=4+Math.random()*8+"px",e.appendChild(i)}}function Zx(n,e,t,i){const a=Qe("results-grid"),s=Qe("compliance-banner"),r=Qe("sim-conclusion"),o=kd(t);a.innerHTML=`
  ...
  `}function $r(n,e){const t=Qe(n),i=Qe(e);t.classList.add("step-exit"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("step-exit"),i.classList.remove("hidden"),i.classList.add("step-enter"),setTimeout(()=>i.classList.remove("step-enter"),400)},300)}function Qx(){if(document.getElementById("sim-styles"))return;const n=`
    /* ── Simulation overlay ───────────────────────────── */
    .sim-overlay {
  ...
  `,e=document.createElement("style");e.id="sim-styles",e.textContent=n,document.head.appendChild(e)}const Ms={context:`
  ...
  `,document.body.appendChild(e),ve("s3-ctx").innerHTML=Ms.context,ve("s3-q").innerHTML=`<strong>❓ Pertanyaan:</strong><br>${Ms.question}`;const t=ve("s3-opts");let i=!1;Ms.options.forEach(a=>{const s=document.createElement("button");s.className="s3-option",s.innerHTML=`<strong>${a.label}.</strong> ${a.text}`,s.onclick=()=>{if(!i)if(a.correct){i=!0,s.classList.add("correct"),t.querySelectorAll(".s3-option").forEach(l=>l.disabled=!0);const r=ee.wrongAnswers??0,o=r===0?100:r<=2?50:25;ee.totalPoints+=o,ee.levelAttempts++,jt(),wc("s3-fb",!0,Ms.explanation+`<br><br>🎉 +${o} poin tambahan!`),ve("s3-next-challenge").classList.remove("hidden")}else s.classList.add("wrong"),s.disabled=!0,ee.wrongAnswers=(ee.wrongAnswers??0)+1,jt(),wc("s3-fb",!1,"❌ Kurang tepat. Coba pilihan lain!")},t.appendChild(s)}),ve("s3-next-challenge").onclick=()=>{Ha(),n()}}function iv(n){const e=Hs("s3-overlay");e.innerHTML=`
  ...
  `,document.body.appendChild(e);let t=null;function i(){const a=ve("s3-shop-grid");a.innerHTML="",ka.forEach(s=>{const r=document.createElement("div");r.className="s3-micro-card",t&&s.id===t&&r.classList.add("chosen");const o=ee.totalPoints>=s.price;r.innerHTML=`
  ...
  `,document.body.appendChild(i);let a=null,s=0,r=!1,o=null,l=0,d=[],c=null,h=null,f=null,p=!1,g=null;const x=6,u={azolla:"#4ecb47",nannochloropsis:"#c8b820",spirulina:"#2ab8d8",chlorella:"#38d878"}[t.id]||"#80e880";i.querySelectorAll(".s3-vol-btn").forEach(_=>{_.onclick=()=>{i.querySelectorAll(".s3-vol-btn").forEach(V=>V.classList.remove("active")),_.classList.add("active"),a=parseInt(_.dataset.vol);const k=yc(n,a);g&&(g(),g=null),s=0,r=!1,ve("s3-lab-result").classList.add("hidden"),ve("s3-btn-to-valve").classList.add("hidden"),ve("s3-spk-micro-layer").style.transition="none",ve("s3-spk-micro-layer").style.height="0%",ve("s3-pour-counter").classList.add("hidden"),ve("s3-pour-progress-wrap").classList.add("hidden"),ve("s3-pour-feedback").classList.add("hidden"),ve("s3-btn-confirm-pour").classList.add("hidden"),ve("s3-pour-hint").classList.remove("hidden"),ve("s3-poured-amt").textContent="0.0",ve("s3-pour-bar-fill").style.width="0%",k?(ve("s3-target-amt").textContent=k.total,ve("s3-target-unit").textContent=k.unit,ve("s3-poured-unit").textContent=k.unit,ve("s3-spk-target-line").style.display=""):ve("s3-spk-target-line").style.display="none",ve("s3-spk-dose-label").innerHTML=k?`Dosis yang dibutuhkan: <b>${k.total} ${k.unit}</b> untuk ${a} L vinasse`:`⛔ ${t.name} tidak cocok untuk vinasse ini`,o=k;const M=k?parseFloat(k.total):0;l=M*.25,d=Array(x).fill(l),c=null;const E=ve("s3-glass-row");if(E.innerHTML="",k)for(let V=0;V<x;V++){const Z=document.createElement("div");Z.className="s3-micro-glass",Z.id=`s3-mg-${V}`,Z.dataset.idx=String(V),Z.innerHTML=`<div class="s3-mg-liquid" id="s3-mg-liq-${V}" style="background:${u};height:85%"></div><div class="s3-mg-label">¼</div>`,E.appendChild(Z)}const I=document.getElementById("s3-mg-ghost");I&&I.remove();const y=document.createElement("div");y.id="s3-mg-ghost",y.className="s3-mg-ghost hidden",y.innerHTML=`<div class="s3-mg-ghost-liquid" id="s3-mg-ghost-liquid" style="background:${u}"></div>`,document.body.appendChild(y);function T(V){const Z=document.getElementById(`s3-mg-liq-${V}`),O=document.getElementById(`s3-mg-${V}`);!Z||!O||(Z.style.height=l>0?d[V]/l*100+"%":"0%",d[V]<=0&&(O.classList.add("empty"),O.classList.remove("dragging")))}function N(){const V=document.getElementById("s3-tank-drops");if(!V)return;const Z=document.createElement("div");Z.className="s3-mg-drop",Z.style.background=u,Z.style.setProperty("--spread",(Math.random()-.5)*10+"px"),Z.style.setProperty("--dur",.26+Math.random()*.26+"s"),V.appendChild(Z),setTimeout(()=>Z.remove(),600)}function H(){if(h||c===null||!o)return;const V=M*1.5;h=setInterval(()=>{if(c===null||d[c]<=0||s>=V){se();return}const Z=Math.max(M*.01,.001),O=Math.min(Z,d[c],V-s);d[c]-=O,s=Math.min(s+O,V),T(c),ve("s3-poured-amt").textContent=s.toFixed(1);const te=document.getElementById("s3-mg-ghost-liquid");te&&(te.style.height=l>0?d[c]/l*100+"%":"0%");const Y=Math.min(s/V,1)*30;ve("s3-spk-micro-layer").style.transition="none",ve("s3-spk-micro-layer").style.height=Y+"%",ve("s3-spk-micro-layer").style.background=u;const me=Math.min(s/V,1)*100;ve("s3-pour-bar-fill").style.width=me+"%";const fe=M>0?s/M:0;ve("s3-pour-bar-fill").style.background=fe<.7?"#20a0d0":fe<.8?"#60d060":fe<=1.2?"#00e870":fe<=1.5?"#e8a020":"#e04020"},80),f=setInterval(N,55)}function se(){clearInterval(h),clearInterval(f),h=f=null}function P(V,Z){y.style.left=V-18+"px",y.style.top=Z-60+"px";const O=document.getElementById("s3-tank-drop-zone");if(!O)return;const te=O.getBoundingClientRect(),Y=V>=te.left&&V<=te.right&&Z>=te.top&&Z<=te.bottom;Y!==p&&(p=Y,O.classList.toggle("active",Y),y.classList.toggle("tilting",Y),Y?H():se())}function F(V,Z,O){var Y;if(d[V]<=0)return;c=V,p=!1,(Y=document.getElementById(`s3-mg-${V}`))==null||Y.classList.add("dragging"),y.classList.remove("hidden");const te=document.getElementById("s3-mg-ghost-liquid");te&&(te.style.height=l>0?d[V]/l*100+"%":"85%"),r||(r=!0,ve("s3-pour-hint").classList.add("hidden"),ve("s3-pour-counter").classList.remove("hidden"),ve("s3-pour-progress-wrap").classList.remove("hidden"),ve("s3-btn-confirm-pour").classList.remove("hidden")),P(Z,O)}function X(){var Z,O;if(c===null)return;se(),T(c),(Z=document.getElementById(`s3-mg-${c}`))==null||Z.classList.remove("dragging"),c=null,p=!1,y.classList.add("hidden"),y.classList.remove("tilting"),(O=document.getElementById("s3-tank-drop-zone"))==null||O.classList.remove("active");const V=document.getElementById("s3-tank-drop-lbl");V&&(V.textContent=s>0&&o?`✓ ${s.toFixed(1)} ${o.unit} dituang`:"Jatuhkan di sini")}for(let V=0;V<x;V++){const Z=document.getElementById(`s3-mg-${V}`);Z&&(Z.addEventListener("mousedown",O=>{F(V,O.clientX,O.clientY),O.preventDefault()}),Z.addEventListener("touchstart",O=>{F(V,O.touches[0].clientX,O.touches[0].clientY),O.preventDefault()},{passive:!1}))}function ne(V){c!==null&&P(V.clientX,V.clientY)}function $(){X()}function K(V){c!==null&&(P(V.touches[0].clientX,V.touches[0].clientY),V.preventDefault())}function J(){X()}window.addEventListener("mousemove",ne),window.addEventListener("mouseup",$),window.addEventListener("touchmove",K,{passive:!1}),window.addEventListener("touchend",J),g=()=>{X(),window.removeEventListener("mousemove",ne),window.removeEventListener("mouseup",$),window.removeEventListener("touchmove",K),window.removeEventListener("touchend",J);const V=document.getElementById("s3-mg-ghost");V&&V.remove()},ve("s3-sprinkler-scene").classList.remove("hidden"),ve("s3-sprinkler-scene").scrollIntoView({behavior:"smooth",block:"nearest"})}});function v(_){const k=ve("s3-calc-grid"),M=ve("s3-lab-notes");_?(k.innerHTML=[{icon:"⚗️",label:"Volume Vinasse",value:`${a} L`},{icon:"🧫",label:"Dosis Mikro",value:`${_.total} ${_.unit}`},{icon:"⏱️",label:"Durasi Perlakuan",value:_.duration}].map(E=>`
        ...
        target hanya <b>${_.total} ${_.unit}</b>. Coba lagi!`,b()):(k.className="s3-pour-feedback correct",k.innerHTML=`✅ <b>Tepat!</b> <b>${s.toFixed(1)} ${_.unit}</b> — sesuai dosis bioremediasi!`,ve("s3-spk-micro-layer").style.transition="height 1.2s ease",ve("s3-spk-micro-layer").style.height="30%",setTimeout(()=>v(_),1500))},ve("s3-btn-to-valve").onclick=()=>{g&&(g(),g=null),Ha(),e()}}function sv(n){const e=Hs("s3-overlay");e.innerHTML=`
  ...
  `,document.body.appendChild(t);const i=(s=ee.stage4)==null?void 0:s.concentrationCfg;i&&(tt("s4-cfg-summary").innerHTML=`
    ...
    `,a.appendChild(o)}),tt("s4-btn-proc-done").onclick=()=>{ra(),e()}}function fv(n,e){var s;const t=Vs(),i=((s=ee.stage4)==null?void 0:s.concentrationCfg)||{repetitions:3,duration:7};if(t.innerHTML=`
    <div class="s4-card">
      <div class="s4-header">
  ...
  `,document.body.appendChild(t),!n.success){tt("s4-btn-finish").onclick=()=>{ra(),Cd(e)};return}let a=!1;tt("s4-run-sim").onclick=()=>{if(a)return;a=!0,tt("s4-run-sim").disabled=!0,tt("s4-run-sim").textContent="⏳ Simulasi berjalan…";const r=tt("s4-rd-liquid"),o=tt("s4-rd-azolla");tt("s4-rd-bubbles").classList.add("active"),r.classList.add("treating"),o.classList.add("growing"),setTimeout(()=>{tt("s4-run-sim").textContent="✅ Simulasi Selesai",tt("s4-sim-results").classList.remove("hidden");const d=tt("s4-conc-tbody");d.innerHTML="",n.perConcentration.forEach((c,h)=>{const f=document.createElement("tr");f.innerHTML=`
    ...
    `).join("")}
  </div>`}function Vs(){const n=document.createElement("div");return n.id="s4-overlay",n.className="s4-overlay",n}function ra(){const n=tt("s4-overlay");n&&n.remove()}function mv(){if(tt("s4-styles"))return;const n=document.createElement("style");n.id="s4-styles",n.textContent=`
    .s4-overlay {
  ...
  `,document.body.appendChild(i),t.length>0){const s=((a=ee.stage4)==null?void 0:a.concentrationCfg)||null,r=Mi("s5-scen-list");t.forEach((o,l)=>{const d=typeof o.symptom=="function"?o.symptom(s):o.symptom,c=document.createElement("div");c.className="s5-scenario-card",c.innerHTML=`
      ...
      `,l===0&&c.classList.add("open"),r.appendChild(c)})}Mi("s5-btn-to-mcq").onclick=()=>{Ws(),n()}}function bv(n){const e=`Dalam proyek yang telah kalian buat, limbah vinasse dari industri etanol di Bekonang memiliki karakteristik pH yang sangat asam, kadar COD dan BOD yang sangat tinggi, serta mengandung pigmen melanoidin dan senyawa fenol.
Berdasarkan konsep bioremediasi yang telah kalian pelajari, analisislah mengapa penggunaan bakteri pengurai seringkali gagal dalam memulihkan limbah vinasse ini? Selanjutnya, jelaskan mekanisme pemilihan agen biologis dapat secara efektif menurunkan kadar polutan dalam proses valorisasi limbah tersebut menjadi Pupuk Organik Cair (POC) yang aman bagi lingkungan`,t=Io();t.innerHTML=`
  ...
  `,document.body.appendChild(t);const i=Mi("s5-essay-input"),a=Mi("s5-btn-essay-submit");i.oninput=()=>{a.disabled=i.value.trim().length<10},a.onclick=()=>{ee.stage5=ee.stage5||{},ee.stage5.essayAnswer=i.value.trim(),Tx({playerName:ee.playerName||"",essayAnswer:ee.stage5.essayAnswer,timestamp:new Date().toISOString()}),Ws(),n()}}function _v(n){var s,r;const e=ee.stage4.reactorResult||{},t=((s=ee.stage4)==null?void 0:s.concentrationCfg)||null,i=(e.perConcentration||[]).map((o,l)=>`
    <tr>
      <td>T${l+1}</td>
      <td>${o.conc}%</td>
  ...
  `,document.body.appendChild(a),Mi("s5-btn-finish").onclick=()=>{Ws(),n&&n()}}function Do(n){return`<div class="s5-step-indicator">
    ...
    `).join("")}
  </div>`}function Io(){const n=document.createElement("div");return n.id="s5-overlay",n.className="s5-overlay",n}function Ws(){const n=Mi("s5-overlay");n&&n.remove()}function yv(){if(Mi("s5-styles"))return;const n=document.createElement("style");n.id="s5-styles",n.textContent=`
    .s5-overlay {
  ...
  `,document.head.appendChild(n)}const Xs=document.getElementById("game-canvas"),Hn=new _o({canvas:Xs,antialias:!0});Hn.setPixelRatio(Math.min(window.devicePixelRatio,2));Hn.setSize(window.innerWidth,window.innerHeight);Hn.shadowMap.enabled=!0;Hn.shadowMap.type=po;Hn.toneMapping=Rc;Hn.toneMappingExposure=1.1;Hn.outputColorSpace=It;let si=null;const{scene:Jt}=og();lg(Jt);const{scene:Si}=gg();xg(Si);const{scene:Un}=Tg();Ag(Un);const{scene:Nn}=Fg();zg(Nn);const{scene:On}=$g();Yg(On);si=Jt;const lt=new Kt(60,window.innerWidth/window.innerHeight,.1,1e3);lt.position.set(0,18,38);lt.lookAt(0,0,0);const dt=new mx(Jt);let Na=xd(Jt),Ca=null,Ra=null,Pa=null,ri=Na;function Uo(n,e){var t,i;n&&(n.glowMesh&&(e.remove(n.glowMesh),(t=n.glowMesh.geometry)==null||t.dispose()),n.glowMat&&n.glowMat.dispose(),n.doneSprite&&(e.remove(n.doneSprite),(i=n.doneSprite.material)==null||i.dispose()))}const Mc=22,Sc=26,Ec=24,Tc=22,Ac=21,Lc=14,Yr=.08;let oa=!1,Sa=null,co=!1,Da=0,pi=Math.PI,kc=Math.PI,jr=0,Ei=27,Ti=17;function wv(n,e){Ei=n,Ti=e}function Mv(n){if(!oa){jr+=.0012,lt.position.x=Math.sin(jr)*38,lt.position.z=Math.cos(jr)*38,lt.position.y=18+Math.sin(n*.3)*1.5,lt.lookAt(0,2,0);return}const e=dt.position.x,t=dt.position.z;if(co&&Sa){Da=Math.min(1,Da+.04);const l=1-Math.pow(1-Da,3),d=Sa.x,c=Sa.z,h=Sa.y??4,f=d+(e-d)*.35,p=c+(t-c)*.35,g=h+6,x=ee.currentLevel===2?Sc:ee.currentLevel===3?Ec:ee.currentLevel===4?Tc:ee.currentLevel===5?Ac:Mc,m=e+Math.sin(pi)*x,u=t+Math.cos(pi)*x,v=Lc;lt.position.x=m+(f-m)*l,lt.position.y=v+(g-v)*l,lt.position.z=u+(p-u)*l,lt.fov=60-20*l,lt.updateProjectionMatrix(),lt.lookAt(d,h,c);return}Math.abs(lt.fov-60)>.5&&(lt.fov+=(60-lt.fov)*.1,lt.updateProjectionMatrix()),kc=(dt.group?dt.group.rotation.y:pi)+Math.PI;let a=kc-pi;for(;a>Math.PI;)a-=Math.PI*2;for(;a<-Math.PI;)a+=Math.PI*2;pi+=a*.04;const s=ee.currentLevel===2?Sc:ee.currentLevel===3?Ec:ee.currentLevel===4?Tc:ee.currentLevel===5?Ac:Mc;let r=e+Math.sin(pi)*s,o=t+Math.cos(pi)*s;r=Math.max(-Ei,Math.min(Ei,r)),o=Math.max(-Ti,Math.min(Ti,o)),lt.position.x+=(r-lt.position.x)*Yr,lt.position.z+=(o-lt.position.z)*Yr,lt.position.y+=(Lc-lt.position.y)*Yr,lt.lookAt(e,3,t)}function Sv(){const n=new L(dt.position.x-lt.position.x,0,dt.position.z-lt.position.z).normalize(),e=new L().crossVectors(n,new L(0,1,0)).normalize();return{fwd:n,right:e}}const Ev=6.5;let Ot=null,on=!1;function Tv(){if(on)return;let n=null,e=1/0;for(const t of ri){if(t.done)continue;const i=dt.position.x-t.pos.x,a=dt.position.z-t.pos.z,s=Math.sqrt(i*i+a*a);s<Ev&&s<e&&(e=s,n=t)}if(n!==Ot){Ot=n;const t=ee.currentLevel===2?`Tekan <kbd>E</kbd> &nbsp;— 🏭 Stasiun ${n?n.idx+1:""}`:ee.currentLevel===3?"Tekan <kbd>E</kbd> &nbsp;— 🚰 Buka Kran Vinasse":ee.currentLevel===4?"Tekan <kbd>E</kbd> &nbsp;— 💻 IPAL Builder Terminal":ee.currentLevel===5?"Tekan <kbd>E</kbd> &nbsp;— 🔬 Analisis Mikroskop":`Tekan <kbd>E</kbd> &nbsp;— ❓ Fenomena ${n?n.idx+1:""}`;Po(n?t:null)}}window.addEventListener("keydown",n=>{n.code==="KeyE"&&Ot&&!on&&oa&&Rd(Ot)});document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("btn-interact-mobile");n&&n.addEventListener("touchstart",e=>{e.preventDefault(),Ot&&!on&&oa&&Rd(Ot)},{passive:!1})});function Rd(n){on=!0,Po(null),Sa=n.pos?{x:n.pos.x,y:3,z:n.pos.z}:{x:0,y:3,z:0},co=!0,Da=0;function e(){co=!1,Da=0}if(ee.currentLevel===3&&n.isValve){tv(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,ee.stage3.valveOpened=!0,setTimeout(()=>Ma(()=>Ea(3)),600)});return}if(ee.currentLevel===4&&n.isTerminal){Cd(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,ee.stage4.terminalDone=!0,setTimeout(()=>Ma(()=>Ea(4)),600)});return}if(ee.currentLevel===5&&n.isScope){xv(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,ee.stage5.scopeDone=!0,setTimeout(()=>Ma(()=>Ea(5)),600)});return}Nx(n.idx,()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.emissive.set(3066993),n.glowMat.emissiveIntensity=.2,e(),on=!1,Ot=null,ri.every(i=>i.done)&&ee.currentLevel===1&&setTimeout(()=>Ma(()=>Ea(1)),600)},()=>{e(),on=!1,Ot=null})}function Ea(n){if(ee.completedRooms.includes(n)||ee.completedRooms.push(n),Sx(n),Mx({playerName:ee.playerName,currentLevel:n,totalPoints:ee.totalPoints,levelBreakdown:ee.levelBreakdown,completedRooms:ee.completedRooms}),ee.completedRooms.length>=5){Bx();return}uo()}function uo(){on=!0,Ot=null,Po(null),zx(n=>{on=!1,Pd(n)})}function Pd(n){ee.currentLevel=n,ee.pointsAtLevelStart=ee.totalPoints,n===1?Av():n===2?Lv():n===3?kv():n===4?Cv():n===5&&Rv()}function Av(){[Jt,Si,Un,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Jt),dt.position.set(0,0,12),si=Jt,Na=xd(Jt),ri=Na,wv(27,17),Ot=null,jt()}function Lv(){si=Si,rx(),Ei=30,Ti=20,[Jt,Un,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Si),dt.position.set(0,0,18),ri=[],Ot=null,jt(),setTimeout(()=>qx(()=>{setTimeout(()=>Ma(()=>Ea(2)),600)}),400)}function kv(){si=Un,ox(),Ei=26,Ti=21,[Jt,Si,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Un),dt.position.set(0,0,16),Uo(Ca,Un),Ca=Ng(Un),ri=[Ca],Ot=null,jt()}function Cv(){si=Nn,dx(),Ei=24,Ti=18,[Jt,Si,Un,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Nn),dt.position.set(0,0,14),Uo(Ra,Nn),Ra=Xg(Nn),ri=[Ra],Ot=null,jt()}function Rv(){si=On,ux(),Ei=22,Ti=16,[Jt,Si,Un,Nn].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(On),dt.position.set(0,0,12),Uo(Pa,On),Pa=ex(On),ri=[Pa],Ot=null,jt()}window.addEventListener("resize",()=>{Hn.setSize(window.innerWidth,window.innerHeight),lt.aspect=window.innerWidth/window.innerHeight,lt.updateProjectionMatrix()});Xs.addEventListener("touchstart",n=>n.preventDefault(),{passive:!1});Xs.addEventListener("touchmove",n=>n.preventDefault(),{passive:!1});Xs.addEventListener("touchend",n=>n.preventDefault(),{passive:!1});Xx();function Dd(){oa=!0,document.getElementById("hud").style.display="block",Ix(),jt(),Ux(()=>{const n=Lo();n&&(ee.completedRooms=n.completedRooms||[],ee.totalPoints=n.totalPoints,ee.levelBreakdown=n.levelBreakdown||[],jt()),uo()},()=>{location.reload()},Pd),dt.addToScene(Jt),dt.position.set(0,0,12),si=Jt,ri=Na,uo()}function Pv(n){ee.playerName=n.playerName,ee.totalPoints=n.totalPoints,ee.levelBreakdown=n.levelBreakdown||[],ee.completedRooms=n.completedRooms||[],ee.pointsAtLevelStart=n.totalPoints,dt.setName(ee.playerName),Dd()}kx(n=>{dt.setName(n),Cx(()=>{Px(()=>{Dx(()=>{Ad(()=>{Dd()})})})})},n=>{Pv(n)});const Dv=new gd;function Id(){requestAnimationFrame(Id);const n=Dv.getElapsedTime();Mv(n),dt.update(n,on||!oa,Sv()),oa&&Tv(),ee.currentLevel===1?mg(Na,n):ee.currentLevel===3&&Ca?Og(Ca,n):ee.currentLevel===4&&Ra?qg(Ra,n):ee.currentLevel===5&&Pa&&tx(Pa,n),Hn.render(si,lt)}Id();
