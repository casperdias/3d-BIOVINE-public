...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Xl(){return new wi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_o(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function ql(){return new wi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_o(),fragmentShader:`
	...
	`}function Zf(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,d=l===Qr||l===eo,c=l===ta||l===na;if(d||c)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let p=e.get(o);return t===null&&(t=new Vl(n)),p=d?t.fromEquirectangular(o,p):t.fromCubemap(o,p),e.set(o,p),p.texture}else{if(e.has(o))return e.get(o).texture;{const p=o.image;if(d&&p&&p.height>0||c&&p&&a(p)){t===null&&(t=new Vl(n));const f=d?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,f),o.addEventListener("dispose",s),f.texture}else return null}}}return o}function a(o){let l=0;const d=6;for(let c=0;c<d;c++)o[c]!==void 0&&l++;return l===d}function s(o){const l=o.target;l.removeEventListener("dispose",s);const d=e.get(l);d!==void 0&&(e.delete(l),d.dispose())}function r(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:r}}function Qf(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let a;switch(i){case"WEBGL_depth_texture":a=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":a=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":a=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":a=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:a=n.getExtension(i)}return e[i]=a,a}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const a=t(i);return a===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),a}}}function e0(n,e,t,i){const a={},s=new WeakMap;function r(p){const f=p.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const x=f.morphAttributes[g];for(let m=0,u=x.length;m<u;m++)e.remove(x[m])}f.removeEventListener("dispose",r),delete a[f.id];const h=s.get(f);h&&(e.remove(h),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(p,f){return a[f.id]===!0||(f.addEventListener("dispose",r),a[f.id]=!0,t.memory.geometries++),f}function l(p){const f=p.attributes;for(const g in f)e.update(f[g],n.ARRAY_BUFFER);const h=p.morphAttributes;for(const g in h){const x=h[g];for(let m=0,u=x.length;m<u;m++)e.update(x[m],n.ARRAY_BUFFER)}}function d(p){const f=[],h=p.index,g=p.attributes.position;let x=0;if(h!==null){const v=h.array;x=h.version;for(let b=0,_=v.length;b<_;b+=3){const k=v[b+0],M=v[b+1],E=v[b+2];f.push(k,M,M,E,E,k)}}else if(g!==void 0){const v=g.array;x=g.version;for(let b=0,_=v.length/3-1;b<_;b+=3){const k=b+0,M=b+1,E=b+2;f.push(k,M,M,E,E,k)}}else return;const m=new(Gc(f)?Kc:jc)(f,1);m.version=x;const u=s.get(p);u&&e.remove(u),s.set(p,m)}function c(p){const f=s.get(p);if(f){const h=p.index;h!==null&&f.version<h.version&&d(p)}else d(p);return s.get(p)}return{get:o,update:l,getWireframeAttribute:c}}function t0(n,e,t,i){const a=i.isWebGL2;let s;function r(h){s=h}let o,l;function d(h){o=h.type,l=h.bytesPerElement}function c(h,g){n.drawElements(s,g,o,h*l),t.update(g,s,1)}function p(h,g,x){if(x===0)return;let m,u;if(a)m=n,u="drawElementsInstanced";else if(m=e.get("ANGLE_instanced_arrays"),u="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[u](s,g,o,h*l,x),t.update(g,s,x)}function f(h,g,x){if(x===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let u=0;u<x;u++)this.render(h[u]/l,g[u]);else{m.multiDrawElementsWEBGL(s,g,0,o,h,0,x);let u=0;for(let v=0;v<x;v++)u+=g[v];t.update(u,s,1)}}this.setMode=r,this.setIndex=d,this.render=c,this.renderInstances=p,this.renderMultiDraw=f}function n0(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,r,o){switch(t.calls++,r){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function a(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:a,update:i}}function i0(n,e){return n[0]-e[0]}function a0(n,e){return Math.abs(e[1])-Math.abs(n[1])}function s0(n,e,t){const i={},a=new Float32Array(8),s=new WeakMap,r=new gt,o=[];for(let d=0;d<8;d++)o[d]=[d,0];function l(d,c,p){const f=d.morphTargetInfluences;if(e.isWebGL2===!0){const g=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,x=g!==void 0?g.length:0;let m=s.get(c);if(m===void 0||m.count!==x){let z=function(){se.dispose(),s.delete(c),c.removeEventListener("dispose",z)};var h=z;m!==void 0&&m.texture.dispose();const b=c.morphAttributes.position!==void 0,_=c.morphAttributes.normal!==void 0,k=c.morphAttributes.color!==void 0,M=c.morphAttributes.position||[],E=c.morphAttributes.normal||[],I=c.morphAttributes.color||[];let y=0;b===!0&&(y=1),_===!0&&(y=2),k===!0&&(y=3);let T=c.attributes.position.count*y,N=1;T>e.maxTextureSize&&(N=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const H=new Float32Array(T*N*4*x),se=new Xc(H,T,N,x);se.type=Kn,se.needsUpdate=!0;const P=y*4;for(let X=0;X<x;X++){const ne=M[X],$=E[X],K=I[X],J=T*N*4*X;for(let V=0;V<ne.count;V++){const Z=V*P;b===!0&&(r.fromBufferAttribute(ne,V),H[J+Z+0]=r.x,H[J+Z+1]=r.y,H[J+Z+2]=r.z,H[J+Z+3]=0),_===!0&&(r.fromBufferAttribute($,V),H[J+Z+4]=r.x,H[J+Z+5]=r.y,H[J+Z+6]=r.z,H[J+Z+7]=0),k===!0&&(r.fromBufferAttribute(K,V),H[J+Z+8]=r.x,H[J+Z+9]=r.y,H[J+Z+10]=r.z,H[J+Z+11]=K.itemSize===4?r.w:1)}}m={count:x,texture:se,size:new we(T,N)},s.set(c,m),c.addEventListener("dispose",z)}let u=0;for(let b=0;b<f.length;b++)u+=f[b];const v=c.morphTargetsRelative?1:1-u;p.getUniforms().setValue(n,"morphTargetBaseInfluence",v),p.getUniforms().setValue(n,"morphTargetInfluences",f),p.getUniforms().setValue(n,"morphTargetsTexture",m.texture,t),p.getUniforms().setValue(n,"morphTargetsTextureSize",m.size)}else{const g=f===void 0?0:f.length;let x=i[c.id];if(x===void 0||x.length!==g){x=[];for(let _=0;_<g;_++)x[_]=[_,0];i[c.id]=x}for(let _=0;_<g;_++){const k=x[_];k[0]=_,k[1]=f[_]}x.sort(a0);for(let _=0;_<8;_++)_<g&&x[_][1]?(o[_][0]=x[_][0],o[_][1]=x[_][1]):(o[_][0]=Number.MAX_SAFE_INTEGER,o[_][1]=0);o.sort(i0);const m=c.morphAttributes.position,u=c.morphAttributes.normal;let v=0;for(let _=0;_<8;_++){const k=o[_],M=k[0],E=k[1];M!==Number.MAX_SAFE_INTEGER&&E?(m&&c.getAttribute("morphTarget"+_)!==m[M]&&c.setAttribute("morphTarget"+_,m[M]),u&&c.getAttribute("morphNormal"+_)!==u[M]&&c.setAttribute("morphNormal"+_,u[M]),a[_]=E,v+=E):(m&&c.hasAttribute("morphTarget"+_)===!0&&c.deleteAttribute("morphTarget"+_),u&&c.hasAttribute("morphNormal"+_)===!0&&c.deleteAttribute("morphNormal"+_),a[_]=0)}const b=c.morphTargetsRelative?1:1-v;p.getUniforms().setValue(n,"morphTargetBaseInfluence",b),p.getUniforms().setValue(n,"morphTargetInfluences",a)}}return{update:l}}function r0(n,e,t,i){let a=new WeakMap;function s(l){const d=i.render.frame,c=l.geometry,p=e.get(l,c);if(a.get(p)!==d&&(e.update(p),a.set(p,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),a.get(l)!==d&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),a.set(l,d))),l.isSkinnedMesh){const f=l.skeleton;a.get(f)!==d&&(f.update(),a.set(f,d))}return p}function r(){a=new WeakMap}function o(l){const d=l.target;d.removeEventListener("dispose",o),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:s,dispose:r}}class nd extends Zt{constructor(e,t,i,a,s,r,o,l,d,c){if(c=c!==void 0?c:bi,c!==bi&&c!==ia)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&c===bi&&(i=jn),i===void 0&&c===ia&&(i=vi),super(null,a,s,r,o,l,c,i,d),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Yt,this.minFilter=l!==void 0?l:Yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const id=new Zt,ad=new nd(1,1);ad.compareFunction=Hc;const sd=new Xc,rd=new Vu,od=new Qc,$l=[],Yl=[],jl=new Float32Array(16),Kl=new Float32Array(9),Jl=new Float32Array(4);function ca(n,e,t){const i=n[0];if(i<=0||i>0)return n;const a=e*t;let s=$l[a];if(s===void 0&&(s=new Float32Array(a),$l[a]=s),e!==0){i.toArray(s,0);for(let r=1,o=0;r!==e;++r)o+=t,n[r].toArray(s,o)}return s}function kt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Ct(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function zs(n,e){let t=Yl[e];t===void 0&&(t=new Int32Array(e),Yl[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function o0(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function l0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;n.uniform2fv(this.addr,e),Ct(t,e)}}function c0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(kt(t,e))return;n.uniform3fv(this.addr,e),Ct(t,e)}}function d0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;n.uniform4fv(this.addr,e),Ct(t,e)}}function u0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(kt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Ct(t,e)}else{if(kt(t,i))return;Jl.set(i),n.uniformMatrix2fv(this.addr,!1,Jl),Ct(t,i)}}function p0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(kt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Ct(t,e)}else{if(kt(t,i))return;Kl.set(i),n.uniformMatrix3fv(this.addr,!1,Kl),Ct(t,i)}}function h0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(kt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Ct(t,e)}else{if(kt(t,i))return;jl.set(i),n.uniformMatrix4fv(this.addr,!1,jl),Ct(t,i)}}function f0(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function m0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;n.uniform2iv(this.addr,e),Ct(t,e)}}function g0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(kt(t,e))return;n.uniform3iv(this.addr,e),Ct(t,e)}}function x0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;n.uniform4iv(this.addr,e),Ct(t,e)}}function v0(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function b0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;n.uniform2uiv(this.addr,e),Ct(t,e)}}function _0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(kt(t,e))return;n.uniform3uiv(this.addr,e),Ct(t,e)}}function y0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;n.uniform4uiv(this.addr,e),Ct(t,e)}}function w0(n,e,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(n.uniform1i(this.addr,a),i[0]=a);const s=this.type===n.SAMPLER_2D_SHADOW?ad:id;t.setTexture2D(e||s,a)}function M0(n,e,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(n.uniform1i(this.addr,a),i[0]=a),t.setTexture3D(e||rd,a)}function S0(n,e,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(n.uniform1i(this.addr,a),i[0]=a),t.setTextureCube(e||od,a)}function E0(n,e,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(n.uniform1i(this.addr,a),i[0]=a),t.setTexture2DArray(e||sd,a)}function T0(n){switch(n){case 5126:return o0;case 35664:return l0;case 35665:return c0;case 35666:return d0;case 35674:return u0;case 35675:return p0;case 35676:return h0;case 5124:case 35670:return f0;case 35667:case 35671:return m0;case 35668:case 35672:return g0;case 35669:case 35673:return x0;case 5125:return v0;case 36294:return b0;case 36295:return _0;case 36296:return y0;case 35678:case 36198:case 36298:case 36306:case 35682:return w0;case 35679:case 36299:case 36307:return M0;case 35680:case 36300:case 36308:case 36293:return S0;case 36289:case 36303:case 36311:case 36292:return E0}}function A0(n,e){n.uniform1fv(this.addr,e)}function L0(n,e){const t=ca(e,this.size,2);n.uniform2fv(this.addr,t)}function k0(n,e){const t=ca(e,this.size,3);n.uniform3fv(this.addr,t)}function C0(n,e){const t=ca(e,this.size,4);n.uniform4fv(this.addr,t)}function R0(n,e){const t=ca(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function P0(n,e){const t=ca(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function D0(n,e){const t=ca(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function I0(n,e){n.uniform1iv(this.addr,e)}function U0(n,e){n.uniform2iv(this.addr,e)}function N0(n,e){n.uniform3iv(this.addr,e)}function O0(n,e){n.uniform4iv(this.addr,e)}function z0(n,e){n.uniform1uiv(this.addr,e)}function F0(n,e){n.uniform2uiv(this.addr,e)}function B0(n,e){n.uniform3uiv(this.addr,e)}function H0(n,e){n.uniform4uiv(this.addr,e)}function G0(n,e,t){const i=this.cache,a=e.length,s=zs(t,a);kt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let r=0;r!==a;++r)t.setTexture2D(e[r]||id,s[r])}function V0(n,e,t){const i=this.cache,a=e.length,s=zs(t,a);kt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let r=0;r!==a;++r)t.setTexture3D(e[r]||rd,s[r])}function W0(n,e,t){const i=this.cache,a=e.length,s=zs(t,a);kt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let r=0;r!==a;++r)t.setTextureCube(e[r]||od,s[r])}function X0(n,e,t){const i=this.cache,a=e.length,s=zs(t,a);kt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let r=0;r!==a;++r)t.setTexture2DArray(e[r]||sd,s[r])}function q0(n){switch(n){case 5126:return A0;case 35664:return L0;case 35665:return k0;case 35666:return C0;case 35674:return R0;case 35675:return P0;case 35676:return D0;case 5124:case 35670:return I0;case 35667:case 35671:return U0;case 35668:case 35672:return N0;case 35669:case 35673:return O0;case 5125:return z0;case 36294:return F0;case 36295:return B0;case 36296:return H0;case 35678:case 36198:case 36298:case 36306:case 35682:return G0;case 35679:case 36299:case 36307:return V0;case 35680:case 36300:case 36308:case 36293:return W0;case 36289:case 36303:case 36311:case 36292:return X0}}class $0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=T0(t.type)}}class Y0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=q0(t.type)}}class j0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const a=this.seq;for(let s=0,r=a.length;s!==r;++s){const o=a[s];o.setValue(e,t[o.id],i)}}}const Tr=/(\w+)(\])?(\[|\.)?/g;function Zl(n,e){n.seq.push(e),n.map[e.id]=e}function K0(n,e,t){const i=n.name,a=i.length;for(Tr.lastIndex=0;;){const s=Tr.exec(i),r=Tr.lastIndex;let o=s[1];const l=s[2]==="]",d=s[3];if(l&&(o=o|0),d===void 0||d==="["&&r+2===a){Zl(t,d===void 0?new $0(o,n,e):new Y0(o,n,e));break}else{let p=t.map[o];p===void 0&&(p=new j0(o),Zl(t,p)),t=p}}}class Es{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const s=e.getActiveUniform(t,a),r=e.getUniformLocation(t,s.name);K0(s,r,this)}}setValue(e,t,i,a){const s=this.map[t];s!==void 0&&s.setValue(e,i,a)}setOptional(e,t,i){const a=t[i];a!==void 0&&this.setValue(e,i,a)}static upload(e,t,i,a){for(let s=0,r=t.length;s!==r;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,a)}}static seqWithValue(e,t){const i=[];for(let a=0,s=e.length;a!==s;++a){const r=e[a];r.id in t&&i.push(r)}return i}}function Ql(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const J0=37297;let Z0=0;function Q0(n,e){const t=n.split(`
`),i=[],a=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let r=a;r<s;r++){const o=r+1;i.push(`${o===e?">":" "} ${o}: ${t[r]}`)}return i.join(`
`)}function em(n){const e=ct.getPrimaries(ct.workingColorSpace),t=ct.getPrimaries(n);let i;switch(e===t?i="":e===Cs&&t===ks?i="LinearDisplayP3ToLinearSRGB":e===ks&&t===Cs&&(i="LinearSRGBToLinearDisplayP3"),n){case zn:case Us:return[i,"LinearTransferOETF"];case It:case vo:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function ec(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),a=n.getShaderInfoLog(e).trim();if(i&&a==="")return"";const s=/ERROR: 0:(\d+)/.exec(a);if(s){const r=parseInt(s[1]);return t.toUpperCase()+`

`+a+`

`+Q0(n.getShaderSource(e),r)}else return a}function tm(n,e){const t=em(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function nm(n,e){let t;switch(e){case hu:t="Linear";break;case fu:t="Reinhard";break;case mu:t="OptimizedCineon";break;case Rc:t="ACESFilmic";break;case xu:t="AgX";break;case gu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function im(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Zi).join(`
`)}function am(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Zi).join(`
`)}function sm(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function rm(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let a=0;a<i;a++){const s=n.getActiveAttrib(e,a),r=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[r]={type:s.type,location:n.getAttribLocation(e,r),locationSize:o}}return t}function Zi(n){return n!==""}function tc(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function nc(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const om=/^[ \t]*#include +<([\w\d./]+)>/gm;function oo(n){return n.replace(om,cm)}const lm=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function cm(n,e){let t=je[e];if(t===void 0){const i=lm.get(e);if(i!==void 0)t=je[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return oo(t)}const dm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ic(n){return n.replace(dm,um)}function um(n,e,t,i){let a="";for(let s=parseInt(e);s<parseInt(t);s++)a+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return a}function ac(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function pm(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Cc?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===fo?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Rn&&(e="SHADOWMAP_TYPE_VSM"),e}function hm(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ta:case na:e="ENVMAP_TYPE_CUBE";break;case Is:e="ENVMAP_TYPE_CUBE_UV";break}return e}function fm(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case na:e="ENVMAP_MODE_REFRACTION";break}return e}function mm(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case mo:e="ENVMAP_BLENDING_MULTIPLY";break;case uu:e="ENVMAP_BLENDING_MIX";break;case pu:e="ENVMAP_BLENDING_ADD";break}return e}function gm(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function xm(n,e,t,i){const a=n.getContext(),s=t.defines;let r=t.vertexShader,o=t.fragmentShader;const l=pm(t),d=hm(t),c=fm(t),p=mm(t),f=gm(t),h=t.isWebGL2?"":im(t),g=am(t),x=sm(s),m=a.createProgram();let u,v,b=t.glslVersion?"#version "+t.glslVersion+`
...
}`;function Um(n,e,t){let i=new bo;const a=new we,s=new we,r=new gt,o=new Rm({depthPacking:Lu}),l=new Pm,d={},c=t.maxTextureSize,p={[ni]:Ht,[Ht]:ni,[At]:At},f=new wi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new we},radius:{value:4}},vertexShader:Dm,fragmentShader:Im}),h=f.clone();h.defines.HORIZONTAL_PASS=1;const g=new xt;g.setAttribute("position",new gn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new C(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Cc;let u=this.type;this.render=function(M,E,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||M.length===0)return;const y=n.getRenderTarget(),T=n.getActiveCubeFace(),N=n.getActiveMipmapLevel(),H=n.state;H.setBlending(Jn),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const se=u!==Rn&&this.type===Rn,P=u===Rn&&this.type!==Rn;for(let z=0,X=M.length;z<X;z++){const ne=M[z],$=ne.shadow;if($===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;a.copy($.mapSize);const K=$.getFrameExtents();if(a.multiply(K),s.copy($.mapSize),(a.x>c||a.y>c)&&(a.x>c&&(s.x=Math.floor(c/K.x),a.x=s.x*K.x,$.mapSize.x=s.x),a.y>c&&(s.y=Math.floor(c/K.y),a.y=s.y*K.y,$.mapSize.y=s.y)),$.map===null||se===!0||P===!0){const V=this.type!==Rn?{minFilter:Yt,magFilter:Yt}:{};$.map!==null&&$.map.dispose(),$.map=new yi(a.x,a.y,V),$.map.texture.name=ne.name+".shadowMap",$.camera.updateProjectionMatrix()}n.setRenderTarget($.map),n.clear();const J=$.getViewportCount();for(let V=0;V<J;V++){const Z=$.getViewport(V);r.set(s.x*Z.x,s.y*Z.y,s.x*Z.z,s.y*Z.w),H.viewport(r),$.updateMatrices(ne,V),i=$.getFrustum(),_(E,I,$.camera,ne,this.type)}$.isPointLightShadow!==!0&&this.type===Rn&&v($,I),$.needsUpdate=!1}u=this.type,m.needsUpdate=!1,n.setRenderTarget(y,T,N)};function v(M,E){const I=e.update(x);f.defines.VSM_SAMPLES!==M.blurSamples&&(f.defines.VSM_SAMPLES=M.blurSamples,h.defines.VSM_SAMPLES=M.blurSamples,f.needsUpdate=!0,h.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new yi(a.x,a.y)),f.uniforms.shadow_pass.value=M.map.texture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,n.setRenderTarget(M.mapPass),n.clear(),n.renderBufferDirect(E,null,I,f,x,null),h.uniforms.shadow_pass.value=M.mapPass.texture,h.uniforms.resolution.value=M.mapSize,h.uniforms.radius.value=M.radius,n.setRenderTarget(M.map),n.clear(),n.renderBufferDirect(E,null,I,h,x,null)}function b(M,E,I,y){let T=null;const N=I.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(N!==void 0)T=N;else if(T=I.isPointLight===!0?l:o,n.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const H=T.uuid,se=E.uuid;let P=d[H];P===void 0&&(P={},d[H]=P);let z=P[se];z===void 0&&(z=T.clone(),P[se]=z,E.addEventListener("dispose",k)),T=z}if(T.visible=E.visible,T.wireframe=E.wireframe,y===Rn?T.side=E.shadowSide!==null?E.shadowSide:E.side:T.side=E.shadowSide!==null?E.shadowSide:p[E.side],T.alphaMap=E.alphaMap,T.alphaTest=E.alphaTest,T.map=E.map,T.clipShadows=E.clipShadows,T.clippingPlanes=E.clippingPlanes,T.clipIntersection=E.clipIntersection,T.displacementMap=E.displacementMap,T.displacementScale=E.displacementScale,T.displacementBias=E.displacementBias,T.wireframeLinewidth=E.wireframeLinewidth,T.linewidth=E.linewidth,I.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const H=n.properties.get(T);H.light=I}return T}function _(M,E,I,y,T){if(M.visible===!1)return;if(M.layers.test(E.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&T===Rn)&&(!M.frustumCulled||i.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,M.matrixWorld);const se=e.update(M),P=M.material;if(Array.isArray(P)){const z=se.groups;for(let X=0,ne=z.length;X<ne;X++){const $=z[X],K=P[$.materialIndex];if(K&&K.visible){const J=b(M,K,y,T);M.onBeforeShadow(n,M,E,I,se,J,$),n.renderBufferDirect(I,null,se,J,M,$),M.onAfterShadow(n,M,E,I,se,J,$)}}}else if(P.visible){const z=b(M,P,y,T);M.onBeforeShadow(n,M,E,I,se,z,null),n.renderBufferDirect(I,null,se,z,M,null),M.onAfterShadow(n,M,E,I,se,z,null)}}const H=M.children;for(let se=0,P=H.length;se<P;se++)_(H[se],E,I,y,T)}function k(M){M.target.removeEventListener("dispose",k);for(const I in d){const y=d[I],T=M.target.uuid;T in y&&(y[T].dispose(),delete y[T])}}}function Nm(n,e,t){const i=t.isWebGL2;function a(){let R=!1;const de=new gt;let he=null;const j=new gt(0,0,0,0);return{setMask:function(pe){he!==pe&&!R&&(n.colorMask(pe,pe,pe,pe),he=pe)},setLocked:function(pe){R=pe},setClear:function(pe,nt,it,Et,Vt){Vt===!0&&(pe*=Et,nt*=Et,it*=Et),de.set(pe,nt,it,Et),j.equals(de)===!1&&(n.clearColor(pe,nt,it,Et),j.copy(de))},reset:function(){R=!1,he=null,j.set(-1,0,0,0)}}}function s(){let R=!1,de=null,he=null,j=null;return{setTest:function(pe){pe?Ue(n.DEPTH_TEST):Ne(n.DEPTH_TEST)},setMask:function(pe){de!==pe&&!R&&(n.depthMask(pe),de=pe)},setFunc:function(pe){if(he!==pe){switch(pe){case au:n.depthFunc(n.NEVER);break;case su:n.depthFunc(n.ALWAYS);break;case ru:n.depthFunc(n.LESS);break;case As:n.depthFunc(n.LEQUAL);break;case ou:n.depthFunc(n.EQUAL);break;case lu:n.depthFunc(n.GEQUAL);break;case cu:n.depthFunc(n.GREATER);break;case du:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}he=pe}},setLocked:function(pe){R=pe},setClear:function(pe){j!==pe&&(n.clearDepth(pe),j=pe)},reset:function(){R=!1,de=null,he=null,j=null}}}function r(){let R=!1,de=null,he=null,j=null,pe=null,nt=null,it=null,Et=null,Vt=null;return{setTest:function(ht){R||(ht?Ue(n.STENCIL_TEST):Ne(n.STENCIL_TEST))},setMask:function(ht){de!==ht&&!R&&(n.stencilMask(ht),de=ht)},setFunc:function(ht,Wt,vn){(he!==ht||j!==Wt||pe!==vn)&&(n.stencilFunc(ht,Wt,vn),he=ht,j=Wt,pe=vn)},setOp:function(ht,Wt,vn){(nt!==ht||it!==Wt||Et!==vn)&&(n.stencilOp(ht,Wt,vn),nt=ht,it=Wt,Et=vn)},setLocked:function(ht){R=ht},setClear:function(ht){Vt!==ht&&(n.clearStencil(ht),Vt=ht)},reset:function(){R=!1,de=null,he=null,j=null,pe=null,nt=null,it=null,Et=null,Vt=null}}}const o=new a,l=new s,d=new r,c=new WeakMap,p=new WeakMap;let f={},h={},g=new WeakMap,x=[],m=null,u=!1,v=null,b=null,_=null,k=null,M=null,E=null,I=null,y=new Ve(0,0,0),T=0,N=!1,H=null,se=null,P=null,z=null,X=null;const ne=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,K=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(J)[1]),$=K>=1):J.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),$=K>=2);let V=null,Z={};const O=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),Y=new gt().fromArray(O),me=new gt().fromArray(te);function fe(R,de,he,j){const pe=new Uint8Array(4),nt=n.createTexture();n.bindTexture(R,nt),n.texParameteri(R,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(R,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let it=0;it<he;it++)i&&(R===n.TEXTURE_3D||R===n.TEXTURE_2D_ARRAY)?n.texImage3D(de,0,n.RGBA,1,1,j,0,n.RGBA,n.UNSIGNED_BYTE,pe):n.texImage2D(de+it,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pe);return nt}const Ce={};Ce[n.TEXTURE_2D]=fe(n.TEXTURE_2D,n.TEXTURE_2D,1),Ce[n.TEXTURE_CUBE_MAP]=fe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Ce[n.TEXTURE_2D_ARRAY]=fe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Ce[n.TEXTURE_3D]=fe(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),d.setClear(0),Ue(n.DEPTH_TEST),l.setFunc(As),Xe(!1),A(Vo),Ue(n.CULL_FACE),Le(Jn);function Ue(R){f[R]!==!0&&(n.enable(R),f[R]=!0)}function Ne(R){f[R]!==!1&&(n.disable(R),f[R]=!1)}function et(R,de){return h[R]!==de?(n.bindFramebuffer(R,de),h[R]=de,i&&(R===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=de),R===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=de)),!0):!1}function F(R,de){let he=x,j=!1;if(R)if(he=g.get(de),he===void 0&&(he=[],g.set(de,he)),R.isWebGLMultipleRenderTargets){const pe=R.texture;if(he.length!==pe.length||he[0]!==n.COLOR_ATTACHMENT0){for(let nt=0,it=pe.length;nt<it;nt++)he[nt]=n.COLOR_ATTACHMENT0+nt;he.length=pe.length,j=!0}}else he[0]!==n.COLOR_ATTACHMENT0&&(he[0]=n.COLOR_ATTACHMENT0,j=!0);else he[0]!==n.BACK&&(he[0]=n.BACK,j=!0);j&&(t.isWebGL2?n.drawBuffers(he):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(he))}function Rt(R){return m!==R?(n.useProgram(R),m=R,!0):!1}const De={[gi]:n.FUNC_ADD,[Vd]:n.FUNC_SUBTRACT,[Wd]:n.FUNC_REVERSE_SUBTRACT};if(i)De[$o]=n.MIN,De[Yo]=n.MAX;else{const R=e.get("EXT_blend_minmax");R!==null&&(De[$o]=R.MIN_EXT,De[Yo]=R.MAX_EXT)}const Be={[Xd]:n.ZERO,[qd]:n.ONE,[$d]:n.SRC_COLOR,[Jr]:n.SRC_ALPHA,[Qd]:n.SRC_ALPHA_SATURATE,[Jd]:n.DST_COLOR,[jd]:n.DST_ALPHA,[Yd]:n.ONE_MINUS_SRC_COLOR,[Zr]:n.ONE_MINUS_SRC_ALPHA,[Zd]:n.ONE_MINUS_DST_COLOR,[Kd]:n.ONE_MINUS_DST_ALPHA,[eu]:n.CONSTANT_COLOR,[tu]:n.ONE_MINUS_CONSTANT_COLOR,[nu]:n.CONSTANT_ALPHA,[iu]:n.ONE_MINUS_CONSTANT_ALPHA};function Le(R,de,he,j,pe,nt,it,Et,Vt,ht){if(R===Jn){u===!0&&(Ne(n.BLEND),u=!1);return}if(u===!1&&(Ue(n.BLEND),u=!0),R!==Gd){if(R!==v||ht!==N){if((b!==gi||M!==gi)&&(n.blendEquation(n.FUNC_ADD),b=gi,M=gi),ht)switch(R){case Qi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Wo:n.blendFunc(n.ONE,n.ONE);break;case Xo:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case qo:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Qi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Wo:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Xo:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case qo:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}_=null,k=null,E=null,I=null,y.set(0,0,0),T=0,v=R,N=ht}return}pe=pe||de,nt=nt||he,it=it||j,(de!==b||pe!==M)&&(n.blendEquationSeparate(De[de],De[pe]),b=de,M=pe),(he!==_||j!==k||nt!==E||it!==I)&&(n.blendFuncSeparate(Be[he],Be[j],Be[nt],Be[it]),_=he,k=j,E=nt,I=it),(Et.equals(y)===!1||Vt!==T)&&(n.blendColor(Et.r,Et.g,Et.b,Vt),y.copy(Et),T=Vt),v=R,N=!1}function pt(R,de){R.side===At?Ne(n.CULL_FACE):Ue(n.CULL_FACE);let he=R.side===Ht;de&&(he=!he),Xe(he),R.blending===Qi&&R.transparent===!1?Le(Jn):Le(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),l.setFunc(R.depthFunc),l.setTest(R.depthTest),l.setMask(R.depthWrite),o.setMask(R.colorWrite);const j=R.stencilWrite;d.setTest(j),j&&(d.setMask(R.stencilWriteMask),d.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),d.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),B(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?Ue(n.SAMPLE_ALPHA_TO_COVERAGE):Ne(n.SAMPLE_ALPHA_TO_COVERAGE)}function Xe(R){H!==R&&(R?n.frontFace(n.CW):n.frontFace(n.CCW),H=R)}function A(R){R!==Bd?(Ue(n.CULL_FACE),R!==se&&(R===Vo?n.cullFace(n.BACK):R===Hd?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Ne(n.CULL_FACE),se=R}function w(R){R!==P&&($&&n.lineWidth(R),P=R)}function B(R,de,he){R?(Ue(n.POLYGON_OFFSET_FILL),(z!==de||X!==he)&&(n.polygonOffset(de,he),z=de,X=he)):Ne(n.POLYGON_OFFSET_FILL)}function ue(R){R?Ue(n.SCISSOR_TEST):Ne(n.SCISSOR_TEST)}function ce(R){R===void 0&&(R=n.TEXTURE0+ne-1),V!==R&&(n.activeTexture(R),V=R)}function re(R,de,he){he===void 0&&(V===null?he=n.TEXTURE0+ne-1:he=V);let j=Z[he];j===void 0&&(j={type:void 0,texture:void 0},Z[he]=j),(j.type!==R||j.texture!==de)&&(V!==he&&(n.activeTexture(he),V=he),n.bindTexture(R,de||Ce[R]),j.type=R,j.texture=de)}function ke(){const R=Z[V];R!==void 0&&R.type!==void 0&&(n.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function ye(){try{n.compressedTexImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ee(){try{n.compressedTexImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Oe(){try{n.texSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function $e(){try{n.texSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function le(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function st(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ke(){try{n.texStorage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function He(){try{n.texStorage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Pe(){try{n.texImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function D(){try{n.texImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ie(R){Y.equals(R)===!1&&(n.scissor(R.x,R.y,R.z,R.w),Y.copy(R))}function _e(R){me.equals(R)===!1&&(n.viewport(R.x,R.y,R.z,R.w),me.copy(R))}function Ae(R,de){let he=p.get(de);he===void 0&&(he=new WeakMap,p.set(de,he));let j=he.get(R);j===void 0&&(j=n.getUniformBlockIndex(de,R.name),he.set(R,j))}function Te(R,de){const j=p.get(de).get(R);c.get(de)!==j&&(n.uniformBlockBinding(de,j,R.__bindingPointIndex),c.set(de,j))}function ee(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),f={},V=null,Z={},h={},g=new WeakMap,x=[],m=null,u=!1,v=null,b=null,_=null,k=null,M=null,E=null,I=null,y=new Ve(0,0,0),T=0,N=!1,H=null,se=null,P=null,z=null,X=null,Y.set(0,0,n.canvas.width,n.canvas.height),me.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),d.reset()}return{buffers:{color:o,depth:l,stencil:d},enable:Ue,disable:Ne,bindFramebuffer:et,drawBuffers:F,useProgram:Rt,setBlending:Le,setMaterial:pt,setFlipSided:Xe,setCullFace:A,setLineWidth:w,setPolygonOffset:B,setScissorTest:ue,activeTexture:ce,bindTexture:re,unbindTexture:ke,compressedTexImage2D:ye,compressedTexImage3D:Ee,texImage2D:Pe,texImage3D:D,updateUBOMapping:Ae,uniformBlockBinding:Te,texStorage2D:Ke,texStorage3D:He,texSubImage2D:Oe,texSubImage3D:$e,compressedTexSubImage2D:le,compressedTexSubImage3D:st,scissor:ie,viewport:_e,reset:ee}}function Om(n,e,t,i,a,s,r){const o=a.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new WeakMap;let p;const f=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,w){return h?new OffscreenCanvas(A,w):Ps("canvas")}function x(A,w,B,ue){let ce=1;if((A.width>ue||A.height>ue)&&(ce=ue/Math.max(A.width,A.height)),ce<1||w===!0)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap){const re=w?ro:Math.floor,ke=re(ce*A.width),ye=re(ce*A.height);p===void 0&&(p=g(ke,ye));const Ee=B?g(ke,ye):p;return Ee.width=ke,Ee.height=ye,Ee.getContext("2d").drawImage(A,0,0,ke,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+A.width+"x"+A.height+") to ("+ke+"x"+ye+")."),Ee}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+A.width+"x"+A.height+")."),A;return A}function m(A){return Ml(A.width)&&Ml(A.height)}function u(A){return o?!1:A.wrapS!==fn||A.wrapT!==fn||A.minFilter!==Yt&&A.minFilter!==sn}function v(A,w){return A.generateMipmaps&&w&&A.minFilter!==Yt&&A.minFilter!==sn}function b(A){n.generateMipmap(A)}function _(A,w,B,ue,ce=!1){if(o===!1)return w;if(A!==null){if(n[A]!==void 0)return n[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let re=w;if(w===n.RED&&(B===n.FLOAT&&(re=n.R32F),B===n.HALF_FLOAT&&(re=n.R16F),B===n.UNSIGNED_BYTE&&(re=n.R8)),w===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&(re=n.R8UI),B===n.UNSIGNED_SHORT&&(re=n.R16UI),B===n.UNSIGNED_INT&&(re=n.R32UI),B===n.BYTE&&(re=n.R8I),B===n.SHORT&&(re=n.R16I),B===n.INT&&(re=n.R32I)),w===n.RG&&(B===n.FLOAT&&(re=n.RG32F),B===n.HALF_FLOAT&&(re=n.RG16F),B===n.UNSIGNED_BYTE&&(re=n.RG8)),w===n.RGBA){const ke=ce?Ls:ct.getTransfer(ue);B===n.FLOAT&&(re=n.RGBA32F),B===n.HALF_FLOAT&&(re=n.RGBA16F),B===n.UNSIGNED_BYTE&&(re=ke===mt?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&(re=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&(re=n.RGB5_A1)}return(re===n.R16F||re===n.R32F||re===n.RG16F||re===n.RG32F||re===n.RGBA16F||re===n.RGBA32F)&&e.get("EXT_color_buffer_float"),re}function k(A,w,B){return v(A,B)===!0||A.isFramebufferTexture&&A.minFilter!==Yt&&A.minFilter!==sn?Math.log2(Math.max(w.width,w.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?w.mipmaps.length:1}function M(A){return A===Yt||A===jo||A===Js?n.NEAREST:n.LINEAR}function E(A){const w=A.target;w.removeEventListener("dispose",E),y(w),w.isVideoTexture&&c.delete(w)}function I(A){const w=A.target;w.removeEventListener("dispose",I),N(w)}function y(A){const w=i.get(A);if(w.__webglInit===void 0)return;const B=A.source,ue=f.get(B);if(ue){const ce=ue[w.__cacheKey];ce.usedTimes--,ce.usedTimes===0&&T(A),Object.keys(ue).length===0&&f.delete(B)}i.remove(A)}function T(A){const w=i.get(A);n.deleteTexture(w.__webglTexture);const B=A.source,ue=f.get(B);delete ue[w.__cacheKey],r.memory.textures--}function N(A){const w=A.texture,B=i.get(A),ue=i.get(w);if(ue.__webglTexture!==void 0&&(n.deleteTexture(ue.__webglTexture),r.memory.textures--),A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let ce=0;ce<6;ce++){if(Array.isArray(B.__webglFramebuffer[ce]))for(let re=0;re<B.__webglFramebuffer[ce].length;re++)n.deleteFramebuffer(B.__webglFramebuffer[ce][re]);else n.deleteFramebuffer(B.__webglFramebuffer[ce]);B.__webglDepthbuffer&&n.deleteRenderbuffer(B.__webglDepthbuffer[ce])}else{if(Array.isArray(B.__webglFramebuffer))for(let ce=0;ce<B.__webglFramebuffer.length;ce++)n.deleteFramebuffer(B.__webglFramebuffer[ce]);else n.deleteFramebuffer(B.__webglFramebuffer);if(B.__webglDepthbuffer&&n.deleteRenderbuffer(B.__webglDepthbuffer),B.__webglMultisampledFramebuffer&&n.deleteFramebuffer(B.__webglMultisampledFramebuffer),B.__webglColorRenderbuffer)for(let ce=0;ce<B.__webglColorRenderbuffer.length;ce++)B.__webglColorRenderbuffer[ce]&&n.deleteRenderbuffer(B.__webglColorRenderbuffer[ce]);B.__webglDepthRenderbuffer&&n.deleteRenderbuffer(B.__webglDepthRenderbuffer)}if(A.isWebGLMultipleRenderTargets)for(let ce=0,re=w.length;ce<re;ce++){const ke=i.get(w[ce]);ke.__webglTexture&&(n.deleteTexture(ke.__webglTexture),r.memory.textures--),i.remove(w[ce])}i.remove(w),i.remove(A)}let H=0;function se(){H=0}function P(){const A=H;return A>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+a.maxTextures),H+=1,A}function z(A){const w=[];return w.push(A.wrapS),w.push(A.wrapT),w.push(A.wrapR||0),w.push(A.magFilter),w.push(A.minFilter),w.push(A.anisotropy),w.push(A.internalFormat),w.push(A.format),w.push(A.type),w.push(A.generateMipmaps),w.push(A.premultiplyAlpha),w.push(A.flipY),w.push(A.unpackAlignment),w.push(A.colorSpace),w.join()}function X(A,w){const B=i.get(A);if(A.isVideoTexture&&pt(A),A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){const ue=A.image;if(ue===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ue.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(B,A,w);return}}t.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+w)}function ne(A,w){const B=i.get(A);if(A.version>0&&B.__version!==A.version){Y(B,A,w);return}t.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+w)}function $(A,w){const B=i.get(A);if(A.version>0&&B.__version!==A.version){Y(B,A,w);return}t.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+w)}function K(A,w){const B=i.get(A);if(A.version>0&&B.__version!==A.version){me(B,A,w);return}t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+w)}const J={[to]:n.REPEAT,[fn]:n.CLAMP_TO_EDGE,[no]:n.MIRRORED_REPEAT},V={[Yt]:n.NEAREST,[jo]:n.NEAREST_MIPMAP_NEAREST,[Js]:n.NEAREST_MIPMAP_LINEAR,[sn]:n.LINEAR,[vu]:n.LINEAR_MIPMAP_NEAREST,[Ua]:n.LINEAR_MIPMAP_LINEAR},Z={[Cu]:n.NEVER,[Nu]:n.ALWAYS,[Ru]:n.LESS,[Hc]:n.LEQUAL,[Pu]:n.EQUAL,[Uu]:n.GEQUAL,[Du]:n.GREATER,[Iu]:n.NOTEQUAL};function O(A,w,B){if(B?(n.texParameteri(A,n.TEXTURE_WRAP_S,J[w.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,J[w.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,J[w.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,V[w.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,V[w.minFilter])):(n.texParameteri(A,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(A,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(w.wrapS!==fn||w.wrapT!==fn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(A,n.TEXTURE_MAG_FILTER,M(w.magFilter)),n.texParameteri(A,n.TEXTURE_MIN_FILTER,M(w.minFilter)),w.minFilter!==Yt&&w.minFilter!==sn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),w.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,Z[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ue=e.get("EXT_texture_filter_anisotropic");if(w.magFilter===Yt||w.minFilter!==Js&&w.minFilter!==Ua||w.type===Kn&&e.has("OES_texture_float_linear")===!1||o===!1&&w.type===Na&&e.has("OES_texture_half_float_linear")===!1)return;(w.anisotropy>1||i.get(w).__currentAnisotropy)&&(n.texParameterf(A,ue.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,a.getMaxAnisotropy())),i.get(w).__currentAnisotropy=w.anisotropy)}}function te(A,w){let B=!1;A.__webglInit===void 0&&(A.__webglInit=!0,w.addEventListener("dispose",E));const ue=w.source;let ce=f.get(ue);ce===void 0&&(ce={},f.set(ue,ce));const re=z(w);if(re!==A.__cacheKey){ce[re]===void 0&&(ce[re]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,B=!0),ce[re].usedTimes++;const ke=ce[A.__cacheKey];ke!==void 0&&(ce[A.__cacheKey].usedTimes--,ke.usedTimes===0&&T(w)),A.__cacheKey=re,A.__webglTexture=ce[re].texture}return B}function Y(A,w,B){let ue=n.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(ue=n.TEXTURE_2D_ARRAY),w.isData3DTexture&&(ue=n.TEXTURE_3D);const ce=te(A,w),re=w.source;t.bindTexture(ue,A.__webglTexture,n.TEXTURE0+B);const ke=i.get(re);if(re.version!==ke.__version||ce===!0){t.activeTexture(n.TEXTURE0+B);const ye=ct.getPrimaries(ct.workingColorSpace),Ee=w.colorSpace===ln?null:ct.getPrimaries(w.colorSpace),Oe=w.colorSpace===ln||ye===Ee?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,w.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,w.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Oe);const $e=u(w)&&m(w.image)===!1;let le=x(w.image,$e,!1,a.maxTextureSize);le=Xe(w,le);const st=m(le)||o,Ke=s.convert(w.format,w.colorSpace);let He=s.convert(w.type),Pe=_(w.internalFormat,Ke,He,w.colorSpace,w.isVideoTexture);O(ue,w,st);let D;const ie=w.mipmaps,_e=o&&w.isVideoTexture!==!0&&Pe!==Fc,Ae=ke.__version===void 0||ce===!0,Te=k(w,le,st);if(w.isDepthTexture)Pe=n.DEPTH_COMPONENT,o?w.type===Kn?Pe=n.DEPTH_COMPONENT32F:w.type===jn?Pe=n.DEPTH_COMPONENT24:w.type===vi?Pe=n.DEPTH24_STENCIL8:Pe=n.DEPTH_COMPONENT16:w.type===Kn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),w.format===bi&&Pe===n.DEPTH_COMPONENT&&w.type!==go&&w.type!==jn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),w.type=jn,He=s.convert(w.type)),w.format===ia&&Pe===n.DEPTH_COMPONENT&&(Pe=n.DEPTH_STENCIL,w.type!==vi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),w.type=vi,He=s.convert(w.type))),Ae&&(_e?t.texStorage2D(n.TEXTURE_2D,1,Pe,le.width,le.height):t.texImage2D(n.TEXTURE_2D,0,Pe,le.width,le.height,0,Ke,He,null));else if(w.isDataTexture)if(ie.length>0&&st){_e&&Ae&&t.texStorage2D(n.TEXTURE_2D,Te,Pe,ie[0].width,ie[0].height);for(let ee=0,R=ie.length;ee<R;ee++)D=ie[ee],_e?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,D.width,D.height,Ke,He,D.data):t.texImage2D(n.TEXTURE_2D,ee,Pe,D.width,D.height,0,Ke,He,D.data);w.generateMipmaps=!1}else _e?(Ae&&t.texStorage2D(n.TEXTURE_2D,Te,Pe,le.width,le.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,le.width,le.height,Ke,He,le.data)):t.texImage2D(n.TEXTURE_2D,0,Pe,le.width,le.height,0,Ke,He,le.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){_e&&Ae&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,Pe,ie[0].width,ie[0].height,le.depth);for(let ee=0,R=ie.length;ee<R;ee++)D=ie[ee],w.format!==mn?Ke!==null?_e?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,D.width,D.height,le.depth,Ke,D.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ee,Pe,D.width,D.height,le.depth,0,D.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):_e?t.texSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,D.width,D.height,le.depth,Ke,He,D.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ee,Pe,D.width,D.height,le.depth,0,Ke,He,D.data)}else{_e&&Ae&&t.texStorage2D(n.TEXTURE_2D,Te,Pe,ie[0].width,ie[0].height);for(let ee=0,R=ie.length;ee<R;ee++)D=ie[ee],w.format!==mn?Ke!==null?_e?t.compressedTexSubImage2D(n.TEXTURE_2D,ee,0,0,D.width,D.height,Ke,D.data):t.compressedTexImage2D(n.TEXTURE_2D,ee,Pe,D.width,D.height,0,D.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):_e?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,D.width,D.height,Ke,He,D.data):t.texImage2D(n.TEXTURE_2D,ee,Pe,D.width,D.height,0,Ke,He,D.data)}else if(w.isDataArrayTexture)_e?(Ae&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,Pe,le.width,le.height,le.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,Ke,He,le.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,Pe,le.width,le.height,le.depth,0,Ke,He,le.data);else if(w.isData3DTexture)_e?(Ae&&t.texStorage3D(n.TEXTURE_3D,Te,Pe,le.width,le.height,le.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,Ke,He,le.data)):t.texImage3D(n.TEXTURE_3D,0,Pe,le.width,le.height,le.depth,0,Ke,He,le.data);else if(w.isFramebufferTexture){if(Ae)if(_e)t.texStorage2D(n.TEXTURE_2D,Te,Pe,le.width,le.height);else{let ee=le.width,R=le.height;for(let de=0;de<Te;de++)t.texImage2D(n.TEXTURE_2D,de,Pe,ee,R,0,Ke,He,null),ee>>=1,R>>=1}}else if(ie.length>0&&st){_e&&Ae&&t.texStorage2D(n.TEXTURE_2D,Te,Pe,ie[0].width,ie[0].height);for(let ee=0,R=ie.length;ee<R;ee++)D=ie[ee],_e?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,Ke,He,D):t.texImage2D(n.TEXTURE_2D,ee,Pe,Ke,He,D);w.generateMipmaps=!1}else _e?(Ae&&t.texStorage2D(n.TEXTURE_2D,Te,Pe,le.width,le.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ke,He,le)):t.texImage2D(n.TEXTURE_2D,0,Pe,Ke,He,le);v(w,st)&&b(ue),ke.__version=re.version,w.onUpdate&&w.onUpdate(w)}A.__version=w.version}function me(A,w,B){if(w.image.length!==6)return;const ue=te(A,w),ce=w.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+B);const re=i.get(ce);if(ce.version!==re.__version||ue===!0){t.activeTexture(n.TEXTURE0+B);const ke=ct.getPrimaries(ct.workingColorSpace),ye=w.colorSpace===ln?null:ct.getPrimaries(w.colorSpace),Ee=w.colorSpace===ln||ke===ye?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,w.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,w.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Oe=w.isCompressedTexture||w.image[0].isCompressedTexture,$e=w.image[0]&&w.image[0].isDataTexture,le=[];for(let ee=0;ee<6;ee++)!Oe&&!$e?le[ee]=x(w.image[ee],!1,!0,a.maxCubemapSize):le[ee]=$e?w.image[ee].image:w.image[ee],le[ee]=Xe(w,le[ee]);const st=le[0],Ke=m(st)||o,He=s.convert(w.format,w.colorSpace),Pe=s.convert(w.type),D=_(w.internalFormat,He,Pe,w.colorSpace),ie=o&&w.isVideoTexture!==!0,_e=re.__version===void 0||ue===!0;let Ae=k(w,st,Ke);O(n.TEXTURE_CUBE_MAP,w,Ke);let Te;if(Oe){ie&&_e&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,D,st.width,st.height);for(let ee=0;ee<6;ee++){Te=le[ee].mipmaps;for(let R=0;R<Te.length;R++){const de=Te[R];w.format!==mn?He!==null?ie?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R,0,0,de.width,de.height,He,de.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R,D,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ie?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R,0,0,de.width,de.height,He,Pe,de.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R,D,de.width,de.height,0,He,Pe,de.data)}}}else{Te=w.mipmaps,ie&&_e&&(Te.length>0&&Ae++,t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,D,le[0].width,le[0].height));for(let ee=0;ee<6;ee++)if($e){ie?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,le[ee].width,le[ee].height,He,Pe,le[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,D,le[ee].width,le[ee].height,0,He,Pe,le[ee].data);for(let R=0;R<Te.length;R++){const he=Te[R].image[ee].image;ie?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R+1,0,0,he.width,he.height,He,Pe,he.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R+1,D,he.width,he.height,0,He,Pe,he.data)}}else{ie?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,He,Pe,le[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,D,He,Pe,le[ee]);for(let R=0;R<Te.length;R++){const de=Te[R];ie?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R+1,0,0,He,Pe,de.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,R+1,D,He,Pe,de.image[ee])}}}v(w,Ke)&&b(n.TEXTURE_CUBE_MAP),re.__version=ce.version,w.onUpdate&&w.onUpdate(w)}A.__version=w.version}function fe(A,w,B,ue,ce,re){const ke=s.convert(B.format,B.colorSpace),ye=s.convert(B.type),Ee=_(B.internalFormat,ke,ye,B.colorSpace);if(!i.get(w).__hasExternalTextures){const $e=Math.max(1,w.width>>re),le=Math.max(1,w.height>>re);ce===n.TEXTURE_3D||ce===n.TEXTURE_2D_ARRAY?t.texImage3D(ce,re,Ee,$e,le,w.depth,0,ke,ye,null):t.texImage2D(ce,re,Ee,$e,le,0,ke,ye,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),Le(w)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ue,ce,i.get(B).__webglTexture,0,Be(w)):(ce===n.TEXTURE_2D||ce>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ce<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ue,ce,i.get(B).__webglTexture,re),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ce(A,w,B){if(n.bindRenderbuffer(n.RENDERBUFFER,A),w.depthBuffer&&!w.stencilBuffer){let ue=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(B||Le(w)){const ce=w.depthTexture;ce&&ce.isDepthTexture&&(ce.type===Kn?ue=n.DEPTH_COMPONENT32F:ce.type===jn&&(ue=n.DEPTH_COMPONENT24));const re=Be(w);Le(w)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,re,ue,w.width,w.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,re,ue,w.width,w.height)}else n.renderbufferStorage(n.RENDERBUFFER,ue,w.width,w.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,A)}else if(w.depthBuffer&&w.stencilBuffer){const ue=Be(w);B&&Le(w)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,ue,n.DEPTH24_STENCIL8,w.width,w.height):Le(w)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ue,n.DEPTH24_STENCIL8,w.width,w.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,A)}else{const ue=w.isWebGLMultipleRenderTargets===!0?w.texture:[w.texture];for(let ce=0;ce<ue.length;ce++){const re=ue[ce],ke=s.convert(re.format,re.colorSpace),ye=s.convert(re.type),Ee=_(re.internalFormat,ke,ye,re.colorSpace),Oe=Be(w);B&&Le(w)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Oe,Ee,w.width,w.height):Le(w)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Oe,Ee,w.width,w.height):n.renderbufferStorage(n.RENDERBUFFER,Ee,w.width,w.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ue(A,w){if(w&&w.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(w.depthTexture).__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),X(w.depthTexture,0);const ue=i.get(w.depthTexture).__webglTexture,ce=Be(w);if(w.depthTexture.format===bi)Le(w)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,ue,0,ce):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,ue,0);else if(w.depthTexture.format===ia)Le(w)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,ue,0,ce):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,ue,0);else throw new Error("Unknown depthTexture format")}function Ne(A){const w=i.get(A),B=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!w.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");Ue(w.__webglFramebuffer,A)}else if(B){w.__webglDepthbuffer=[];for(let ue=0;ue<6;ue++)t.bindFramebuffer(n.FRAMEBUFFER,w.__webglFramebuffer[ue]),w.__webglDepthbuffer[ue]=n.createRenderbuffer(),Ce(w.__webglDepthbuffer[ue],A,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer=n.createRenderbuffer(),Ce(w.__webglDepthbuffer,A,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function et(A,w,B){const ue=i.get(A);w!==void 0&&fe(ue.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&Ne(A)}function F(A){const w=A.texture,B=i.get(A),ue=i.get(w);A.addEventListener("dispose",I),A.isWebGLMultipleRenderTargets!==!0&&(ue.__webglTexture===void 0&&(ue.__webglTexture=n.createTexture()),ue.__version=w.version,r.memory.textures++);const ce=A.isWebGLCubeRenderTarget===!0,re=A.isWebGLMultipleRenderTargets===!0,ke=m(A)||o;if(ce){B.__webglFramebuffer=[];for(let ye=0;ye<6;ye++)if(o&&w.mipmaps&&w.mipmaps.length>0){B.__webglFramebuffer[ye]=[];for(let Ee=0;Ee<w.mipmaps.length;Ee++)B.__webglFramebuffer[ye][Ee]=n.createFramebuffer()}else B.__webglFramebuffer[ye]=n.createFramebuffer()}else{if(o&&w.mipmaps&&w.mipmaps.length>0){B.__webglFramebuffer=[];for(let ye=0;ye<w.mipmaps.length;ye++)B.__webglFramebuffer[ye]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(re)if(a.drawBuffers){const ye=A.texture;for(let Ee=0,Oe=ye.length;Ee<Oe;Ee++){const $e=i.get(ye[Ee]);$e.__webglTexture===void 0&&($e.__webglTexture=n.createTexture(),r.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&A.samples>0&&Le(A)===!1){const ye=re?w:[w];B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let Ee=0;Ee<ye.length;Ee++){const Oe=ye[Ee];B.__webglColorRenderbuffer[Ee]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[Ee]);const $e=s.convert(Oe.format,Oe.colorSpace),le=s.convert(Oe.type),st=_(Oe.internalFormat,$e,le,Oe.colorSpace,A.isXRRenderTarget===!0),Ke=Be(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ke,st,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ee,n.RENDERBUFFER,B.__webglColorRenderbuffer[Ee])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),Ce(B.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ce){t.bindTexture(n.TEXTURE_CUBE_MAP,ue.__webglTexture),O(n.TEXTURE_CUBE_MAP,w,ke);for(let ye=0;ye<6;ye++)if(o&&w.mipmaps&&w.mipmaps.length>0)for(let Ee=0;Ee<w.mipmaps.length;Ee++)fe(B.__webglFramebuffer[ye][Ee],A,w,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ee);else fe(B.__webglFramebuffer[ye],A,w,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0);v(w,ke)&&b(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(re){const ye=A.texture;for(let Ee=0,Oe=ye.length;Ee<Oe;Ee++){const $e=ye[Ee],le=i.get($e);t.bindTexture(n.TEXTURE_2D,le.__webglTexture),O(n.TEXTURE_2D,$e,ke),fe(B.__webglFramebuffer,A,$e,n.COLOR_ATTACHMENT0+Ee,n.TEXTURE_2D,0),v($e,ke)&&b(n.TEXTURE_2D)}t.unbindTexture()}else{let ye=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(o?ye=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ye,ue.__webglTexture),O(ye,w,ke),o&&w.mipmaps&&w.mipmaps.length>0)for(let Ee=0;Ee<w.mipmaps.length;Ee++)fe(B.__webglFramebuffer[Ee],A,w,n.COLOR_ATTACHMENT0,ye,Ee);else fe(B.__webglFramebuffer,A,w,n.COLOR_ATTACHMENT0,ye,0);v(w,ke)&&b(ye),t.unbindTexture()}A.depthBuffer&&Ne(A)}function Rt(A){const w=m(A)||o,B=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let ue=0,ce=B.length;ue<ce;ue++){const re=B[ue];if(v(re,w)){const ke=A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ye=i.get(re).__webglTexture;t.bindTexture(ke,ye),b(ke),t.unbindTexture()}}}function De(A){if(o&&A.samples>0&&Le(A)===!1){const w=A.isWebGLMultipleRenderTargets?A.texture:[A.texture],B=A.width,ue=A.height;let ce=n.COLOR_BUFFER_BIT;const re=[],ke=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ye=i.get(A),Ee=A.isWebGLMultipleRenderTargets===!0;if(Ee)for(let Oe=0;Oe<w.length;Oe++)t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let Oe=0;Oe<w.length;Oe++){re.push(n.COLOR_ATTACHMENT0+Oe),A.depthBuffer&&re.push(ke);const $e=ye.__ignoreDepthValues!==void 0?ye.__ignoreDepthValues:!1;if($e===!1&&(A.depthBuffer&&(ce|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&(ce|=n.STENCIL_BUFFER_BIT)),Ee&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ye.__webglColorRenderbuffer[Oe]),$e===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[ke]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[ke])),Ee){const le=i.get(w[Oe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,le,0)}n.blitFramebuffer(0,0,B,ue,0,0,B,ue,ce,n.NEAREST),d&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,re)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Ee)for(let Oe=0;Oe<w.length;Oe++){t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.RENDERBUFFER,ye.__webglColorRenderbuffer[Oe]);const $e=i.get(w[Oe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.TEXTURE_2D,$e,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}}function Be(A){return Math.min(a.maxSamples,A.samples)}function Le(A){const w=i.get(A);return o&&A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function pt(A){const w=r.render.frame;c.get(A)!==w&&(c.set(A,w),A.update())}function Xe(A,w){const B=A.colorSpace,ue=A.format,ce=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||A.format===ao||B!==zn&&B!==ln&&(ct.getTransfer(B)===mt?o===!1?e.has("EXT_sRGB")===!0&&ue===mn?(A.format=ao,A.minFilter=sn,A.generateMipmaps=!1):w=Vc.sRGBToLinear(w):(ue!==mn||ce!==Qn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),w}this.allocateTextureUnit=P,this.resetTextureUnits=se,this.setTexture2D=X,this.setTexture2DArray=ne,this.setTexture3D=$,this.setTextureCube=K,this.rebindTextures=et,this.setupRenderTarget=F,this.updateRenderTargetMipmap=Rt,this.updateMultisampleRenderTarget=De,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=Le}function zm(n,e,t){const i=t.isWebGL2;function a(s,r=ln){let o;const l=ct.getTransfer(r);if(s===Qn)return n.UNSIGNED_BYTE;if(s===Ic)return n.UNSIGNED_SHORT_4_4_4_4;if(s===Uc)return n.UNSIGNED_SHORT_5_5_5_1;if(s===bu)return n.BYTE;if(s===_u)return n.SHORT;if(s===go)return n.UNSIGNED_SHORT;if(s===Dc)return n.INT;if(s===jn)return n.UNSIGNED_INT;if(s===Kn)return n.FLOAT;if(s===Na)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===yu)return n.ALPHA;if(s===mn)return n.RGBA;if(s===wu)return n.LUMINANCE;if(s===Mu)return n.LUMINANCE_ALPHA;if(s===bi)return n.DEPTH_COMPONENT;if(s===ia)return n.DEPTH_STENCIL;if(s===ao)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===Su)return n.RED;if(s===Nc)return n.RED_INTEGER;if(s===Eu)return n.RG;if(s===Oc)return n.RG_INTEGER;if(s===zc)return n.RGBA_INTEGER;if(s===Zs||s===Qs||s===er||s===tr)if(l===mt)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Zs)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Qs)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===er)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===tr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Zs)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Qs)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===er)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===tr)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ko||s===Jo||s===Zo||s===Qo)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===Ko)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Jo)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Zo)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Qo)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Fc)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===el||s===tl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===el)return l===mt?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===tl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===nl||s===il||s===al||s===sl||s===rl||s===ol||s===ll||s===cl||s===dl||s===ul||s===pl||s===hl||s===fl||s===ml)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===nl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===il)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===al)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===sl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===rl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===ol)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===ll)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===cl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===dl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ul)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===pl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===hl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===fl)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===ml)return l===mt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===nr||s===gl||s===xl)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===nr)return l===mt?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===gl)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===xl)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Tu||s===vl||s===bl||s===_l)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===nr)return o.COMPRESSED_RED_RGTC1_EXT;if(s===vl)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===bl)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===_l)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===vi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:a}}class Fm extends Kt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class jt extends Lt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Bm={type:"move"};class Ar{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new jt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new jt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new jt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let a=null,s=null,r=null;const o=this._targetRay,l=this._grip,d=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(d&&e.hand){r=!0;for(const x of e.hand.values()){const m=t.getJointPose(x,i),u=this._getHandJoint(d,x);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const c=d.joints["index-finger-tip"],p=d.joints["thumb-tip"],f=c.position.distanceTo(p.position),h=.02,g=.005;d.inputState.pinching&&f>h+g?(d.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!d.inputState.pinching&&f<=h-g&&(d.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(a=t.getPose(e.targetRaySpace,i),a===null&&s!==null&&(a=s),a!==null&&(o.matrix.fromArray(a.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,a.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(a.linearVelocity)):o.hasLinearVelocity=!1,a.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(a.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Bm)))}return o!==null&&(o.visible=a!==null),l!==null&&(l.visible=s!==null),d!==null&&(d.visible=r!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new jt;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class Hm extends la{constructor(e,t){super();const i=this;let a=null,s=1,r=null,o="local-floor",l=1,d=null,c=null,p=null,f=null,h=null,g=null;const x=t.getContextAttributes();let m=null,u=null;const v=[],b=[],_=new we;let k=null;const M=new Kt;M.layers.enable(1),M.viewport=new gt;const E=new Kt;E.layers.enable(2),E.viewport=new gt;const I=[M,E],y=new Fm;y.layers.enable(1),y.layers.enable(2);let T=null,N=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(O){let te=v[O];return te===void 0&&(te=new Ar,v[O]=te),te.getTargetRaySpace()},this.getControllerGrip=function(O){let te=v[O];return te===void 0&&(te=new Ar,v[O]=te),te.getGripSpace()},this.getHand=function(O){let te=v[O];return te===void 0&&(te=new Ar,v[O]=te),te.getHandSpace()};function H(O){const te=b.indexOf(O.inputSource);if(te===-1)return;const Y=v[te];Y!==void 0&&(Y.update(O.inputSource,O.frame,d||r),Y.dispatchEvent({type:O.type,data:O.inputSource}))}function se(){a.removeEventListener("select",H),a.removeEventListener("selectstart",H),a.removeEventListener("selectend",H),a.removeEventListener("squeeze",H),a.removeEventListener("squeezestart",H),a.removeEventListener("squeezeend",H),a.removeEventListener("end",se),a.removeEventListener("inputsourceschange",P);for(let O=0;O<v.length;O++){const te=b[O];te!==null&&(b[O]=null,v[O].disconnect(te))}T=null,N=null,e.setRenderTarget(m),h=null,f=null,p=null,a=null,u=null,Z.stop(),i.isPresenting=!1,e.setPixelRatio(k),e.setSize(_.width,_.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(O){s=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(O){o=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return d||r},this.setReferenceSpace=function(O){d=O},this.getBaseLayer=function(){return f!==null?f:h},this.getBinding=function(){return p},this.getFrame=function(){return g},this.getSession=function(){return a},this.setSession=async function(O){if(a=O,a!==null){if(m=e.getRenderTarget(),a.addEventListener("select",H),a.addEventListener("selectstart",H),a.addEventListener("selectend",H),a.addEventListener("squeeze",H),a.addEventListener("squeezestart",H),a.addEventListener("squeezeend",H),a.addEventListener("end",se),a.addEventListener("inputsourceschange",P),x.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(_),a.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const te={antialias:a.renderState.layers===void 0?x.antialias:!0,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(a,t,te),a.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),u=new yi(h.framebufferWidth,h.framebufferHeight,{format:mn,type:Qn,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let te=null,Y=null,me=null;x.depth&&(me=x.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,te=x.stencil?ia:bi,Y=x.stencil?vi:jn);const fe={colorFormat:t.RGBA8,depthFormat:me,scaleFactor:s};p=new XRWebGLBinding(a,t),f=p.createProjectionLayer(fe),a.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),u=new yi(f.textureWidth,f.textureHeight,{format:mn,type:Qn,depthTexture:new nd(f.textureWidth,f.textureHeight,Y,void 0,void 0,void 0,void 0,void 0,void 0,te),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0});const Ce=e.properties.get(u);Ce.__ignoreDepthValues=f.ignoreDepthValues}u.isXRRenderTarget=!0,this.setFoveation(l),d=null,r=await a.requestReferenceSpace(o),Z.setContext(a),Z.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode};function P(O){for(let te=0;te<O.removed.length;te++){const Y=O.removed[te],me=b.indexOf(Y);me>=0&&(b[me]=null,v[me].disconnect(Y))}for(let te=0;te<O.added.length;te++){const Y=O.added[te];let me=b.indexOf(Y);if(me===-1){for(let Ce=0;Ce<v.length;Ce++)if(Ce>=b.length){b.push(Y),me=Ce;break}else if(b[Ce]===null){b[Ce]=Y,me=Ce;break}if(me===-1)break}const fe=v[me];fe&&fe.connect(Y)}}const z=new L,X=new L;function ne(O,te,Y){z.setFromMatrixPosition(te.matrixWorld),X.setFromMatrixPosition(Y.matrixWorld);const me=z.distanceTo(X),fe=te.projectionMatrix.elements,Ce=Y.projectionMatrix.elements,Ue=fe[14]/(fe[10]-1),Ne=fe[14]/(fe[10]+1),et=(fe[9]+1)/fe[5],F=(fe[9]-1)/fe[5],Rt=(fe[8]-1)/fe[0],De=(Ce[8]+1)/Ce[0],Be=Ue*Rt,Le=Ue*De,pt=me/(-Rt+De),Xe=pt*-Rt;te.matrixWorld.decompose(O.position,O.quaternion,O.scale),O.translateX(Xe),O.translateZ(pt),O.matrixWorld.compose(O.position,O.quaternion,O.scale),O.matrixWorldInverse.copy(O.matrixWorld).invert();const A=Ue+pt,w=Ne+pt,B=Be-Xe,ue=Le+(me-Xe),ce=et*Ne/w*A,re=F*Ne/w*A;O.projectionMatrix.makePerspective(B,ue,ce,re,A,w),O.projectionMatrixInverse.copy(O.projectionMatrix).invert()}function $(O,te){te===null?O.matrixWorld.copy(O.matrix):O.matrixWorld.multiplyMatrices(te.matrixWorld,O.matrix),O.matrixWorldInverse.copy(O.matrixWorld).invert()}this.updateCamera=function(O){if(a===null)return;y.near=E.near=M.near=O.near,y.far=E.far=M.far=O.far,(T!==y.near||N!==y.far)&&(a.updateRenderState({depthNear:y.near,depthFar:y.far}),T=y.near,N=y.far);const te=O.parent,Y=y.cameras;$(y,te);for(let me=0;me<Y.length;me++)$(Y[me],te);Y.length===2?ne(y,M,E):y.projectionMatrix.copy(M.projectionMatrix),K(O,y,te)};function K(O,te,Y){Y===null?O.matrix.copy(te.matrixWorld):(O.matrix.copy(Y.matrixWorld),O.matrix.invert(),O.matrix.multiply(te.matrixWorld)),O.matrix.decompose(O.position,O.quaternion,O.scale),O.updateMatrixWorld(!0),O.projectionMatrix.copy(te.projectionMatrix),O.projectionMatrixInverse.copy(te.projectionMatrixInverse),O.isPerspectiveCamera&&(O.fov=so*2*Math.atan(1/O.projectionMatrix.elements[5]),O.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&h===null))return l},this.setFoveation=function(O){l=O,f!==null&&(f.fixedFoveation=O),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=O)};let J=null;function V(O,te){if(c=te.getViewerPose(d||r),g=te,c!==null){const Y=c.views;h!==null&&(e.setRenderTargetFramebuffer(u,h.framebuffer),e.setRenderTarget(u));let me=!1;Y.length!==y.cameras.length&&(y.cameras.length=0,me=!0);for(let fe=0;fe<Y.length;fe++){const Ce=Y[fe];let Ue=null;if(h!==null)Ue=h.getViewport(Ce);else{const et=p.getViewSubImage(f,Ce);Ue=et.viewport,fe===0&&(e.setRenderTargetTextures(u,et.colorTexture,f.ignoreDepthValues?void 0:et.depthStencilTexture),e.setRenderTarget(u))}let Ne=I[fe];Ne===void 0&&(Ne=new Kt,Ne.layers.enable(fe),Ne.viewport=new gt,I[fe]=Ne),Ne.matrix.fromArray(Ce.transform.matrix),Ne.matrix.decompose(Ne.position,Ne.quaternion,Ne.scale),Ne.projectionMatrix.fromArray(Ce.projectionMatrix),Ne.projectionMatrixInverse.copy(Ne.projectionMatrix).invert(),Ne.viewport.set(Ue.x,Ue.y,Ue.width,Ue.height),fe===0&&(y.matrix.copy(Ne.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),me===!0&&y.cameras.push(Ne)}}for(let Y=0;Y<v.length;Y++){const me=b[Y],fe=v[Y];me!==null&&fe!==void 0&&fe.update(me,te,d||r)}J&&J(O,te),te.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:te}),g=null}const Z=new ed;Z.setAnimationLoop(V),this.setAnimationLoop=function(O){J=O},this.dispose=function(){}}}function Gm(n,e){function t(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,Jc(n)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function a(m,u,v,b,_){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(m,u):u.isMeshToonMaterial?(s(m,u),p(m,u)):u.isMeshPhongMaterial?(s(m,u),c(m,u)):u.isMeshStandardMaterial?(s(m,u),f(m,u),u.isMeshPhysicalMaterial&&h(m,u,_)):u.isMeshMatcapMaterial?(s(m,u),g(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),x(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(r(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,v,b):u.isSpriteMaterial?d(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,t(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Ht&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,t(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Ht&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,t(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,t(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const v=e.get(u).envMap;if(v&&(m.envMap.value=v,m.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap){m.lightMap.value=u.lightMap;const b=n._useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=u.lightMapIntensity*b,t(u.lightMap,m.lightMapTransform)}u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,m.aoMapTransform))}function r(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,v,b){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*v,m.scale.value=b*.5,u.map&&(m.map.value=u.map,t(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function p(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function f(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,m.roughnessMapTransform)),e.get(u).envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function h(m,u,v){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Ht&&m.clearcoatNormalScale.value.negate())),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,u){u.matcap&&(m.matcap.value=u.matcap)}function x(m,u){const v=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:a}}function Vm(n,e,t,i){let a={},s={},r=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(v,b){const _=b.program;i.uniformBlockBinding(v,_)}function d(v,b){let _=a[v.id];_===void 0&&(g(v),_=c(v),a[v.id]=_,v.addEventListener("dispose",m));const k=b.program;i.updateUBOMapping(v,k);const M=e.render.frame;s[v.id]!==M&&(f(v),s[v.id]=M)}function c(v){const b=p();v.__bindingPointIndex=b;const _=n.createBuffer(),k=v.__size,M=v.usage;return n.bindBuffer(n.UNIFORM_BUFFER,_),n.bufferData(n.UNIFORM_BUFFER,k,M),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,_),_}function p(){for(let v=0;v<o;v++)if(r.indexOf(v)===-1)return r.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(v){const b=a[v.id],_=v.uniforms,k=v.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let M=0,E=_.length;M<E;M++){const I=Array.isArray(_[M])?_[M]:[_[M]];for(let y=0,T=I.length;y<T;y++){const N=I[y];if(h(N,M,y,k)===!0){const H=N.__offset,se=Array.isArray(N.value)?N.value:[N.value];let P=0;for(let z=0;z<se.length;z++){const X=se[z],ne=x(X);typeof X=="number"||typeof X=="boolean"?(N.__data[0]=X,n.bufferSubData(n.UNIFORM_BUFFER,H+P,N.__data)):X.isMatrix3?(N.__data[0]=X.elements[0],N.__data[1]=X.elements[1],N.__data[2]=X.elements[2],N.__data[3]=0,N.__data[4]=X.elements[3],N.__data[5]=X.elements[4],N.__data[6]=X.elements[5],N.__data[7]=0,N.__data[8]=X.elements[6],N.__data[9]=X.elements[7],N.__data[10]=X.elements[8],N.__data[11]=0):(X.toArray(N.__data,P),P+=ne.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,H,N.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function h(v,b,_,k){const M=v.value,E=b+"_"+_;if(k[E]===void 0)return typeof M=="number"||typeof M=="boolean"?k[E]=M:k[E]=M.clone(),!0;{const I=k[E];if(typeof M=="number"||typeof M=="boolean"){if(I!==M)return k[E]=M,!0}else if(I.equals(M)===!1)return I.copy(M),!0}return!1}function g(v){const b=v.uniforms;let _=0;const k=16;for(let E=0,I=b.length;E<I;E++){const y=Array.isArray(b[E])?b[E]:[b[E]];for(let T=0,N=y.length;T<N;T++){const H=y[T],se=Array.isArray(H.value)?H.value:[H.value];for(let P=0,z=se.length;P<z;P++){const X=se[P],ne=x(X),$=_%k;$!==0&&k-$<ne.boundary&&(_+=k-$),H.__data=new Float32Array(ne.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=_,_+=ne.storage}}}const M=_%k;return M>0&&(_+=k-M),v.__size=_,v.__cache={},this}function x(v){const b={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(b.boundary=4,b.storage=4):v.isVector2?(b.boundary=8,b.storage=8):v.isVector3||v.isColor?(b.boundary=16,b.storage=12):v.isVector4?(b.boundary=16,b.storage=16):v.isMatrix3?(b.boundary=48,b.storage=48):v.isMatrix4?(b.boundary=64,b.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),b}function m(v){const b=v.target;b.removeEventListener("dispose",m);const _=r.indexOf(b.__bindingPointIndex);r.splice(_,1),n.deleteBuffer(a[b.id]),delete a[b.id],delete s[b.id]}function u(){for(const v in a)n.deleteBuffer(a[v]);r=[],a={},s={}}return{bind:l,update:d,dispose:u}}class yo{constructor(e={}){const{canvas:t=zu(),context:i=null,depth:a=!0,stencil:s=!0,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:d=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:p=!1}=e;this.isWebGLRenderer=!0;let f;i!==null?f=i.getContextAttributes().alpha:f=r;const h=new Uint32Array(4),g=new Int32Array(4);let x=null,m=null;const u=[],v=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=It,this._useLegacyLights=!1,this.toneMapping=Zn,this.toneMappingExposure=1;const b=this;let _=!1,k=0,M=0,E=null,I=-1,y=null;const T=new gt,N=new gt;let H=null;const se=new Ve(0);let P=0,z=t.width,X=t.height,ne=1,$=null,K=null;const J=new gt(0,0,z,X),V=new gt(0,0,z,X);let Z=!1;const O=new bo;let te=!1,Y=!1,me=null;const fe=new bt,Ce=new we,Ue=new L,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function et(){return E===null?ne:1}let F=i;function Rt(S,U){for(let W=0;W<S.length;W++){const q=S[W],G=t.getContext(q,U);if(G!==null)return G}return null}try{const S={alpha:!0,depth:a,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:d,powerPreference:c,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ho}`),t.addEventListener("webglcontextlost",ee,!1),t.addEventListener("webglcontextrestored",R,!1),t.addEventListener("webglcontextcreationerror",de,!1),F===null){const U=["webgl2","webgl","experimental-webgl"];if(b.isWebGL1Renderer===!0&&U.shift(),F=Rt(U,S),F===null)throw Rt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&F instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),F.getShaderPrecisionFormat===void 0&&(F.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let De,Be,Le,pt,Xe,A,w,B,ue,ce,re,ke,ye,Ee,Oe,$e,le,st,Ke,He,Pe,D,ie,_e;function Ae(){De=new Qf(F),Be=new $f(F,De,e),De.init(Be),D=new zm(F,De,Be),Le=new Nm(F,De,Be),pt=new n0(F),Xe=new wm,A=new Om(F,De,Le,Xe,Be,D,pt),w=new jf(b),B=new Zf(b),ue=new cp(F,Be),ie=new Xf(F,De,ue,Be),ce=new e0(F,ue,pt,ie),re=new r0(F,ce,ue,pt),Ke=new s0(F,Be,A),$e=new Yf(Xe),ke=new ym(b,w,B,De,Be,ie,$e),ye=new Gm(b,Xe),Ee=new Sm,Oe=new Cm(De,Be),st=new Wf(b,w,B,Le,re,f,l),le=new Um(b,re,Be),_e=new Vm(F,pt,Be,Le),He=new qf(F,De,pt,Be),Pe=new t0(F,De,pt,Be),pt.programs=ke.programs,b.capabilities=Be,b.extensions=De,b.properties=Xe,b.renderLists=Ee,b.shadowMap=le,b.state=Le,b.info=pt}Ae();const Te=new Hm(b,F);this.xr=Te,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const S=De.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=De.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return ne},this.setPixelRatio=function(S){S!==void 0&&(ne=S,this.setSize(z,X,!1))},this.getSize=function(S){return S.set(z,X)},this.setSize=function(S,U,W=!0){if(Te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}z=S,X=U,t.width=Math.floor(S*ne),t.height=Math.floor(U*ne),W===!0&&(t.style.width=S+"px",t.style.height=U+"px"),this.setViewport(0,0,S,U)},this.getDrawingBufferSize=function(S){return S.set(z*ne,X*ne).floor()},this.setDrawingBufferSize=function(S,U,W){z=S,X=U,ne=W,t.width=Math.floor(S*W),t.height=Math.floor(U*W),this.setViewport(0,0,S,U)},this.getCurrentViewport=function(S){return S.copy(T)},this.getViewport=function(S){return S.copy(J)},this.setViewport=function(S,U,W,q){S.isVector4?J.set(S.x,S.y,S.z,S.w):J.set(S,U,W,q),Le.viewport(T.copy(J).multiplyScalar(ne).floor())},this.getScissor=function(S){return S.copy(V)},this.setScissor=function(S,U,W,q){S.isVector4?V.set(S.x,S.y,S.z,S.w):V.set(S,U,W,q),Le.scissor(N.copy(V).multiplyScalar(ne).floor())},this.getScissorTest=function(){return Z},this.setScissorTest=function(S){Le.setScissorTest(Z=S)},this.setOpaqueSort=function(S){$=S},this.setTransparentSort=function(S){K=S},this.getClearColor=function(S){return S.copy(st.getClearColor())},this.setClearColor=function(){st.setClearColor.apply(st,arguments)},this.getClearAlpha=function(){return st.getClearAlpha()},this.setClearAlpha=function(){st.setClearAlpha.apply(st,arguments)},this.clear=function(S=!0,U=!0,W=!0){let q=0;if(S){let G=!1;if(E!==null){const Se=E.texture.format;G=Se===zc||Se===Oc||Se===Nc}if(G){const Se=E.texture.type,Re=Se===Qn||Se===jn||Se===go||Se===vi||Se===Ic||Se===Uc,ze=st.getClearColor(),Ge=st.getClearAlpha(),Je=ze.r,qe=ze.g,Ye=ze.b;Re?(h[0]=Je,h[1]=qe,h[2]=Ye,h[3]=Ge,F.clearBufferuiv(F.COLOR,0,h)):(g[0]=Je,g[1]=qe,g[2]=Ye,g[3]=Ge,F.clearBufferiv(F.COLOR,0,g))}else q|=F.COLOR_BUFFER_BIT}U&&(q|=F.DEPTH_BUFFER_BIT),W&&(q|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ee,!1),t.removeEventListener("webglcontextrestored",R,!1),t.removeEventListener("webglcontextcreationerror",de,!1),Ee.dispose(),Oe.dispose(),Xe.dispose(),w.dispose(),B.dispose(),re.dispose(),ie.dispose(),_e.dispose(),ke.dispose(),Te.dispose(),Te.removeEventListener("sessionstart",Vt),Te.removeEventListener("sessionend",ht),me&&(me.dispose(),me=null),Wt.stop()};function ee(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),_=!0}function R(){console.log("THREE.WebGLRenderer: Context Restored."),_=!1;const S=pt.autoReset,U=le.enabled,W=le.autoUpdate,q=le.needsUpdate,G=le.type;Ae(),pt.autoReset=S,le.enabled=U,le.autoUpdate=W,le.needsUpdate=q,le.type=G}function de(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function he(S){const U=S.target;U.removeEventListener("dispose",he),j(U)}function j(S){pe(S),Xe.remove(S)}function pe(S){const U=Xe.get(S).programs;U!==void 0&&(U.forEach(function(W){ke.releaseProgram(W)}),S.isShaderMaterial&&ke.releaseShaderCache(S))}this.renderBufferDirect=function(S,U,W,q,G,Se){U===null&&(U=Ne);const Re=G.isMesh&&G.matrixWorld.determinant()<0,ze=Nd(S,U,W,q,G);Le.setMaterial(q,Re);let Ge=W.index,Je=1;if(q.wireframe===!0){if(Ge=ce.getWireframeAttribute(W),Ge===void 0)return;Je=2}const qe=W.drawRange,Ye=W.attributes.position;let Mt=qe.start*Je,Qt=(qe.start+qe.count)*Je;Se!==null&&(Mt=Math.max(Mt,Se.start*Je),Qt=Math.min(Qt,(Se.start+Se.count)*Je)),Ge!==null?(Mt=Math.max(Mt,0),Qt=Math.min(Qt,Ge.count)):Ye!=null&&(Mt=Math.max(Mt,0),Qt=Math.min(Qt,Ye.count));const Pt=Qt-Mt;if(Pt<0||Pt===1/0)return;ie.setup(G,q,ze,W,Ge);let En,vt=He;if(Ge!==null&&(En=ue.get(Ge),vt=Pe,vt.setIndex(En)),G.isMesh)q.wireframe===!0?(Le.setLineWidth(q.wireframeLinewidth*et()),vt.setMode(F.LINES)):vt.setMode(F.TRIANGLES);else if(G.isLine){let Ze=q.linewidth;Ze===void 0&&(Ze=1),Le.setLineWidth(Ze*et()),G.isLineSegments?vt.setMode(F.LINES):G.isLineLoop?vt.setMode(F.LINE_LOOP):vt.setMode(F.LINE_STRIP)}else G.isPoints?vt.setMode(F.POINTS):G.isSprite&&vt.setMode(F.TRIANGLES);if(G.isBatchedMesh)vt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else if(G.isInstancedMesh)vt.renderInstances(Mt,Pt,G.count);else if(W.isInstancedBufferGeometry){const Ze=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,$s=Math.min(W.instanceCount,Ze);vt.renderInstances(Mt,Pt,$s)}else vt.render(Mt,Pt)};function nt(S,U,W){S.transparent===!0&&S.side===At&&S.forceSinglePass===!1?(S.side=Ht,S.needsUpdate=!0,Wa(S,U,W),S.side=ni,S.needsUpdate=!0,Wa(S,U,W),S.side=At):Wa(S,U,W)}this.compile=function(S,U,W=null){W===null&&(W=S),m=Oe.get(W),m.init(),v.push(m),W.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),S!==W&&S.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),m.setupLights(b._useLegacyLights);const q=new Set;return S.traverse(function(G){const Se=G.material;if(Se)if(Array.isArray(Se))for(let Re=0;Re<Se.length;Re++){const ze=Se[Re];nt(ze,W,G),q.add(ze)}else nt(Se,W,G),q.add(Se)}),v.pop(),m=null,q},this.compileAsync=function(S,U,W=null){const q=this.compile(S,U,W);return new Promise(G=>{function Se(){if(q.forEach(function(Re){Xe.get(Re).currentProgram.isReady()&&q.delete(Re)}),q.size===0){G(S);return}setTimeout(Se,10)}De.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let it=null;function Et(S){it&&it(S)}function Vt(){Wt.stop()}function ht(){Wt.start()}const Wt=new ed;Wt.setAnimationLoop(Et),typeof self<"u"&&Wt.setContext(self),this.setAnimationLoop=function(S){it=S,Te.setAnimationLoop(S),S===null?Wt.stop():Wt.start()},Te.addEventListener("sessionstart",Vt),Te.addEventListener("sessionend",ht),this.render=function(S,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(_===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),Te.enabled===!0&&Te.isPresenting===!0&&(Te.cameraAutoUpdate===!0&&Te.updateCamera(U),U=Te.getCamera()),S.isScene===!0&&S.onBeforeRender(b,S,U,E),m=Oe.get(S,v.length),m.init(),v.push(m),fe.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),O.setFromProjectionMatrix(fe),Y=this.localClippingEnabled,te=$e.init(this.clippingPlanes,Y),x=Ee.get(S,u.length),x.init(),u.push(x),vn(S,U,0,b.sortObjects),x.finish(),b.sortObjects===!0&&x.sort($,K),this.info.render.frame++,te===!0&&$e.beginShadows();const W=m.state.shadowsArray;if(le.render(W,S,U),te===!0&&$e.endShadows(),this.info.autoReset===!0&&this.info.reset(),st.render(x,S),m.setupLights(b._useLegacyLights),U.isArrayCamera){const q=U.cameras;for(let G=0,Se=q.length;G<Se;G++){const Re=q[G];Oo(x,S,Re,Re.viewport)}}else Oo(x,S,U);E!==null&&(A.updateMultisampleRenderTarget(E),A.updateRenderTargetMipmap(E)),S.isScene===!0&&S.onAfterRender(b,S,U),ie.resetDefaultState(),I=-1,y=null,v.pop(),v.length>0?m=v[v.length-1]:m=null,u.pop(),u.length>0?x=u[u.length-1]:x=null};function vn(S,U,W,q){if(S.visible===!1)return;if(S.layers.test(U.layers)){if(S.isGroup)W=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(U);else if(S.isLight)m.pushLight(S),S.castShadow&&m.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||O.intersectsSprite(S)){q&&Ue.setFromMatrixPosition(S.matrixWorld).applyMatrix4(fe);const Re=re.update(S),ze=S.material;ze.visible&&x.push(S,Re,ze,W,Ue.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||O.intersectsObject(S))){const Re=re.update(S),ze=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ue.copy(S.boundingSphere.center)):(Re.boundingSphere===null&&Re.computeBoundingSphere(),Ue.copy(Re.boundingSphere.center)),Ue.applyMatrix4(S.matrixWorld).applyMatrix4(fe)),Array.isArray(ze)){const Ge=Re.groups;for(let Je=0,qe=Ge.length;Je<qe;Je++){const Ye=Ge[Je],Mt=ze[Ye.materialIndex];Mt&&Mt.visible&&x.push(S,Re,Mt,W,Ue.z,Ye)}}else ze.visible&&x.push(S,Re,ze,W,Ue.z,null)}}const Se=S.children;for(let Re=0,ze=Se.length;Re<ze;Re++)vn(Se[Re],U,W,q)}function Oo(S,U,W,q){const G=S.opaque,Se=S.transmissive,Re=S.transparent;m.setupLightsView(W),te===!0&&$e.setGlobalState(b.clippingPlanes,W),Se.length>0&&Ud(G,Se,U,W),q&&Le.viewport(T.copy(q)),G.length>0&&Va(G,U,W),Se.length>0&&Va(Se,U,W),Re.length>0&&Va(Re,U,W),Le.buffers.depth.setTest(!0),Le.buffers.depth.setMask(!0),Le.buffers.color.setMask(!0),Le.setPolygonOffset(!1)}function Ud(S,U,W,q){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;const Se=Be.isWebGL2;me===null&&(me=new yi(1,1,{generateMipmaps:!0,type:De.has("EXT_color_buffer_half_float")?Na:Qn,minFilter:Ua,samples:Se?4:0})),b.getDrawingBufferSize(Ce),Se?me.setSize(Ce.x,Ce.y):me.setSize(ro(Ce.x),ro(Ce.y));const Re=b.getRenderTarget();b.setRenderTarget(me),b.getClearColor(se),P=b.getClearAlpha(),P<1&&b.setClearColor(16777215,.5),b.clear();const ze=b.toneMapping;b.toneMapping=Zn,Va(S,W,q),A.updateMultisampleRenderTarget(me),A.updateRenderTargetMipmap(me);let Ge=!1;for(let Je=0,qe=U.length;Je<qe;Je++){const Ye=U[Je],Mt=Ye.object,Qt=Ye.geometry,Pt=Ye.material,En=Ye.group;if(Pt.side===At&&Mt.layers.test(q.layers)){const vt=Pt.side;Pt.side=Ht,Pt.needsUpdate=!0,zo(Mt,W,q,Qt,Pt,En),Pt.side=vt,Pt.needsUpdate=!0,Ge=!0}}Ge===!0&&(A.updateMultisampleRenderTarget(me),A.updateRenderTargetMipmap(me)),b.setRenderTarget(Re),b.setClearColor(se,P),b.toneMapping=ze}function Va(S,U,W){const q=U.isScene===!0?U.overrideMaterial:null;for(let G=0,Se=S.length;G<Se;G++){const Re=S[G],ze=Re.object,Ge=Re.geometry,Je=q===null?Re.material:q,qe=Re.group;ze.layers.test(W.layers)&&zo(ze,U,W,Ge,Je,qe)}}function zo(S,U,W,q,G,Se){S.onBeforeRender(b,U,W,q,G,Se),S.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),G.onBeforeRender(b,U,W,q,S,Se),G.transparent===!0&&G.side===At&&G.forceSinglePass===!1?(G.side=Ht,G.needsUpdate=!0,b.renderBufferDirect(W,U,q,G,S,Se),G.side=ni,G.needsUpdate=!0,b.renderBufferDirect(W,U,q,G,S,Se),G.side=At):b.renderBufferDirect(W,U,q,G,S,Se),S.onAfterRender(b,U,W,q,G,Se)}function Wa(S,U,W){U.isScene!==!0&&(U=Ne);const q=Xe.get(S),G=m.state.lights,Se=m.state.shadowsArray,Re=G.state.version,ze=ke.getParameters(S,G.state,Se,U,W),Ge=ke.getProgramCacheKey(ze);let Je=q.programs;q.environment=S.isMeshStandardMaterial?U.environment:null,q.fog=U.fog,q.envMap=(S.isMeshStandardMaterial?B:w).get(S.envMap||q.environment),Je===void 0&&(S.addEventListener("dispose",he),Je=new Map,q.programs=Je);let qe=Je.get(Ge);if(qe!==void 0){if(q.currentProgram===qe&&q.lightsStateVersion===Re)return Bo(S,ze),qe}else ze.uniforms=ke.getUniforms(S),S.onBuild(W,ze,b),S.onBeforeCompile(ze,b),qe=ke.acquireProgram(ze,Ge),Je.set(Ge,qe),q.uniforms=ze.uniforms;const Ye=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ye.clippingPlanes=$e.uniform),Bo(S,ze),q.needsLights=zd(S),q.lightsStateVersion=Re,q.needsLights&&(Ye.ambientLightColor.value=G.state.ambient,Ye.lightProbe.value=G.state.probe,Ye.directionalLights.value=G.state.directional,Ye.directionalLightShadows.value=G.state.directionalShadow,Ye.spotLights.value=G.state.spot,Ye.spotLightShadows.value=G.state.spotShadow,Ye.rectAreaLights.value=G.state.rectArea,Ye.ltc_1.value=G.state.rectAreaLTC1,Ye.ltc_2.value=G.state.rectAreaLTC2,Ye.pointLights.value=G.state.point,Ye.pointLightShadows.value=G.state.pointShadow,Ye.hemisphereLights.value=G.state.hemi,Ye.directionalShadowMap.value=G.state.directionalShadowMap,Ye.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ye.spotShadowMap.value=G.state.spotShadowMap,Ye.spotLightMatrix.value=G.state.spotLightMatrix,Ye.spotLightMap.value=G.state.spotLightMap,Ye.pointShadowMap.value=G.state.pointShadowMap,Ye.pointShadowMatrix.value=G.state.pointShadowMatrix),q.currentProgram=qe,q.uniformsList=null,qe}function Fo(S){if(S.uniformsList===null){const U=S.currentProgram.getUniforms();S.uniformsList=Es.seqWithValue(U.seq,S.uniforms)}return S.uniformsList}function Bo(S,U){const W=Xe.get(S);W.outputColorSpace=U.outputColorSpace,W.batching=U.batching,W.instancing=U.instancing,W.instancingColor=U.instancingColor,W.skinning=U.skinning,W.morphTargets=U.morphTargets,W.morphNormals=U.morphNormals,W.morphColors=U.morphColors,W.morphTargetsCount=U.morphTargetsCount,W.numClippingPlanes=U.numClippingPlanes,W.numIntersection=U.numClipIntersection,W.vertexAlphas=U.vertexAlphas,W.vertexTangents=U.vertexTangents,W.toneMapping=U.toneMapping}function Nd(S,U,W,q,G){U.isScene!==!0&&(U=Ne),A.resetTextureUnits();const Se=U.fog,Re=q.isMeshStandardMaterial?U.environment:null,ze=E===null?b.outputColorSpace:E.isXRRenderTarget===!0?E.texture.colorSpace:zn,Ge=(q.isMeshStandardMaterial?B:w).get(q.envMap||Re),Je=q.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,qe=!!W.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ye=!!W.morphAttributes.position,Mt=!!W.morphAttributes.normal,Qt=!!W.morphAttributes.color;let Pt=Zn;q.toneMapped&&(E===null||E.isXRRenderTarget===!0)&&(Pt=b.toneMapping);const En=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,vt=En!==void 0?En.length:0,Ze=Xe.get(q),$s=m.state.lights;if(te===!0&&(Y===!0||S!==y)){const nn=S===y&&q.id===I;$e.setState(q,S,nn)}let yt=!1;q.version===Ze.__version?(Ze.needsLights&&Ze.lightsStateVersion!==$s.state.version||Ze.outputColorSpace!==ze||G.isBatchedMesh&&Ze.batching===!1||!G.isBatchedMesh&&Ze.batching===!0||G.isInstancedMesh&&Ze.instancing===!1||!G.isInstancedMesh&&Ze.instancing===!0||G.isSkinnedMesh&&Ze.skinning===!1||!G.isSkinnedMesh&&Ze.skinning===!0||G.isInstancedMesh&&Ze.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ze.instancingColor===!1&&G.instanceColor!==null||Ze.envMap!==Ge||q.fog===!0&&Ze.fog!==Se||Ze.numClippingPlanes!==void 0&&(Ze.numClippingPlanes!==$e.numPlanes||Ze.numIntersection!==$e.numIntersection)||Ze.vertexAlphas!==Je||Ze.vertexTangents!==qe||Ze.morphTargets!==Ye||Ze.morphNormals!==Mt||Ze.morphColors!==Qt||Ze.toneMapping!==Pt||Be.isWebGL2===!0&&Ze.morphTargetsCount!==vt)&&(yt=!0):(yt=!0,Ze.__version=q.version);let oi=Ze.currentProgram;yt===!0&&(oi=Wa(q,U,G));let Ho=!1,pa=!1,Ys=!1;const zt=oi.getUniforms(),li=Ze.uniforms;if(Le.useProgram(oi.program)&&(Ho=!0,pa=!0,Ys=!0),q.id!==I&&(I=q.id,pa=!0),Ho||y!==S){zt.setValue(F,"projectionMatrix",S.projectionMatrix),zt.setValue(F,"viewMatrix",S.matrixWorldInverse);const nn=zt.map.cameraPosition;nn!==void 0&&nn.setValue(F,Ue.setFromMatrixPosition(S.matrixWorld)),Be.logarithmicDepthBuffer&&zt.setValue(F,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&zt.setValue(F,"isOrthographic",S.isOrthographicCamera===!0),y!==S&&(y=S,pa=!0,Ys=!0)}if(G.isSkinnedMesh){zt.setOptional(F,G,"bindMatrix"),zt.setOptional(F,G,"bindMatrixInverse");const nn=G.skeleton;nn&&(Be.floatVertexTextures?(nn.boneTexture===null&&nn.computeBoneTexture(),zt.setValue(F,"boneTexture",nn.boneTexture,A)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}G.isBatchedMesh&&(zt.setOptional(F,G,"batchingTexture"),zt.setValue(F,"batchingTexture",G._matricesTexture,A));const js=W.morphAttributes;if((js.position!==void 0||js.normal!==void 0||js.color!==void 0&&Be.isWebGL2===!0)&&Ke.update(G,W,oi),(pa||Ze.receiveShadow!==G.receiveShadow)&&(Ze.receiveShadow=G.receiveShadow,zt.setValue(F,"receiveShadow",G.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(li.envMap.value=Ge,li.flipEnvMap.value=Ge.isCubeTexture&&Ge.isRenderTargetTexture===!1?-1:1),pa&&(zt.setValue(F,"toneMappingExposure",b.toneMappingExposure),Ze.needsLights&&Od(li,Ys),Se&&q.fog===!0&&ye.refreshFogUniforms(li,Se),ye.refreshMaterialUniforms(li,q,ne,X,me),Es.upload(F,Fo(Ze),li,A)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Es.upload(F,Fo(Ze),li,A),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&zt.setValue(F,"center",G.center),zt.setValue(F,"modelViewMatrix",G.modelViewMatrix),zt.setValue(F,"normalMatrix",G.normalMatrix),zt.setValue(F,"modelMatrix",G.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const nn=q.uniformsGroups;for(let Ks=0,Fd=nn.length;Ks<Fd;Ks++)if(Be.isWebGL2){const Go=nn[Ks];_e.update(Go,oi),_e.bind(Go,oi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return oi}function Od(S,U){S.ambientLightColor.needsUpdate=U,S.lightProbe.needsUpdate=U,S.directionalLights.needsUpdate=U,S.directionalLightShadows.needsUpdate=U,S.pointLights.needsUpdate=U,S.pointLightShadows.needsUpdate=U,S.spotLights.needsUpdate=U,S.spotLightShadows.needsUpdate=U,S.rectAreaLights.needsUpdate=U,S.hemisphereLights.needsUpdate=U}function zd(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return M},this.getRenderTarget=function(){return E},this.setRenderTargetTextures=function(S,U,W){Xe.get(S.texture).__webglTexture=U,Xe.get(S.depthTexture).__webglTexture=W;const q=Xe.get(S);q.__hasExternalTextures=!0,q.__hasExternalTextures&&(q.__autoAllocateDepthBuffer=W===void 0,q.__autoAllocateDepthBuffer||De.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,U){const W=Xe.get(S);W.__webglFramebuffer=U,W.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(S,U=0,W=0){E=S,k=U,M=W;let q=!0,G=null,Se=!1,Re=!1;if(S){const Ge=Xe.get(S);Ge.__useDefaultFramebuffer!==void 0?(Le.bindFramebuffer(F.FRAMEBUFFER,null),q=!1):Ge.__webglFramebuffer===void 0?A.setupRenderTarget(S):Ge.__hasExternalTextures&&A.rebindTextures(S,Xe.get(S.texture).__webglTexture,Xe.get(S.depthTexture).__webglTexture);const Je=S.texture;(Je.isData3DTexture||Je.isDataArrayTexture||Je.isCompressedArrayTexture)&&(Re=!0);const qe=Xe.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(qe[U])?G=qe[U][W]:G=qe[U],Se=!0):Be.isWebGL2&&S.samples>0&&A.useMultisampledRTT(S)===!1?G=Xe.get(S).__webglMultisampledFramebuffer:Array.isArray(qe)?G=qe[W]:G=qe,T.copy(S.viewport),N.copy(S.scissor),H=S.scissorTest}else T.copy(J).multiplyScalar(ne).floor(),N.copy(V).multiplyScalar(ne).floor(),H=Z;if(Le.bindFramebuffer(F.FRAMEBUFFER,G)&&Be.drawBuffers&&q&&Le.drawBuffers(S,G),Le.viewport(T),Le.scissor(N),Le.setScissorTest(H),Se){const Ge=Xe.get(S.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+U,Ge.__webglTexture,W)}else if(Re){const Ge=Xe.get(S.texture),Je=U||0;F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ge.__webglTexture,W||0,Je)}I=-1},this.readRenderTargetPixels=function(S,U,W,q,G,Se,Re){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ze=Xe.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(ze=ze[Re]),ze){Le.bindFramebuffer(F.FRAMEBUFFER,ze);try{const Ge=S.texture,Je=Ge.format,qe=Ge.type;if(Je!==mn&&D.convert(Je)!==F.getParameter(F.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ye=qe===Na&&(De.has("EXT_color_buffer_half_float")||Be.isWebGL2&&De.has("EXT_color_buffer_float"));if(qe!==Qn&&D.convert(qe)!==F.getParameter(F.IMPLEMENTATION_COLOR_READ_TYPE)&&!(qe===Kn&&(Be.isWebGL2||De.has("OES_texture_float")||De.has("WEBGL_color_buffer_float")))&&!Ye){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=S.width-q&&W>=0&&W<=S.height-G&&F.readPixels(U,W,q,G,D.convert(Je),D.convert(qe),Se)}finally{const Ge=E!==null?Xe.get(E).__webglFramebuffer:null;Le.bindFramebuffer(F.FRAMEBUFFER,Ge)}}},this.copyFramebufferToTexture=function(S,U,W=0){const q=Math.pow(2,-W),G=Math.floor(U.image.width*q),Se=Math.floor(U.image.height*q);A.setTexture2D(U,0),F.copyTexSubImage2D(F.TEXTURE_2D,W,0,0,S.x,S.y,G,Se),Le.unbindTexture()},this.copyTextureToTexture=function(S,U,W,q=0){const G=U.image.width,Se=U.image.height,Re=D.convert(W.format),ze=D.convert(W.type);A.setTexture2D(W,0),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,W.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,W.unpackAlignment),U.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,q,S.x,S.y,G,Se,Re,ze,U.image.data):U.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,q,S.x,S.y,U.mipmaps[0].width,U.mipmaps[0].height,Re,U.mipmaps[0].data):F.texSubImage2D(F.TEXTURE_2D,q,S.x,S.y,Re,ze,U.image),q===0&&W.generateMipmaps&&F.generateMipmap(F.TEXTURE_2D),Le.unbindTexture()},this.copyTextureToTexture3D=function(S,U,W,q,G=0){if(b.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Se=S.max.x-S.min.x+1,Re=S.max.y-S.min.y+1,ze=S.max.z-S.min.z+1,Ge=D.convert(q.format),Je=D.convert(q.type);let qe;if(q.isData3DTexture)A.setTexture3D(q,0),qe=F.TEXTURE_3D;else if(q.isDataArrayTexture||q.isCompressedArrayTexture)A.setTexture2DArray(q,0),qe=F.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,q.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,q.unpackAlignment);const Ye=F.getParameter(F.UNPACK_ROW_LENGTH),Mt=F.getParameter(F.UNPACK_IMAGE_HEIGHT),Qt=F.getParameter(F.UNPACK_SKIP_PIXELS),Pt=F.getParameter(F.UNPACK_SKIP_ROWS),En=F.getParameter(F.UNPACK_SKIP_IMAGES),vt=W.isCompressedTexture?W.mipmaps[G]:W.image;F.pixelStorei(F.UNPACK_ROW_LENGTH,vt.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,vt.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,S.min.x),F.pixelStorei(F.UNPACK_SKIP_ROWS,S.min.y),F.pixelStorei(F.UNPACK_SKIP_IMAGES,S.min.z),W.isDataTexture||W.isData3DTexture?F.texSubImage3D(qe,G,U.x,U.y,U.z,Se,Re,ze,Ge,Je,vt.data):W.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),F.compressedTexSubImage3D(qe,G,U.x,U.y,U.z,Se,Re,ze,Ge,vt.data)):F.texSubImage3D(qe,G,U.x,U.y,U.z,Se,Re,ze,Ge,Je,vt),F.pixelStorei(F.UNPACK_ROW_LENGTH,Ye),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Mt),F.pixelStorei(F.UNPACK_SKIP_PIXELS,Qt),F.pixelStorei(F.UNPACK_SKIP_ROWS,Pt),F.pixelStorei(F.UNPACK_SKIP_IMAGES,En),G===0&&q.generateMipmaps&&F.generateMipmap(qe),Le.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?A.setTextureCube(S,0):S.isData3DTexture?A.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?A.setTexture2DArray(S,0):A.setTexture2D(S,0),Le.unbindTexture()},this.resetState=function(){k=0,M=0,E=null,Le.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return In}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===vo?"display-p3":"srgb",t.unpackColorSpace=ct.workingColorSpace===Us?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===It?_i:Bc}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===_i?It:zn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class Wm extends yo{}Wm.prototype.isWebGL1Renderer=!0;class Ba{constructor(e,t=25e-5){this.isFogExp2=!0,this.name="",this.color=new Ve(e),this.density=t}clone(){return new Ba(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class Ha{constructor(e,t=1,i=1e3){this.isFog=!0,this.name="",this.color=new Ve(e),this.near=t,this.far=i}clone(){return new Ha(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class da extends Lt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class Xm{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=io,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=ei()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}get updateRange(){return console.warn("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(e){return this.usage=e,this}addUpdateRange(e,t){this.updateRanges.push({start:e,count:t})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let a=0,s=this.stride;a<s;a++)this.array[e+a]=t.array[i+a];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ei()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ei()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Xt=new L;class Ds{constructor(e,t,i,a=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=a}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)Xt.fromBufferAttribute(this,t),Xt.applyMatrix4(e),this.setXYZ(t,Xt.x,Xt.y,Xt.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)Xt.fromBufferAttribute(this,t),Xt.applyNormalMatrix(e),this.setXYZ(t,Xt.x,Xt.y,Xt.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)Xt.fromBufferAttribute(this,t),Xt.transformDirection(e),this.setXYZ(t,Xt.x,Xt.y,Xt.z);return this}setX(e,t){return this.normalized&&(t=ut(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=ut(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=ut(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=ut(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=Dn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=Dn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=Dn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=Dn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=ut(t,this.array),i=ut(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,a){return e=e*this.data.stride+this.offset,this.normalized&&(t=ut(t,this.array),i=ut(i,this.array),a=ut(a,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=a,this}setXYZW(e,t,i,a,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=ut(t,this.array),i=ut(i,this.array),a=ut(a,this.array),s=ut(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=a,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const a=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[a+s])}return new gn(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ds(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const a=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[a+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class ai extends ii{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ve(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Wi;const xa=new L,Xi=new L,qi=new L,$i=new we,va=new we,ld=new bt,hs=new L,ba=new L,fs=new L,lc=new we,Lr=new we,cc=new we;class Ai extends Lt{constructor(e=new ai){if(super(),this.isSprite=!0,this.type="Sprite",Wi===void 0){Wi=new xt;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new Xm(t,5);Wi.setIndex([0,1,2,0,2,3]),Wi.setAttribute("position",new Ds(i,3,0,!1)),Wi.setAttribute("uv",new Ds(i,2,3,!1))}this.geometry=Wi,this.material=e,this.center=new we(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Xi.setFromMatrixScale(this.matrixWorld),ld.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),qi.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Xi.multiplyScalar(-qi.z);const i=this.material.rotation;let a,s;i!==0&&(s=Math.cos(i),a=Math.sin(i));const r=this.center;ms(hs.set(-.5,-.5,0),qi,r,Xi,a,s),ms(ba.set(.5,-.5,0),qi,r,Xi,a,s),ms(fs.set(.5,.5,0),qi,r,Xi,a,s),lc.set(0,0),Lr.set(1,0),cc.set(1,1);let o=e.ray.intersectTriangle(hs,ba,fs,!1,xa);if(o===null&&(ms(ba.set(-.5,.5,0),qi,r,Xi,a,s),Lr.set(0,1),o=e.ray.intersectTriangle(hs,fs,ba,!1,xa),o===null))return;const l=e.ray.origin.distanceTo(xa);l<e.near||l>e.far||t.push({distance:l,point:xa.clone(),uv:rn.getInterpolation(xa,hs,ba,fs,lc,Lr,cc,new we),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function ms(n,e,t,i,a,s){$i.subVectors(n,t).addScalar(.5).multiply(i),a!==void 0?(va.x=s*$i.x-a*$i.y,va.y=a*$i.x+s*$i.y):va.copy($i),n.copy(e),n.x+=va.x,n.y+=va.y,n.applyMatrix4(ld)}class ua extends ii{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Ve(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const dc=new L,uc=new L,pc=new bt,kr=new qc,gs=new Ns;class Fn extends Lt{constructor(e=new xt,t=new ua){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[0];for(let a=1,s=t.count;a<s;a++)dc.fromBufferAttribute(t,a-1),uc.fromBufferAttribute(t,a),i[a]=i[a-1],i[a]+=dc.distanceTo(uc);e.setAttribute("lineDistance",new ft(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const i=this.geometry,a=this.matrixWorld,s=e.params.Line.threshold,r=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),gs.copy(i.boundingSphere),gs.applyMatrix4(a),gs.radius+=s,e.ray.intersectsSphere(gs)===!1)return;pc.copy(a).invert(),kr.copy(e.ray).applyMatrix4(pc);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,d=new L,c=new L,p=new L,f=new L,h=this.isLineSegments?2:1,g=i.index,m=i.attributes.position;if(g!==null){const u=Math.max(0,r.start),v=Math.min(g.count,r.start+r.count);for(let b=u,_=v-1;b<_;b+=h){const k=g.getX(b),M=g.getX(b+1);if(d.fromBufferAttribute(m,k),c.fromBufferAttribute(m,M),kr.distanceSqToSegment(d,c,f,p)>l)continue;f.applyMatrix4(this.matrixWorld);const I=e.ray.origin.distanceTo(f);I<e.near||I>e.far||t.push({distance:I,point:p.clone().applyMatrix4(this.matrixWorld),index:b,face:null,faceIndex:null,object:this})}}else{const u=Math.max(0,r.start),v=Math.min(m.count,r.start+r.count);for(let b=u,_=v-1;b<_;b+=h){if(d.fromBufferAttribute(m,b),c.fromBufferAttribute(m,b+1),kr.distanceSqToSegment(d,c,f,p)>l)continue;f.applyMatrix4(this.matrixWorld);const M=e.ray.origin.distanceTo(f);M<e.near||M>e.far||t.push({distance:M,point:p.clone().applyMatrix4(this.matrixWorld),index:b,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const a=t[i[0]];if(a!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,r=a.length;s<r;s++){const o=a[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}class Fs extends Zt{constructor(e,t,i,a,s,r,o,l,d){super(e,t,i,a,s,r,o,l,d),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Sn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const i=this.getUtoTmapping(e);return this.getPoint(i,t)}getPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return t}getSpacedPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPointAt(i/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let i,a=this.getPoint(0),s=0;t.push(0);for(let r=1;r<=e;r++)i=this.getPoint(r/e),s+=i.distanceTo(a),t.push(s),a=i;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const i=this.getLengths();let a=0;const s=i.length;let r;t?r=t:r=e*i[s-1];let o=0,l=s-1,d;for(;o<=l;)if(a=Math.floor(o+(l-o)/2),d=i[a]-r,d<0)o=a+1;else if(d>0)l=a-1;else{l=a;break}if(a=l,i[a]===r)return a/(s-1);const c=i[a],f=i[a+1]-c,h=(r-c)/f;return(a+h)/(s-1)}getTangent(e,t){let a=e-1e-4,s=e+1e-4;a<0&&(a=0),s>1&&(s=1);const r=this.getPoint(a),o=this.getPoint(s),l=t||(r.isVector2?new we:new L);return l.copy(o).sub(r).normalize(),l}getTangentAt(e,t){const i=this.getUtoTmapping(e);return this.getTangent(i,t)}computeFrenetFrames(e,t){const i=new L,a=[],s=[],r=[],o=new L,l=new bt;for(let h=0;h<=e;h++){const g=h/e;a[h]=this.getTangentAt(g,new L)}s[0]=new L,r[0]=new L;let d=Number.MAX_VALUE;const c=Math.abs(a[0].x),p=Math.abs(a[0].y),f=Math.abs(a[0].z);c<=d&&(d=c,i.set(1,0,0)),p<=d&&(d=p,i.set(0,1,0)),f<=d&&i.set(0,0,1),o.crossVectors(a[0],i).normalize(),s[0].crossVectors(a[0],o),r[0].crossVectors(a[0],s[0]);for(let h=1;h<=e;h++){if(s[h]=s[h-1].clone(),r[h]=r[h-1].clone(),o.crossVectors(a[h-1],a[h]),o.length()>Number.EPSILON){o.normalize();const g=Math.acos(Nt(a[h-1].dot(a[h]),-1,1));s[h].applyMatrix4(l.makeRotationAxis(o,g))}r[h].crossVectors(a[h],s[h])}if(t===!0){let h=Math.acos(Nt(s[0].dot(s[e]),-1,1));h/=e,a[0].dot(o.crossVectors(s[0],s[e]))>0&&(h=-h);for(let g=1;g<=e;g++)s[g].applyMatrix4(l.makeRotationAxis(a[g],h*g)),r[g].crossVectors(a[g],s[g])}return{tangents:a,normals:s,binormals:r}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class wo extends Sn{constructor(e=0,t=0,i=1,a=1,s=0,r=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=i,this.yRadius=a,this.aStartAngle=s,this.aEndAngle=r,this.aClockwise=o,this.aRotation=l}getPoint(e,t){const i=t||new we,a=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const r=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=a;for(;s>a;)s-=a;s<Number.EPSILON&&(r?s=0:s=a),this.aClockwise===!0&&!r&&(s===a?s=-a:s=s-a);const o=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(o),d=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const c=Math.cos(this.aRotation),p=Math.sin(this.aRotation),f=l-this.aX,h=d-this.aY;l=f*c-h*p+this.aX,d=f*p+h*c+this.aY}return i.set(l,d)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class qm extends wo{constructor(e,t,i,a,s,r){super(e,t,i,i,a,s,r),this.isArcCurve=!0,this.type="ArcCurve"}}function Mo(){let n=0,e=0,t=0,i=0;function a(s,r,o,l){n=s,e=o,t=-3*s+3*r-2*o-l,i=2*s-2*r+o+l}return{initCatmullRom:function(s,r,o,l,d){a(r,o,d*(o-s),d*(l-r))},initNonuniformCatmullRom:function(s,r,o,l,d,c,p){let f=(r-s)/d-(o-s)/(d+c)+(o-r)/c,h=(o-r)/c-(l-r)/(c+p)+(l-o)/p;f*=c,h*=c,a(r,o,f,h)},calc:function(s){const r=s*s,o=r*s;return n+e*s+t*r+i*o}}}const xs=new L,Cr=new Mo,Rr=new Mo,Pr=new Mo;class cd extends Sn{constructor(e=[],t=!1,i="centripetal",a=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=i,this.tension=a}getPoint(e,t=new L){const i=t,a=this.points,s=a.length,r=(s-(this.closed?0:1))*e;let o=Math.floor(r),l=r-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/s)+1)*s:l===0&&o===s-1&&(o=s-2,l=1);let d,c;this.closed||o>0?d=a[(o-1)%s]:(xs.subVectors(a[0],a[1]).add(a[0]),d=xs);const p=a[o%s],f=a[(o+1)%s];if(this.closed||o+2<s?c=a[(o+2)%s]:(xs.subVectors(a[s-1],a[s-2]).add(a[s-1]),c=xs),this.curveType==="centripetal"||this.curveType==="chordal"){const h=this.curveType==="chordal"?.5:.25;let g=Math.pow(d.distanceToSquared(p),h),x=Math.pow(p.distanceToSquared(f),h),m=Math.pow(f.distanceToSquared(c),h);x<1e-4&&(x=1),g<1e-4&&(g=x),m<1e-4&&(m=x),Cr.initNonuniformCatmullRom(d.x,p.x,f.x,c.x,g,x,m),Rr.initNonuniformCatmullRom(d.y,p.y,f.y,c.y,g,x,m),Pr.initNonuniformCatmullRom(d.z,p.z,f.z,c.z,g,x,m)}else this.curveType==="catmullrom"&&(Cr.initCatmullRom(d.x,p.x,f.x,c.x,this.tension),Rr.initCatmullRom(d.y,p.y,f.y,c.y,this.tension),Pr.initCatmullRom(d.z,p.z,f.z,c.z,this.tension));return i.set(Cr.calc(l),Rr.calc(l),Pr.calc(l)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const a=e.points[t];this.points.push(a.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const a=this.points[t];e.points.push(a.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const a=e.points[t];this.points.push(new L().fromArray(a))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function hc(n,e,t,i,a){const s=(i-e)*.5,r=(a-t)*.5,o=n*n,l=n*o;return(2*t-2*i+s+r)*l+(-3*t+3*i-2*s-r)*o+s*n+t}function $m(n,e){const t=1-n;return t*t*e}function Ym(n,e){return 2*(1-n)*n*e}function jm(n,e){return n*n*e}function La(n,e,t,i){return $m(n,e)+Ym(n,t)+jm(n,i)}function Km(n,e){const t=1-n;return t*t*t*e}function Jm(n,e){const t=1-n;return 3*t*t*n*e}function Zm(n,e){return 3*(1-n)*n*n*e}function Qm(n,e){return n*n*n*e}function ka(n,e,t,i,a){return Km(n,e)+Jm(n,t)+Zm(n,i)+Qm(n,a)}class dd extends Sn{constructor(e=new we,t=new we,i=new we,a=new we){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=i,this.v3=a}getPoint(e,t=new we){const i=t,a=this.v0,s=this.v1,r=this.v2,o=this.v3;return i.set(ka(e,a.x,s.x,r.x,o.x),ka(e,a.y,s.y,r.y,o.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class eg extends Sn{constructor(e=new L,t=new L,i=new L,a=new L){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=i,this.v3=a}getPoint(e,t=new L){const i=t,a=this.v0,s=this.v1,r=this.v2,o=this.v3;return i.set(ka(e,a.x,s.x,r.x,o.x),ka(e,a.y,s.y,r.y,o.y),ka(e,a.z,s.z,r.z,o.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class ud extends Sn{constructor(e=new we,t=new we){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new we){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new we){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class tg extends Sn{constructor(e=new L,t=new L){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new L){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new L){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class pd extends Sn{constructor(e=new we,t=new we,i=new we){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new we){const i=t,a=this.v0,s=this.v1,r=this.v2;return i.set(La(e,a.x,s.x,r.x),La(e,a.y,s.y,r.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class ng extends Sn{constructor(e=new L,t=new L,i=new L){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new L){const i=t,a=this.v0,s=this.v1,r=this.v2;return i.set(La(e,a.x,s.x,r.x),La(e,a.y,s.y,r.y),La(e,a.z,s.z,r.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class hd extends Sn{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new we){const i=t,a=this.points,s=(a.length-1)*e,r=Math.floor(s),o=s-r,l=a[r===0?r:r-1],d=a[r],c=a[r>a.length-2?a.length-1:r+1],p=a[r>a.length-3?a.length-1:r+2];return i.set(hc(o,l.x,d.x,c.x,p.x),hc(o,l.y,d.y,c.y,p.y)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const a=e.points[t];this.points.push(a.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const a=this.points[t];e.points.push(a.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const a=e.points[t];this.points.push(new we().fromArray(a))}return this}}var fc=Object.freeze({__proto__:null,ArcCurve:qm,CatmullRomCurve3:cd,CubicBezierCurve:dd,CubicBezierCurve3:eg,EllipseCurve:wo,LineCurve:ud,LineCurve3:tg,QuadraticBezierCurve:pd,QuadraticBezierCurve3:ng,SplineCurve:hd});class ig extends Sn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const i=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new fc[i](t,e))}return this}getPoint(e,t){const i=e*this.getLength(),a=this.getCurveLengths();let s=0;for(;s<a.length;){if(a[s]>=i){const r=a[s]-i,o=this.curves[s],l=o.getLength(),d=l===0?0:1-r/l;return o.getPointAt(d,t)}s++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let i=0,a=this.curves.length;i<a;i++)t+=this.curves[i].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let i;for(let a=0,s=this.curves;a<s.length;a++){const r=s[a],o=r.isEllipseCurve?e*2:r.isLineCurve||r.isLineCurve3?1:r.isSplineCurve?e*r.points.length:e,l=r.getPoints(o);for(let d=0;d<l.length;d++){const c=l[d];i&&i.equals(c)||(t.push(c),i=c)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const a=e.curves[t];this.curves.push(a.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,i=this.curves.length;t<i;t++){const a=this.curves[t];e.curves.push(a.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const a=e.curves[t];this.curves.push(new fc[a.type]().fromJSON(a))}return this}}class ag extends ig{constructor(e){super(),this.type="Path",this.currentPoint=new we,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,i=e.length;t<i;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const i=new ud(this.currentPoint.clone(),new we(e,t));return this.curves.push(i),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,i,a){const s=new pd(this.currentPoint.clone(),new we(e,t),new we(i,a));return this.curves.push(s),this.currentPoint.set(i,a),this}bezierCurveTo(e,t,i,a,s,r){const o=new dd(this.currentPoint.clone(),new we(e,t),new we(i,a),new we(s,r));return this.curves.push(o),this.currentPoint.set(s,r),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),i=new hd(t);return this.curves.push(i),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,i,a,s,r){const o=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+o,t+l,i,a,s,r),this}absarc(e,t,i,a,s,r){return this.absellipse(e,t,i,i,a,s,r),this}ellipse(e,t,i,a,s,r,o,l){const d=this.currentPoint.x,c=this.currentPoint.y;return this.absellipse(e+d,t+c,i,a,s,r,o,l),this}absellipse(e,t,i,a,s,r,o,l){const d=new wo(e,t,i,a,s,r,o,l);if(this.curves.length>0){const p=d.getPoint(0);p.equals(this.currentPoint)||this.lineTo(p.x,p.y)}this.curves.push(d);const c=d.getPoint(1);return this.currentPoint.copy(c),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class So extends xt{constructor(e=[new we(0,-.5),new we(.5,0),new we(0,.5)],t=12,i=0,a=Math.PI*2){super(),this.type="LatheGeometry",this.parameters={points:e,segments:t,phiStart:i,phiLength:a},t=Math.floor(t),a=Nt(a,0,Math.PI*2);const s=[],r=[],o=[],l=[],d=[],c=1/t,p=new L,f=new we,h=new L,g=new L,x=new L;let m=0,u=0;for(let v=0;v<=e.length-1;v++)switch(v){case 0:m=e[v+1].x-e[v].x,u=e[v+1].y-e[v].y,h.x=u*1,h.y=-m,h.z=u*0,x.copy(h),h.normalize(),l.push(h.x,h.y,h.z);break;case e.length-1:l.push(x.x,x.y,x.z);break;default:m=e[v+1].x-e[v].x,u=e[v+1].y-e[v].y,h.x=u*1,h.y=-m,h.z=u*0,g.copy(h),h.x+=x.x,h.y+=x.y,h.z+=x.z,h.normalize(),l.push(h.x,h.y,h.z),x.copy(g)}for(let v=0;v<=t;v++){const b=i+v*c*a,_=Math.sin(b),k=Math.cos(b);for(let M=0;M<=e.length-1;M++){p.x=e[M].x*_,p.y=e[M].y,p.z=e[M].x*k,r.push(p.x,p.y,p.z),f.x=v/t,f.y=M/(e.length-1),o.push(f.x,f.y);const E=l[3*M+0]*_,I=l[3*M+1],y=l[3*M+0]*k;d.push(E,I,y)}}for(let v=0;v<t;v++)for(let b=0;b<e.length-1;b++){const _=b+v*e.length,k=_,M=_+e.length,E=_+e.length+1,I=_+1;s.push(k,M,I),s.push(E,I,M)}this.setIndex(s),this.setAttribute("position",new ft(r,3)),this.setAttribute("uv",new ft(o,2)),this.setAttribute("normal",new ft(d,3))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new So(e.points,e.segments,e.phiStart,e.phiLength)}}class Eo extends So{constructor(e=1,t=1,i=4,a=8){const s=new ag;s.absarc(0,-t/2,e,Math.PI*1.5,0),s.absarc(0,t/2,e,0,Math.PI*.5),super(s.getPoints(i),a),this.type="CapsuleGeometry",this.parameters={radius:e,length:t,capSegments:i,radialSegments:a}}static fromJSON(e){return new Eo(e.radius,e.length,e.capSegments,e.radialSegments)}}class cn extends xt{constructor(e=1,t=32,i=0,a=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:t,thetaStart:i,thetaLength:a},t=Math.max(3,t);const s=[],r=[],o=[],l=[],d=new L,c=new we;r.push(0,0,0),o.push(0,0,1),l.push(.5,.5);for(let p=0,f=3;p<=t;p++,f+=3){const h=i+p/t*a;d.x=e*Math.cos(h),d.y=e*Math.sin(h),r.push(d.x,d.y,d.z),o.push(0,0,1),c.x=(r[f]/e+1)/2,c.y=(r[f+1]/e+1)/2,l.push(c.x,c.y)}for(let p=1;p<=t;p++)s.push(p,p+1,0);this.setIndex(s),this.setAttribute("position",new ft(r,3)),this.setAttribute("normal",new ft(o,3)),this.setAttribute("uv",new ft(l,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new cn(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class ge extends xt{constructor(e=1,t=1,i=1,a=32,s=1,r=!1,o=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:i,radialSegments:a,heightSegments:s,openEnded:r,thetaStart:o,thetaLength:l};const d=this;a=Math.floor(a),s=Math.floor(s);const c=[],p=[],f=[],h=[];let g=0;const x=[],m=i/2;let u=0;v(),r===!1&&(e>0&&b(!0),t>0&&b(!1)),this.setIndex(c),this.setAttribute("position",new ft(p,3)),this.setAttribute("normal",new ft(f,3)),this.setAttribute("uv",new ft(h,2));function v(){const _=new L,k=new L;let M=0;const E=(t-e)/i;for(let I=0;I<=s;I++){const y=[],T=I/s,N=T*(t-e)+e;for(let H=0;H<=a;H++){const se=H/a,P=se*l+o,z=Math.sin(P),X=Math.cos(P);k.x=N*z,k.y=-T*i+m,k.z=N*X,p.push(k.x,k.y,k.z),_.set(z,E,X).normalize(),f.push(_.x,_.y,_.z),h.push(se,1-T),y.push(g++)}x.push(y)}for(let I=0;I<a;I++)for(let y=0;y<s;y++){const T=x[y][I],N=x[y+1][I],H=x[y+1][I+1],se=x[y][I+1];c.push(T,N,se),c.push(N,H,se),M+=6}d.addGroup(u,M,0),u+=M}function b(_){const k=g,M=new we,E=new L;let I=0;const y=_===!0?e:t,T=_===!0?1:-1;for(let H=1;H<=a;H++)p.push(0,m*T,0),f.push(0,T,0),h.push(.5,.5),g++;const N=g;for(let H=0;H<=a;H++){const P=H/a*l+o,z=Math.cos(P),X=Math.sin(P);E.x=y*X,E.y=m*T,E.z=y*z,p.push(E.x,E.y,E.z),f.push(0,T,0),M.x=z*.5+.5,M.y=X*.5*T+.5,h.push(M.x,M.y),g++}for(let H=0;H<a;H++){const se=k+H,P=N+H;_===!0?c.push(P,P+1,se):c.push(P+1,P,se),I+=3}d.addGroup(u,I,_===!0?1:2),u+=I}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ge(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Bn extends ge{constructor(e=1,t=1,i=32,a=1,s=!1,r=0,o=Math.PI*2){super(0,e,t,i,a,s,r,o),this.type="ConeGeometry",this.parameters={radius:e,height:t,radialSegments:i,heightSegments:a,openEnded:s,thetaStart:r,thetaLength:o}}static fromJSON(e){return new Bn(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class To extends xt{constructor(e=.5,t=1,i=32,a=1,s=0,r=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:i,phiSegments:a,thetaStart:s,thetaLength:r},i=Math.max(3,i),a=Math.max(1,a);const o=[],l=[],d=[],c=[];let p=e;const f=(t-e)/a,h=new L,g=new we;for(let x=0;x<=a;x++){for(let m=0;m<=i;m++){const u=s+m/i*r;h.x=p*Math.cos(u),h.y=p*Math.sin(u),l.push(h.x,h.y,h.z),d.push(0,0,1),g.x=(h.x/t+1)/2,g.y=(h.y/t+1)/2,c.push(g.x,g.y)}p+=f}for(let x=0;x<a;x++){const m=x*(i+1);for(let u=0;u<i;u++){const v=u+m,b=v,_=v+i+1,k=v+i+2,M=v+1;o.push(b,_,M),o.push(_,k,M)}}this.setIndex(o),this.setAttribute("position",new ft(l,3)),this.setAttribute("normal",new ft(d,3)),this.setAttribute("uv",new ft(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new To(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}class at extends xt{constructor(e=1,t=32,i=16,a=0,s=Math.PI*2,r=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:a,phiLength:s,thetaStart:r,thetaLength:o},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(r+o,Math.PI);let d=0;const c=[],p=new L,f=new L,h=[],g=[],x=[],m=[];for(let u=0;u<=i;u++){const v=[],b=u/i;let _=0;u===0&&r===0?_=.5/t:u===i&&l===Math.PI&&(_=-.5/t);for(let k=0;k<=t;k++){const M=k/t;p.x=-e*Math.cos(a+M*s)*Math.sin(r+b*o),p.y=e*Math.cos(r+b*o),p.z=e*Math.sin(a+M*s)*Math.sin(r+b*o),g.push(p.x,p.y,p.z),f.copy(p).normalize(),x.push(f.x,f.y,f.z),m.push(M+_,1-b),v.push(d++)}c.push(v)}for(let u=0;u<i;u++)for(let v=0;v<t;v++){const b=c[u][v+1],_=c[u][v],k=c[u+1][v],M=c[u+1][v+1];(u!==0||r>0)&&h.push(b,_,M),(u!==i-1||l<Math.PI)&&h.push(_,k,M)}this.setIndex(h),this.setAttribute("position",new ft(g,3)),this.setAttribute("normal",new ft(x,3)),this.setAttribute("uv",new ft(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new at(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class xn extends xt{constructor(e=1,t=.4,i=12,a=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:t,radialSegments:i,tubularSegments:a,arc:s},i=Math.floor(i),a=Math.floor(a);const r=[],o=[],l=[],d=[],c=new L,p=new L,f=new L;for(let h=0;h<=i;h++)for(let g=0;g<=a;g++){const x=g/a*s,m=h/i*Math.PI*2;p.x=(e+t*Math.cos(m))*Math.cos(x),p.y=(e+t*Math.cos(m))*Math.sin(x),p.z=t*Math.sin(m),o.push(p.x,p.y,p.z),c.x=e*Math.cos(x),c.y=e*Math.sin(x),f.subVectors(p,c).normalize(),l.push(f.x,f.y,f.z),d.push(g/a),d.push(h/i)}for(let h=1;h<=i;h++)for(let g=1;g<=a;g++){const x=(a+1)*h+g-1,m=(a+1)*(h-1)+g-1,u=(a+1)*(h-1)+g,v=(a+1)*h+g;r.push(x,m,v),r.push(m,u,v)}this.setIndex(r),this.setAttribute("position",new ft(o,3)),this.setAttribute("normal",new ft(l,3)),this.setAttribute("uv",new ft(d,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new xn(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class ae extends ii{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ve(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ve(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=xo,this.normalScale=new we(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Me extends ii{constructor(e){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new Ve(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ve(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=xo,this.normalScale=new we(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.combine=mo,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Bs extends Lt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ve(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}class fd extends Bs{constructor(e,t,i){super(e,i),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(Lt.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Ve(t)}copy(e,t){return super.copy(e,t),this.groundColor.copy(e.groundColor),this}}const Dr=new bt,mc=new L,gc=new L;class md{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new we(512,512),this.map=null,this.mapPass=null,this.matrix=new bt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new bo,this._frameExtents=new we(1,1),this._viewportCount=1,this._viewports=[new gt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;mc.setFromMatrixPosition(e.matrixWorld),t.position.copy(mc),gc.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(gc),t.updateMatrixWorld(),Dr.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Dr),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Dr)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const xc=new bt,_a=new L,Ir=new L;class sg extends md{constructor(){super(new Kt(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new we(4,2),this._viewportCount=6,this._viewports=[new gt(2,1,1,1),new gt(0,1,1,1),new gt(3,1,1,1),new gt(1,1,1,1),new gt(3,0,1,1),new gt(1,0,1,1)],this._cubeDirections=[new L(1,0,0),new L(-1,0,0),new L(0,0,1),new L(0,0,-1),new L(0,1,0),new L(0,-1,0)],this._cubeUps=[new L(0,1,0),new L(0,1,0),new L(0,1,0),new L(0,1,0),new L(0,0,1),new L(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,a=this.matrix,s=e.distance||i.far;s!==i.far&&(i.far=s,i.updateProjectionMatrix()),_a.setFromMatrixPosition(e.matrixWorld),i.position.copy(_a),Ir.copy(i.position),Ir.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt(Ir),i.updateMatrixWorld(),a.makeTranslation(-_a.x,-_a.y,-_a.z),xc.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(xc)}}class ti extends Bs{constructor(e,t,i=0,a=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=a,this.shadow=new sg}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class rg extends md{constructor(){super(new td(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Mn extends Bs{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Lt.DEFAULT_UP),this.updateMatrix(),this.target=new Lt,this.shadow=new rg}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Hs extends Bs{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class gd{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=vc(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=vc();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function vc(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ho}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ho);const ot=60,We=40,Ut=14,Ur=[new L(-16,0,6),new L(0,0,-6),new L(16,0,6)];function og(){const n=new da;n.background=new Ve(1711918),n.fog=new Ha(1711918,40,90),n.add(new Hs(13691135,.55));const e=[[-18,Ut-.5,8],[-18,Ut-.5,-8],[0,Ut-.5,8],[0,Ut-.5,-8],[18,Ut-.5,8],[18,Ut-.5,-8]];for(const[i,a,s]of e){const r=new ti(15267071,1.2,28);r.position.set(i,a,s),n.add(r)}const t=new Mn(16777215,.5);return t.position.set(10,20,10),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),n.add(t),{scene:n}}function lg(n){cg(n),dg(n),ug(n)}function cg(n){const e=new ae({color:15263976,roughness:.8,metalness:0}),t=new ae({color:14541804,roughness:.85,metalness:0}),i=new ae({color:16119288,roughness:.9,metalness:0});new ae({color:2764605,roughness:.7,metalness:.1});const a=new C(new _t(ot,We),e);a.rotation.x=-Math.PI/2,a.receiveShadow=!0,n.add(a);const s=new ua({color:13421772});for(let u=-ot/2;u<=ot/2;u+=3){const v=new xt().setFromPoints([new L(u,.01,-We/2),new L(u,.01,We/2)]);n.add(new Fn(v,s))}for(let u=-We/2;u<=We/2;u+=3){const v=new xt().setFromPoints([new L(-ot/2,.01,u),new L(ot/2,.01,u)]);n.add(new Fn(v,s))}const r=new C(new _t(ot,We),i);r.rotation.x=Math.PI/2,r.position.y=Ut,n.add(r);const o=[{w:ot,h:Ut,x:0,y:Ut/2,z:-We/2,ry:0},{w:ot,h:Ut,x:0,y:Ut/2,z:We/2,ry:Math.PI},{w:We,h:Ut,x:-ot/2,y:Ut/2,z:0,ry:Math.PI/2},{w:We,h:Ut,x:ot/2,y:Ut/2,z:0,ry:-Math.PI/2}];for(const u of o){const v=new C(new _t(u.w,u.h),t);v.position.set(u.x,u.y,u.z),v.rotation.y=u.ry,n.add(v)}const l=new Me({color:11581640}),d=[{w:ot,x:0,z:-We/2+.05,ry:0},{w:ot,x:0,z:We/2-.05,ry:Math.PI},{w:We,x:-ot/2+.05,z:0,ry:Math.PI/2},{w:We,x:ot/2-.05,z:0,ry:-Math.PI/2}];for(const u of d){const v=new C(new oe(u.w,.5,.1),l);v.position.set(u.x,.25,u.z),v.rotation.y=u.ry,n.add(v)}const c=new Me({color:16777215}),p=new ae({color:15663088,emissive:15663088,emissiveIntensity:.9});for(const[u,,v]of[[-18,0,8],[-18,0,-8],[0,0,8],[0,0,-8],[18,0,8],[18,0,-8]]){const b=new C(new oe(6,.25,.8),c);b.position.set(u,Ut-.12,v),n.add(b);const _=new C(new ge(.1,.1,5.6,16),p);_.rotation.z=Math.PI/2,_.position.set(u,Ut-.3,v),n.add(_)}const f=new Me({color:9083568}),h=new Me({color:5929626}),g=new C(new oe(3.2,7.2,.15),f);g.position.set(0,3.6,We/2-.05),n.add(g);const x=new C(new oe(2.8,6.8,.1),h);x.position.set(0,3.4,We/2-.04),n.add(x);const m=new Me({color:6993128,transparent:!0,opacity:.35});for(const u of[-14,0,14]){const v=new C(new oe(5,4,.15),f);v.position.set(u,8,-We/2+.05),n.add(v);const b=new C(new oe(4.4,3.4,.08),m);b.position.set(u,8,-We/2+.06),n.add(b)}}function dg(n){const e=new ae({color:15791336,roughness:.55,metalness:.05}),t=new ae({color:4871528,roughness:.7,metalness:.05}),i=new ae({color:13687016,roughness:.6,metalness:0}),a=new ae({color:8952234,roughness:.4,metalness:.5}),s=[{x:-16,z:5},{x:0,z:-6},{x:16,z:5}];for(const{x:m,z:u}of s){const v=new C(new oe(7,3,3),t);v.position.set(m,1.5,u),v.castShadow=!0,n.add(v);const b=new C(new oe(7.2,.15,3.2),e);b.position.set(m,3.08,u),b.castShadow=!0,n.add(b);for(const[_,k]of[[-3.2,-1.3],[3.2,-1.3],[-3.2,1.3],[3.2,1.3]]){const M=new C(new oe(.2,3,.2),a);M.position.set(m+_,1.5,u+k),n.add(M)}for(let _=0;_<3;_++){const k=new C(new oe(2,.6,.05),i);k.position.set(m-2.2+_*2.2,1.8,u+1.52),n.add(k)}if(m===0){const _=new ae({color:13426158,roughness:.3,metalness:.3}),k=new C(new oe(1.2,.2,.9),_);k.position.set(2.5,3.15,u),n.add(k);const M=new C(new ge(.05,.05,.6,16),a);M.position.set(2.5,3.55,u-.3),n.add(M);const E=new C(new at(.09,16,14),a);E.position.set(2.5,3.85,u),n.add(E)}}for(let m=-22;m<=22;m+=11)for(let u=0;u<3;u++){const v=new C(new oe(9,.12,1.2),i);v.position.set(m,5+u*2.2,-We/2+.8),n.add(v);for(const b of[-4,4]){const _=new C(new oe(.1,.5,1),a);_.position.set(m+b,4.75+u*2.2,-We/2+.8),n.add(_)}}const r=new C(new oe(3,3,22),t);r.position.set(-ot/2+2,1.5,0),r.castShadow=!0,n.add(r);const o=new C(new oe(3.2,.15,22.2),e);o.position.set(-ot/2+2,3.08,0),n.add(o);const l=new C(new oe(3,3,22),t);l.position.set(ot/2-2,1.5,0),l.castShadow=!0,n.add(l);const d=new C(new oe(3.2,.15,22.2),e);d.position.set(ot/2-2,3.08,0),n.add(d);const c=new ae({color:6978186,roughness:.6,metalness:.1}),p=new ae({color:8965341,transparent:!0,opacity:.4,roughness:.1,metalness:0}),f=new C(new oe(6,5,2.5),c);f.position.set(-20,4.5,-We/2+1.5),n.add(f);const h=new C(new oe(5,3,.08),p);h.position.set(-20,4.8,-We/2+2.8),n.add(h);const g=new C(new oe(6.2,3,2.8),t);g.position.set(-20,1.5,-We/2+1.6),n.add(g);const x=new C(new oe(6.2,.15,2.8),e);x.position.set(-20,3.08,-We/2+1.6),n.add(x)}function ug(n){const e=new ae({color:11197934,transparent:!0,opacity:.7,roughness:.05,metalness:0}),t=new ae({color:4033344,transparent:!0,opacity:.85,roughness:.15,metalness:0}),i=new ae({color:8010768,transparent:!0,opacity:.85,roughness:.2,metalness:0}),a=new ae({color:12597547,transparent:!0,opacity:.85,roughness:.15,metalness:0}),s=new ae({color:16777215,roughness:.7,metalness:0}),r=new ae({color:8952234,roughness:.35,metalness:.6});new ae({color:16774604,roughness:.8});const o=[{x:-24,y:5.3,z:-We/2+.7,mat:t,r:.22,h:.7},{x:-22,y:5.3,z:-We/2+.7,mat:i,r:.18,h:.9},{x:-20,y:5.3,z:-We/2+.7,mat:a,r:.2,h:.75},{x:-18,y:5.3,z:-We/2+.7,mat:e,r:.16,h:.65},{x:-13,y:5.3,z:-We/2+.7,mat:i,r:.2,h:.85},{x:-11,y:5.3,z:-We/2+.7,mat:t,r:.25,h:.6},{x:-2,y:5.3,z:-We/2+.7,mat:a,r:.18,h:.8},{x:0,y:5.3,z:-We/2+.7,mat:e,r:.22,h:.7},{x:2,y:5.3,z:-We/2+.7,mat:t,r:.2,h:.9},{x:10,y:5.3,z:-We/2+.7,mat:i,r:.19,h:.7},{x:12,y:5.3,z:-We/2+.7,mat:a,r:.21,h:.8},{x:22,y:5.3,z:-We/2+.7,mat:e,r:.23,h:.65},{x:24,y:5.3,z:-We/2+.7,mat:t,r:.17,h:.9},{x:-23,y:7.5,z:-We/2+.7,mat:a,r:.2,h:.8},{x:-21,y:7.5,z:-We/2+.7,mat:e,r:.18,h:.7},{x:-1,y:7.5,z:-We/2+.7,mat:i,r:.22,h:.85},{x:1,y:7.5,z:-We/2+.7,mat:t,r:.2,h:.7},{x:21,y:7.5,z:-We/2+.7,mat:a,r:.19,h:.75}];for(const M of o){const E=new C(new ge(M.r,M.r*.9,M.h,20),M.mat);E.position.set(M.x,M.y+M.h/2,M.z),n.add(E);const I=new C(new ge(M.r*.7,M.r*.7,.12,20),s);I.position.set(M.x,M.y+M.h+.06,M.z),n.add(I)}pg(n,-ot/2+2.5,3.2,-6,r,s),hg(n,-ot/2+2.5,3.2,4,r,s),fg(n,ot/2-2.5,3.2,-5,r);for(let M=0;M<4;M++){const E=M%2===0?i:e,I=new C(new ge(.22,.2,.5,20),E);I.position.set(ot/2-2.5+(M-1.5)*.7,3.5,5+M%2*.6),n.add(I)}const l=new Me({color:16769154}),d=new C(new oe(3.5,5,.06),l);d.position.set(ot/2-.06,6,10),d.rotation.y=-Math.PI/2,n.add(d);const c=Pn(`⚠ KESELAMATAN
LABORATORIUM`,15022389);c.scale.set(4,1.6,1),c.position.set(ot/2-.3,6.5,10),n.add(c);const p=new C(new ge(.06,.06,1.5,16),r);p.position.set(-ot/2+.2,9,14),p.rotation.z=Math.PI/2,n.add(p);for(const M of[-.5,0,.5]){const E=new C(new xn(.14,.03,12,24,Math.PI),r);E.position.set(-ot/2+.25,8.6,14+M),E.rotation.y=Math.PI/2,n.add(E)}const f=new Me({color:16448250}),h=new C(new oe(.05,2.5,1.5),f);h.position.set(-ot/2+.28,7.8,14),n.add(h);const g=new Me({color:15158332}),x=new Me({color:15965202});for(const[M,E,I]of[[-8,14,g],[8,14,x]]){const y=new C(new ge(.45,.38,1,20),I);y.position.set(M,.5,E),n.add(y)}const m=new Me({color:12597547}),u=new C(new ge(.2,.22,1.1,20),m);u.position.set(ot/2-.8,1.8,-14),n.add(u);const v=new C(new ge(.1,.2,.3,20),r);v.position.set(ot/2-.8,2.5,-14),n.add(v);const b=new Me({color:16777215}),_=new C(new ge(.7,.7,.1,24),b);_.rotation.x=Math.PI/2,_.position.set(8,10.5,-We/2+.1),n.add(_);const k=new C(new xn(.7,.06,12,40),r);k.rotation.x=Math.PI/2,k.position.set(8,10.5,-We/2+.12),n.add(k)}function pg(n,e,t,i,a,s){const r=new C(new ge(.65,.7,.7,24),s);r.position.set(e,t+.35,i),n.add(r);const o=new C(new ge(.66,.66,.12,24),a);o.position.set(e,t+.76,i),n.add(o);const l=new C(new at(.1,16,14),a);l.position.set(e,t+.88,i),n.add(l)}function hg(n,e,t,i,a,s){const r=new C(new oe(.7,.12,.55),a);r.position.set(e,t+.06,i),n.add(r);const o=new C(new oe(.12,1.4,.12),a);o.position.set(e,t+.76,i-.1),n.add(o);const l=new C(new ge(.1,.12,.5,16),a);l.position.set(e,t+1.7,i-.15),l.rotation.z=.4,n.add(l);const d=new C(new ge(.06,.08,.35,16),s);d.position.set(e+.05,t+.75,i+.05),n.add(d)}function fg(n,e,t,i,a){const s=new ae({color:2899536,roughness:.6,metalness:.15}),r=new C(new oe(1,.18,1),s);r.position.set(e,t+.09,i),n.add(r);const o=new C(new ge(.38,.38,.04,20),a);o.position.set(e,t+.2,i),n.add(o);const l=new ae({color:16737792,emissive:16737792,emissiveIntensity:.6,transparent:!0,opacity:.7}),d=new C(new cn(.3,20),l);d.rotation.x=-Math.PI/2,d.position.set(e,t+.22,i),n.add(d);const c=new Me({color:11197934,transparent:!0,opacity:.8}),p=new C(new at(.3,20,16),c);p.position.set(e,t+.55,i),n.add(p);const f=new C(new ge(.08,.12,.35,20),c);f.position.set(e,t+.9,i),n.add(f)}function xd(n){const e=[];{const t=Ur[0],i=new jt;i.position.copy(t);const a=new Me({color:11197934,transparent:!0,opacity:.75}),s=new Me({color:7027216,transparent:!0,opacity:.9}),r=new Me({color:8952234}),o=new Me({color:16448250}),l=new Me({color:15791336}),d=new C(new oe(6.8,.12,2.8),l);d.position.set(0,3.14,0),i.add(d);const c=new Me({color:14540253}),p=new C(new oe(2,.18,.45),c);p.position.set(-1.5,3.3,.2),i.add(p);for(let y=0;y<5;y++){const T=new C(new ge(.07,.07,.55,16),s);T.position.set(-2.2+y*.42,3.62,.2),i.add(T)}const f=new C(new at(.38,20,16),a);f.position.set(.8,3.62,-.3),i.add(f);const h=new C(new ge(.1,.15,.45,20),a);h.position.set(.8,4.05,-.3),i.add(h);const g=new C(new at(.32,18,16),s);g.position.set(.8,3.58,-.3),i.add(g);const x=new C(new ge(.04,.04,1,16),r);x.position.set(.8,4.2,-.3),i.add(x);const m=new C(new oe(.5,.35,.15),o);m.position.set(.8,4.85,-.3),i.add(m);const u=new Me({color:16775399}),v=new C(new oe(.7,.9,.05),u);v.position.set(2.3,3.85,-.5),v.rotation.y=-.3,i.add(v);const b=new Me({color:8952234}),_=new C(new oe(.35,.12,.06),b);_.position.set(2.3,4.34,-.46),_.rotation.y=-.3,i.add(_);const k=Pn("❓ Fenomena 1 — Kualitas Air",54527);k.position.set(0,3.2,0),i.add(k);const M=Pn("✅ Selesai",3066993);M.position.set(0,4.2,0),M.visible=!1,i.add(M);const E=new ae({color:54527,emissive:54527,emissiveIntensity:.5,transparent:!0,opacity:.25,side:At}),I=new C(new cn(3.2,32),E);I.rotation.x=-Math.PI/2,I.position.y=.02,i.add(I),n.add(i),e.push({group:i,glowMat:E,idx:0,pos:t,done:!1,doneSprite:M,_probe:x,_meter:m})}{const t=Ur[1],i=new jt;i.position.copy(t);const a=new Me({color:11197934,transparent:!0,opacity:.7}),s=new Me({color:5910024,transparent:!0,opacity:.9});new Me({color:1735226,transparent:!0,opacity:.85});const r=new Me({color:8952234}),o=new Me({color:16448250});new Me({color:15965202});const l=new C(new oe(6.8,.12,2.8),new Me({color:15791336}));l.position.set(0,3.14,0),i.add(l);const d=new C(new oe(.22,.9,.14),o);d.position.set(-2,3.75,0),i.add(d);const c=new C(new oe(.16,.3,.05),new Me({color:1714714}));c.position.set(-2,3.88,.1),i.add(c);const p=new C(new ge(.03,.03,.5,16),r);p.position.set(-2,3.05,0),i.add(p);const f=new C(new ge(.42,.38,.8,20),a);f.position.set(-.5,3.7,.2),i.add(f);const h=new C(new ge(.38,.34,.6,20),s);h.position.set(-.5,3.6,.2),i.add(h),new Me({color:2899536});const g=new C(new ge(.05,.05,1.4,14),r);g.position.set(1.2,3.9,-.7),i.add(g);const x=new C(new oe(1.4,1,.05),new Me({color:16775399}));x.position.set(1.2,4.85,-.7),i.add(x);const m=Pn("K⁺  Ca²⁺  Cl⁻",1735226);m.scale.set(2.8,.75,1),m.position.set(1.2,4.92,-.6),i.add(m);const u=new C(new oe(.55,.4,.22),o);u.position.set(2.2,3.4,0),i.add(u);const v=new C(new oe(.38,.22,.06),new Me({color:662026}));v.position.set(2.2,3.44,.14),i.add(v);for(const[E,I]of[[2.8,s],[3.3,a]]){const y=new C(new ge(.18,.16,.7,20),I);y.position.set(E,3.55,-.5),i.add(y)}const b=Pn("❓ Fenomena 2 — Komposisi TDS",16750848);b.position.set(0,3.2,0),i.add(b);const _=Pn("✅ Selesai",3066993);_.position.set(0,4.2,0),_.visible=!1,i.add(_);const k=new ae({color:16750848,emissive:16750848,emissiveIntensity:.5,transparent:!0,opacity:.25,side:At}),M=new C(new cn(3.2,32),k);M.rotation.x=-Math.PI/2,M.position.y=.02,i.add(M),n.add(i),e.push({group:i,glowMat:k,idx:1,pos:t,done:!1,doneSprite:_,_beaker:f,_liq:h})}{const t=Ur[2],i=new jt;i.position.copy(t);const a=new Me({color:8018990}),s=new Me({color:5025616}),r=new Me({color:11059264}),o=new Me({color:11887901}),l=new Me({color:11197934,transparent:!0,opacity:.7}),d=new Me({color:16448250}),c=new Me({color:8952234}),p=new C(new oe(6.8,.12,2.8),new Me({color:15791336}));p.position.set(0,3.14,0),i.add(p);const f=[{x:-2,mat:s,height:.9,label:`Thn 1
62%`,lColor:5025616},{x:0,mat:r,height:1.1,label:`Thn 2
78%`,lColor:11059264},{x:2,mat:o,height:.35,label:`Thn 3
34%`,lColor:15158332}];for(const N of f){const H=new C(new oe(1.2,.2,.9),a);H.position.set(N.x,3.35,.2),i.add(H);for(let P=-1;P<=1;P+=2){const z=new C(new ge(.04,.055,N.height,5),N.mat),X=N.x+P*.22;z.position.set(X,3.45+N.height/2,.2),i.add(z);const ne=new C(new at(N.height>.8?.14:.06,12,8),N.mat);ne.position.set(X+(N.mat===o?.1:0),3.45+N.height+.08,.2),i.add(ne)}const se=Pn(N.label,N.lColor);se.scale.set(2,.75,1),se.position.set(N.x,3.45+N.height+.6,.2),i.add(se)}const h=new C(new oe(.22,.75,.14),d);h.position.set(-2.9,3.65,-.4),i.add(h);const g=new C(new ge(.025,.025,.55,16),c);g.position.set(-2.9,3.12,-.4),i.add(g);const x=new C(new oe(.15,.22,.05),new Me({color:662026}));x.position.set(-2.9,3.72,-.33),i.add(x);const m=new Me({color:8018990,transparent:!0,opacity:.9}),u=new C(new ge(.28,.25,.6,20),l);u.position.set(2.8,3.55,-.4),i.add(u);const v=new C(new ge(.24,.22,.38,20),m);v.position.set(2.8,3.44,-.4),i.add(v);const b=new Me({color:16775399}),_=new C(new oe(.8,1,.05),b);_.position.set(3.2,3.95,-.6),_.rotation.y=-.25,i.add(_);const k=[5025616,11059264,15158332],M=[.22,.3,.1];for(let N=0;N<3;N++){const H=new Me({color:k[N]}),se=new C(new oe(.12,M[N],.04),H);se.position.set(3.05+N*.2,3.5+M[N]/2,-.57),se.rotation.y=-.25,i.add(se)}const E=Pn("❓ Fenomena 3 — Panen Padi",4521864);E.position.set(0,3.2,0),i.add(E);const I=Pn("✅ Selesai",3066993);I.position.set(0,4.4,0),I.visible=!1,i.add(I);const y=new ae({color:4521864,emissive:4521864,emissiveIntensity:.5,transparent:!0,opacity:.25,side:At}),T=new C(new cn(3.2,32),y);T.rotation.x=-Math.PI/2,T.position.y=.02,i.add(T),n.add(i),e.push({group:i,glowMat:y,idx:2,pos:t,done:!1,doneSprite:I,_stems:i.children})}return e}function Pn(n,e){const t=document.createElement("canvas");t.width=320,t.height=72;const i=t.getContext("2d");i.fillStyle="rgba(10,20,40,0.85)",i.beginPath(),i.roundRect(4,8,312,56,16),i.fill();const a=e>>16&255,s=e>>8&255,r=e&255;i.strokeStyle=`rgb(${a},${s},${r})`,i.lineWidth=3,i.beginPath(),i.roundRect(4,8,312,56,16),i.stroke(),i.fillStyle=`rgb(${a},${s},${r})`,i.font="bold 24px Segoe UI, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(n,160,36);const o=new Fs(t),l=new ai({map:o,transparent:!0}),d=new Ai(l);return d.scale.set(5,1.1,1),d}function mg(n,e){for(const t of n){if(t.done){t.glowMat.emissiveIntensity=.15+Math.sin(e*1.2)*.05,t.glowMat.opacity=.12;continue}const i=.5+.5*Math.sin(e*2.2+t.idx*1.3);if(t.glowMat.emissiveIntensity=.3+i*.5,t.glowMat.opacity=.15+i*.15,t.idx===0&&(t._probe&&(t._probe.position.y=4.2+Math.sin(e*1.4)*.12),t._meter&&(t._meter.position.y=4.85+Math.sin(e*1.4)*.12)),t.idx===1&&t._liq){const a=1+Math.sin(e*2.5)*.04;t._liq.scale.set(1,a,1)}t.idx===2&&(t.group.rotation.z=Math.sin(e*.6)*.008),t.group.position.y=Math.sin(e*.5+t.idx)*.04}}const St=70,qt=50,rt=18;new L(-18,0,10),new L(0,0,-8),new L(18,0,10);function gg(){const n=new da;n.background=new Ve(1708552),n.fog=new Ha(1708552,35,85),n.add(new Hs(16771248,.4));const e=[[-22,rt-1,10],[-22,rt-1,-10],[0,rt-1,10],[0,rt-1,-10],[22,rt-1,10],[22,rt-1,-10]];for(const[s,r,o]of e){const l=new ti(16765056,1.1,30);l.position.set(s,r,o),n.add(l)}const t=new ti(16737792,1.5,18);t.position.set(-18,6,8),n.add(t);const i=new ti(8956671,.8,14);i.position.set(0,6,-6),n.add(i);const a=new Mn(16773324,.4);return a.position.set(10,20,10),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),n.add(a),{scene:n}}function xg(n){vg(n),_g(n),Sg(n)}function vg(n){const e=new ae({color:5919299,roughness:.9,metalness:0}),t=new ae({color:4866096,roughness:.85,metalness:0}),i=new ae({color:3024410,roughness:.9,metalness:0}),a=new C(new _t(St,qt),e);a.rotation.x=-Math.PI/2,a.receiveShadow=!0,n.add(a);const s=new ua({color:3813920});for(let g=-St/2;g<=St/2;g+=5){const x=new xt().setFromPoints([new L(g,.01,-qt/2),new L(g,.01,qt/2)]);n.add(new Fn(x,s))}for(let g=-qt/2;g<=qt/2;g+=5){const x=new xt().setFromPoints([new L(-St/2,.01,g),new L(St/2,.01,g)]);n.add(new Fn(x,s))}const r=new C(new _t(St,qt),i);r.rotation.x=Math.PI/2,r.position.y=rt,n.add(r);const o=new Me({color:1971728});for(let g=-St/2;g<=St/2;g+=4){const x=new C(new oe(.4,.15,qt),o);x.position.set(g,rt,0),n.add(x)}const l=.6,d=[{pos:[0,rt/2,-qt/2],size:[St,rt,l]},{pos:[0,rt/2,qt/2],size:[St,rt,l]},{pos:[-St/2,rt/2,0],size:[l,rt,qt]},{pos:[St/2,rt/2,0],size:[l,rt,qt]}];for(const g of d){const x=new C(new oe(...g.size),t);x.position.set(...g.pos),n.add(x)}const c=new Me({color:3813408}),p=[[-St/2+1,rt/2,-qt/2+1],[St/2-1,rt/2,-qt/2+1],[-St/2+1,rt/2,qt/2-1],[St/2-1,rt/2,qt/2-1],[-St/2+1,rt/2,0],[St/2-1,rt/2,0]];for(const[g,x,m]of p){const u=new C(new oe(1.2,rt,1.2),c);u.position.set(g,x,m),n.add(u)}const f=new Me({color:8947848}),h=new ae({color:16774592,emissive:16765024,emissiveIntensity:1.2});for(const[g,,x]of bg){const m=new C(new oe(1.5,.4,.6),f);m.position.set(g,rt-.8,x),n.add(m);const u=new C(new at(.25,16,10),h);u.position.set(g,rt-1.1,x),n.add(u)}}const bg=[[-22,rt-1,10],[-22,rt-1,-10],[0,rt-1,10],[0,rt-1,-10],[22,rt-1,10],[22,rt-1,-10]];function _g(n){yg(n,-18,0,6),wg(n,0,0,-12),Mg(n,18,0,6)}function yg(n,e,t,i){const a=new jt;a.position.set(e,t,i);const s=new Me({color:3944480}),r=new C(new oe(5,.4,5),s);r.position.y=.2,a.add(r);const o=new ae({color:7372944,metalness:.7,roughness:.3}),l=new C(new ge(2,2,5.5,24),o);l.position.y=3.15,a.add(l);const d=new C(new at(2,24,14,0,Math.PI*2,0,Math.PI/2),o);d.position.y=5.9,a.add(d);const c=new C(new at(2,24,14,0,Math.PI*2,Math.PI/2,Math.PI/2),o);c.position.y=.4,a.add(c);const p=new Me({color:9474208});for(let k=1.5;k<=5.5;k+=1.5){const M=new C(new xn(2.06,.09,10,40),p);M.rotation.x=Math.PI/2,M.position.y=k+.5,a.add(M)}const f=new ae({color:6719658,metalness:.6,roughness:.4}),h=new C(new ge(.12,.12,2,16),f);h.position.set(.8,7.2,0),a.add(h);const g=new C(new ge(.15,.15,1.8,16),f);g.rotation.z=Math.PI/2,g.position.set(-2.8,1.2,0),a.add(g);const x=new C(new at(.18,16,14),f);x.position.set(-3.7,1.2,0),a.add(x);const m=new C(new ge(.15,.15,1.2,16),f);m.position.set(-3.7,.6,0),a.add(m);const u=new ae({color:13378082,metalness:.5,roughness:.5}),v=new C(new ge(.22,.22,.5,16),u);v.rotation.z=Math.PI/2,v.position.set(-2.85,2.5,0),a.add(v);const b=new C(new ge(.1,.1,2.5,16),f);b.position.set(-.5,8,0),a.add(b);const _=new ae({color:8965375,transparent:!0,opacity:.35,roughness:.2,metalness:0});for(let k=0;k<5;k++){const M=new C(new at(.12+k*.04,12,10),_);M.position.set(-.5,8.8+k*.28,0),M.userData.bubbleIndex=k,a.add(M)}return Ao(a,`FERMENTOR
DRUM`,0,9.5,0,16752704),n.add(a),a}function wg(n,e,t,i){const a=new jt;a.position.set(e,t,i);const s=new ae({color:11189196,metalness:.8,roughness:.25}),r=new ae({color:5596791,metalness:.7,roughness:.35}),o=new ae({color:8952234,metalness:.6,roughness:.4}),l=new C(new oe(4,.4,4),r);l.position.y=.2,a.add(l);const d=new C(new ge(.8,1,8,24),s);d.position.y=4.4,a.add(d);for(let E=1.5;E<=7.5;E+=1.2){const I=new C(new ge(.95,.95,.12,24),r);I.position.y=E,a.add(I)}const c=new C(new ge(.7,.7,1.5,20),r);c.position.y=9.2,a.add(c);const p=new ae({color:8956620,metalness:.8,roughness:.2});for(let E=0;E<4;E++){const I=new C(new xn(.5,.06,12,36),p);I.rotation.x=Math.PI/2,I.position.y=9.1+E*.28,a.add(I)}const f=new C(new at(.7,18,10,0,Math.PI*2,0,Math.PI/2),r);f.position.y=10.2,a.add(f);const h=new C(new ge(.12,.12,2.5,16),o);h.rotation.z=Math.PI/2,h.position.set(-1.85,6.5,0),a.add(h);const g=new C(new ge(.1,.1,1.5,16),o);g.position.set(.5,11,0),a.add(g);const x=new C(new ge(.13,.13,2,16),o);x.rotation.z=Math.PI/2,x.position.set(1.8,9.6,0),a.add(x);const m=new C(new ge(.16,.16,1.4,16),o);m.position.set(.8,.3,0),a.add(m);const u=new ae({color:8016432,metalness:.3,roughness:.7}),v=new C(new ge(.65,.6,1.2,20),u);v.position.set(.8,-.2,0),a.add(v);const b=new C(new ge(.66,.66,.08,20),r);b.position.set(.8,.42,0),a.add(b);const _=new ae({color:11197951,transparent:!0,opacity:.5}),k=new C(new ge(.07,.07,4,16),_);k.position.set(-.92,3,.7),a.add(k);const M=new C(new ge(.06,.06,2.5,16),new ae({color:6332608,transparent:!0,opacity:.7}));return M.position.set(-.92,2.25,.7),a.add(M),Ao(a,`DESTILATOR
KOLOM`,0,11.5,0,8441087),n.add(a),a}function Mg(n,e,t,i){const a=new jt;a.position.set(e,t,i);const s=new ae({color:4473924,metalness:.6,roughness:.5}),r=new Me({color:9127187}),o=new ae({color:16737792,emissive:16724736,emissiveIntensity:.9}),l=new ae({color:7368816,metalness:.8,roughness:.3}),d=new C(new oe(3.5,2,3),r);d.position.y=1,a.add(d);const c=new C(new oe(3.5,.15,3),s);c.position.y=2.08,a.add(c);for(let E=-1.4;E<=1.4;E+=.5){const I=new C(new oe(.1,.16,2.5),new Me({color:2236962}));I.position.set(E,2.08,0),a.add(I)}const p=new C(new Bn(.5,1.2,14),o);p.position.y=2.9,a.add(p);const f=new C(new Bn(.3,.9,14),o.clone());f.position.set(.6,2.85,.4),a.add(f);const h=new C(new ge(1.2,1,1.4,24),l);h.position.y=3.75,a.add(h);const g=new ae({color:8145424,transparent:!0,opacity:.85}),x=new C(new ge(1.18,1.18,.8,24),g);x.position.y=3.85,a.add(x);const m=new ae({color:14540253,transparent:!0,opacity:.25});for(let E=0;E<3;E++){const I=new C(new at(.25+E*.12,12,10),m);I.position.set((E-1)*.4,5+E*.5,(E-1)*.3),I.userData.steamIndex=E,a.add(I)}const u=new ae({color:13421772,metalness:.5}),v=new C(new ge(.22,.22,.08,20),u);v.rotation.x=Math.PI/2,v.position.set(1.5,3.2,-1.4),a.add(v);const b=new C(new cn(.2,12),new ae({color:16777215}));b.rotation.x=-Math.PI/2,b.position.set(1.5,3.21,-1.62),a.add(b);const _=new Me({color:3355443}),k=new C(new ge(.25,.3,3,20),_);k.position.set(-1.2,3.5,-1.2),a.add(k);const M=new ae({color:8947848,transparent:!0,opacity:.2});for(let E=0;E<4;E++){const I=new C(new at(.18+E*.1,12,10),M);I.position.set(-1.2,5+E*.6,-1.2),I.userData.smokeIndex=E,a.add(I)}return Ao(a,`KOMPOR
PEMANAS`,0,7.5,0,16746564),n.add(a),a}function Sg(n){const e=new ae({color:5910544,metalness:.2,roughness:.8}),t=new ae({color:8947848,metalness:.6,roughness:.4}),i=[[-28,0,-16],[-28,0,-12],[-28,0,-8],[-24,0,-16],[-24,0,-12],[-24,0,-8]];for(const[c,,p]of i){const f=new C(new ge(.7,.65,1.5,20),e);f.position.set(c,.75,p),n.add(f);const h=new C(new xn(.72,.05,10,28),t);h.rotation.x=Math.PI/2,h.position.set(c,1.2,p),n.add(h);const g=h.clone();g.position.set(c,.4,p),n.add(g)}Ts(n,`MOLASSES
STORAGE`,-26,3.2,-12,16755234,1.8);const a=new Me({color:5275840}),s=[[28,0,-18],[28,0,-15],[28,0,-12]];for(const[c,,p]of s){const f=new C(new oe(.8,.5,1.2),a);f.position.set(c,.25,p),n.add(f);const h=new C(new oe(.8,.5,1.2),a);h.position.set(c+.9,.25,p),n.add(h)}Ts(n,"NPK / UREA",29,2.8,-15,8956671,1.6);const r=new ae({color:13412928,metalness:.5});for(let c=0;c<3;c++){const p=new C(new ge(.3,.3,.9,20),r);p.position.set(28,.45,-6+c*1.2),n.add(p)}Ts(n,`RAGI
(YEAST)`,29,2.4,-5,16768384,1.5),Or(n,-St/2+.8,5,-10,`⚠️ BAHAYA
GAS BERTEKANAN`),Or(n,-St/2+.8,5,10,`🔥 AREA
PANAS`),Or(n,St/2-.8,5,-10,`☣️ LIMBAH
VINASSE`),Nr(n,-18,.05,5,0),Nr(n,-9,.05,3,-Math.PI/4),Nr(n,9,.05,3,Math.PI/4),Eg(n);const o=new ae({color:5583633}),l=new C(new oe(2.5,.15,2.5),o);l.position.set(0,.08,-12),n.add(l);const d=new C(new oe(2.3,.08,2.3),new ae({color:3807232,transparent:!0,opacity:.9}));d.position.set(0,.12,-12),n.add(d)}function Eg(n){const e=new ae({color:10066346,metalness:.6,roughness:.4}),t=new C(new ge(.14,.14,22,16),e);t.rotation.z=Math.PI/2,t.position.set(-9,11,0),n.add(t);const i=new C(new ge(.14,.14,5,16),e);i.position.set(0,8.5,-12),n.add(i);const a=new C(new ge(.14,.14,20,16),e);a.rotation.z=Math.PI/2,a.position.set(9,11,0),n.add(a);for(const[s,r]of[[-18,6],[0,-12],[18,6]]){const o=new C(new ge(.14,.14,3,16),e);o.position.set(s,9.5,r),n.add(o)}}function Nr(n,e,t,i,a){const s=new Me({color:16755200}),r=new C(new oe(.3,.05,5),s);r.position.set(e,t,i),r.rotation.y=a,n.add(r);const o=new C(new Bn(.5,.9,4),s);o.rotation.x=Math.PI/2,o.rotation.z=a,o.position.set(e+Math.sin(a)*3,t,i+Math.cos(a)*-3),n.add(o)}function Or(n,e,t,i,a){const s=new Me({color:16763904}),r=new C(new oe(1.8,1.2,.06),s);r.position.set(e,t,i),e<0?r.rotation.y=Math.PI/2:r.rotation.y=-Math.PI/2,n.add(r),Ts(n,a,e,t,i,2236962,1.2,r.rotation.y)}function Ao(n,e,t,i,a,s=16777215){const r=e.split(`
`),o=document.createElement("canvas");o.width=256,o.height=64*r.length;const l=o.getContext("2d");l.fillStyle="rgba(0,0,0,0)",l.fillRect(0,0,o.width,o.height);const d="#"+s.toString(16).padStart(6,"0");l.fillStyle=d,l.font="bold 28px sans-serif",l.textAlign="center",l.textBaseline="middle",r.forEach((h,g)=>{l.fillText(h,128,32+g*64)});const c=new Fs(o),p=new ai({map:c,depthTest:!1}),f=new Ai(p);f.scale.set(3.5,1*r.length,1),f.position.set(t,i,a),n.add(f)}function Ts(n,e,t,i,a,s=16777215,r=2,o=0){const l=e.split(`
`),d=document.createElement("canvas");d.width=256,d.height=64*l.length;const c=d.getContext("2d");c.fillStyle="rgba(0,0,0,0)",c.fillRect(0,0,d.width,d.height);const p="#"+s.toString(16).padStart(6,"0");c.fillStyle=p,c.font="bold 28px sans-serif",c.textAlign="center",c.textBaseline="middle",l.forEach((x,m)=>c.fillText(x,128,32+m*64));const f=new Fs(d),h=new ai({map:f,depthTest:!1}),g=new Ai(h);g.scale.set(r*l.length*.7+1,r*.7*l.length*.5+.5,1),g.position.set(t,i,a),n.add(g)}const vd=60,bd=50,_n=new L(0,0,-10);function Tg(){const n=new da;n.background=new Ve(8900331),n.fog=new Ba(11589872,.008),n.add(new fd(10409208,8034896,1.1));const e=new Mn(16774604,2.4);e.position.set(25,40,20),e.castShadow=!0,e.shadow.mapSize.set(1024,1024),e.shadow.camera.near=.5,e.shadow.camera.far=140,e.shadow.camera.left=-44,e.shadow.camera.right=44,e.shadow.camera.top=44,e.shadow.camera.bottom=-44,n.add(e);const t=new Mn(12114175,.6);t.position.set(-20,18,-15),n.add(t);const i=new ti(16769168,.8,35);i.position.set(0,5,0),n.add(i);const a=new ti(16772761,1,18);return a.position.set(_n.x,8,_n.z),n.add(a),{scene:n}}function Ag(n){Lg(n),kg(n),Cg(n),Rg(n),Pg(n),Dg(n),Ug(n)}function Lg(n){const e=new Me({color:1849872});new Me({color:2760202});const t=new C(new _t(vd*2,bd*2),e);t.rotation.x=-Math.PI/2,t.receiveShadow=!0,n.add(t);const i=new Me({color:4864032}),a=new C(new _t(3,22),i);a.rotation.x=-Math.PI/2,a.position.set(0,.01,0),n.add(a)}function kg(n){const e=new Me({color:8017200}),t=new ua({color:4874304}),i=vd/2,a=bd/2,s=[[-i,-a],[i,-a],[i,a],[-i,a],[-i,-a]],r=s.map(([l,d])=>new L(l,1.2,d)),o=new xt().setFromPoints(r);n.add(new Fn(o,t));for(let l=0;l<4;l++){const[d,c]=s[l],[p,f]=s[l+1],h=Math.ceil(Math.sqrt((p-d)**2+(f-c)**2)/8);for(let g=0;g<=h;g++){const x=g/h,m=new C(new ge(.1,.1,2.4,5),e);m.position.set(d+(p-d)*x,1.2,c+(f-c)*x),n.add(m)}}}function Cg(n){const e=new Me({color:3815472}),t=new Me({color:2762776}),i=new Me({color:1574912,transparent:!0,opacity:.92}),a=new Me({color:667664,transparent:!0,opacity:.85}),s=.6,r=22,o=16,l=1.5,d=new C(new oe(r+s*2,l,s),e);d.position.set(0,l/2,-8),n.add(d);const c=d.clone();c.position.set(0,l/2,o/2),n.add(c);const p=new C(new oe(s,l,o),e);p.position.set(r/2,l/2,0),n.add(p);const f=p.clone();f.position.set(-r/2,l/2,0),n.add(f);const h=new C(new _t(r,o),t);h.rotation.x=-Math.PI/2,h.position.y=.01,n.add(h);const g=new C(new _t(r-s*2,o-s*2),i);g.rotation.x=-Math.PI/2,g.position.y=.8,n.add(g);const x=new C(new oe(s,l,o),e);x.position.set(4,l/2,0),n.add(x);const m=new C(new _t(r/2-4-s*1.5,o-s*2),a);m.rotation.x=-Math.PI/2,m.position.set(r/2-(r/4-2+s*.5)-1.5,.8,0),n.add(m),_d(n,`REAKTOR
BIOREMEDIASI`,0,2.5,-o/2-1.2,4259712)}function Rg(n){const e=new Me({color:5271648}),t=new Me({color:3162160}),i=new C(new ge(.22,.22,14,20),e);i.rotation.x=Math.PI/2,i.position.set(-1.2,1.8,-3),n.add(i);const a=new C(new oe(.5,.5,.5),e);a.position.set(-1.2,1.8,-8),n.add(a);const s=new C(new ge(.22,.22,2,20),e);s.position.set(-1.2,.8,-8.2),n.add(s);for(const r of[-2,-5,-8]){const o=new C(new oe(.3,.6,.15),t);o.position.set(-.7,2.1,r),n.add(o)}}function Pg(n){const e=new Me({color:9056272}),t=new Me({color:13388320}),i=new Me({color:3160112}),a=_n.x,s=_n.z,r=new C(new ge(.15,.2,3.5,16),i);r.position.set(a,1.75,s),n.add(r);const o=new C(new oe(1,.8,1.2),e);o.position.set(a,3.5,s),n.add(o);const l=new C(new xn(.55,.1,12,32),t);l.position.set(a,3.5,s-.7),l.rotation.x=Math.PI/2,n.add(l);for(let d=0;d<4;d++){const c=new C(new ge(.05,.05,1,14),t);c.rotation.z=d/4*Math.PI,c.position.set(a,3.5,s-.7),n.add(c)}_d(n,`KRAN
VINASSE`,a,5.5,s,16752736)}function Dg(n){const e=new Me({color:1728544}),t=new Me({color:2785344,transparent:!0,opacity:.8}),i=[[-7,-4],[-8,0],[-7,3],[-9,-2]];for(const[r,o]of i){const l=new C(new _t(2+Math.random()*1.5,1.2+Math.random()),t);l.rotation.x=-Math.PI/2,l.position.set(r,.85,o),n.add(l)}const a=[[-24,-18],[-20,18],[22,-14],[26,8],[-28,4],[16,20],[-12,-20],[18,-20]];for(const[r,o]of a)Ig(n,r,o,e);const s=new Me({color:9089088});for(let r=-3;r<=3;r++){const o=new C(new ge(.07,.09,3.5+Math.random(),6),s);o.position.set(-28+r*.4,1.75,-22+Math.random()*2),n.add(o)}}function Ig(n,e,t,i){const a=.6+Math.random()*.5,s=new C(new Bn(.6+Math.random()*.3,a,6),i);s.position.set(e,a/2,t),n.add(s)}function Ug(n){const e=new wt({color:6993128,side:Ht}),t=new C(new at(120,20,14),e);n.add(t);const i=new wt({color:16776672,side:At}),a=new C(new cn(8,24),i);a.position.set(30,22,-88),a.lookAt(0,14,0),n.add(a);const s=new wt({color:16774560,transparent:!0,opacity:.35,side:At}),r=new C(new cn(13,24),s);r.position.copy(a.position),r.rotation.copy(a.rotation),n.add(r);const o=new wt({color:16448250,transparent:!0,opacity:.88,side:At});[[0,22,-85,1.1],[-35,20,-78,.9],[50,21,-80,1],[-30,22,85,1],[35,20,80,.85],[-90,21,10,.9],[90,20,-5,.8]].forEach(([l,d,c,p])=>{const f=new L(l,d,c).normalize();[-1,0,1].forEach(h=>{const x=new L().crossVectors(f,new L(0,1,0)).normalize().clone().multiplyScalar(h*7*p),m=new C(new at(5*p,8,6),o);m.position.set(l+x.x,d+(h===0?2*p:0),c+x.z),n.add(m)})})}function Ng(n){const e=new wt({color:16744480,transparent:!0,opacity:.6,side:At}),t=new C(new xn(1.2,.25,10,32),e);t.position.set(_n.x,5.5,_n.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(_n.x,7,_n.z),a.visible=!1,n.add(a),{idx:0,pos:{x:_n.x,z:_n.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isValve:!0}}function Og(n,e){!n||n.done||(n.glowMat.opacity=.4+.35*Math.sin(e*3.5),n.glowMesh.rotation.z=e*1.2)}function _d(n,e,t,i,a,s){const r=new C(new oe(2.5,.8,.1),new wt({color:s}));r.position.set(t,i,a),n.add(r)}const ji=56,Ki=44,yn=new L(0,0,-14);function zg(){const n=new da;n.background=new Ve(1715780),n.fog=new Ba(1583168,.012),n.add(new Hs(10537192,1));const e=new Mn(15267071,1.6);e.position.set(0,20,5),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.near=.5,e.shadow.camera.far=80,e.shadow.camera.left=-30,e.shadow.camera.right=30,e.shadow.camera.top=30,e.shadow.camera.bottom=-30,n.add(e);const t=new ti(6343935,2,28);t.position.set(yn.x,4,yn.z),n.add(t);const i=new Mn(9482448,.8);return i.position.set(-18,10,-10),n.add(i),{scene:n}}function Fg(n){Bg(n),Hg(n),Gg(n),Vg(n),Wg(n)}function Bg(n){const e=new ae({color:1712688,roughness:.9,metalness:.05}),t=new ae({color:1846332,roughness:.85,metalness:0}),i=new ae({color:1120288,roughness:1,metalness:0}),a=ji/2,s=Ki/2,r=10,o=new C(new _t(ji,Ki),e);o.rotation.x=-Math.PI/2,o.receiveShadow=!0,n.add(o);const l=new C(new _t(ji,Ki),i);l.rotation.x=Math.PI/2,l.position.y=r,n.add(l);const d=[{pos:[0,r/2,-s],rot:[0,0,0],size:[ji,r]},{pos:[0,r/2,s],rot:[0,Math.PI,0],size:[ji,r]},{pos:[-a,r/2,0],rot:[0,Math.PI/2,0],size:[Ki,r]},{pos:[a,r/2,0],rot:[0,-Math.PI/2,0],size:[Ki,r]}];for(const f of d){const h=new C(new _t(...f.size),t);h.position.set(...f.pos),h.rotation.set(...f.rot),n.add(h)}const c=new wt({color:9488639});for(let f=-18;f<=18;f+=12){const h=new C(new oe(.3,.08,18),c);h.position.set(f,r-.05,0),n.add(h)}const p=new ua({color:1716304});for(let f=-a;f<=a;f+=4){const h=[new L(f,.01,-s),new L(f,.01,s)];n.add(new Fn(new xt().setFromPoints(h),p))}for(let f=-s;f<=s;f+=4){const h=[new L(-a,.01,f),new L(a,.01,f)];n.add(new Fn(new xt().setFromPoints(h),p))}}function Hg(n){const e=new ae({color:2767434,roughness:.7}),t=new ae({color:1714224,roughness:.8}),i=new ae({color:2130080,transparent:!0,opacity:.35,roughness:.1,metalness:.1}),a=new ae({color:2099712,transparent:!0,opacity:.85,roughness:.3}),s=new ae({color:4213328,roughness:.5,metalness:.3});[{x:-16,z:2},{x:0,z:2},{x:16,z:2}].forEach(({x:o,z:l})=>{const d=new C(new oe(8,.15,3.5),e);d.position.set(o,3.1,l),d.castShadow=!0,d.receiveShadow=!0,n.add(d);for(const[x,m]of[[-3.5,-1.4],[3.5,-1.4],[-3.5,1.4],[3.5,1.4]]){const u=new C(new oe(.15,3.1,.15),t);u.position.set(o+x,1.55,l+m),n.add(u)}const c=new C(new oe(3,1.6,1.6),i);c.position.set(o-1,4.1,l),n.add(c);const p=new C(new _t(2.8,1.5),a);p.rotation.x=-Math.PI/2,p.position.set(o-1,3.42,l),n.add(p);const f=new C(new oe(.5,.4,.4),s);f.position.set(o+2.2,3.35,l-.5),n.add(f);const h=new ae({color:8429712,roughness:.6}),g=new C(new ge(.04,.04,.9,8),h);g.position.set(o+1.8,3.75,l-.5),n.add(g)})}function Gg(n){const e=new ae({color:2767402,roughness:.8}),t=new ae({color:4214880,roughness:.6,metalness:.2}),i=new ae({color:6303776,roughness:.7}),a=new wt({color:4259788});for(let s=-18;s<=18;s+=18){const r=new C(new oe(8,6,.2),e);r.position.set(s,3,-22+.15),n.add(r);for(let o=0;o<3;o++){const l=new C(new oe(7.6,.08,.5),e);l.position.set(s,1.2+o*2,-22+.45),n.add(l);for(let c=-2;c<=2;c++){const p=.3+Math.random()*.5,f=new C(new ge(.18,.18,p,8),c%2===0?t:i);f.position.set(s+c*1.4,1.25+o*2+p/2,-22+.5),n.add(f)}const d=new C(new oe(6,.06,.08),a);d.position.set(s,1.18+o*2,-22+.6),n.add(d)}}}function Vg(n){const e=new ae({color:1714224,roughness:.6,metalness:.3}),t=new ae({color:6192,roughness:.1,metalness:.2,emissive:new Ve(16544),emissiveIntensity:.5}),i=new ae({color:3160128,roughness:.5,metalness:.5}),a=new ae({color:2765376,roughness:.8}),s=yn.x,r=yn.z,o=new C(new ge(.5,.65,3.4,16),e);o.position.set(s,1.7,r),o.castShadow=!0,n.add(o);const l=new C(new oe(2.4,1.8,.12),i);l.position.set(s,4.4,r),n.add(l);const d=new C(new oe(2.2,1.6,.06),t);d.position.set(s,4.4,r-.04),n.add(d);const c=new C(new oe(1.8,.06,.7),a);c.position.set(s,3.55,r+.3),n.add(c);const p=new wt({color:4245759});for(let m=0;m<3;m++){const u=new C(new oe(1.5,.02,.08),p);u.position.set(s,3.59,r+.12+m*.16),n.add(u)}const f=new wt({color:43775}),h=new C(new oe(2.8,.5,.08),f);h.position.set(s,5.7,r),n.add(h);const g=new wt({color:4259839}),x=new C(new oe(.3,.3,.1),g);x.position.set(s-1.3,4.4,r-.1),n.add(x)}function Wg(n){const e=ji/2,t=Ki/2,i=new ae({color:3689016,roughness:.8});for(const[l,d]of[[e-1.5,-t+1.2],[e-1.5,t-1.2]]){const c=new C(new oe(2.4,5,1.6),i);c.position.set(l,2.5,d),c.castShadow=!0,n.add(c);const p=new C(new oe(.06,.4,.06),new ae({color:10526816,metalness:.8,roughness:.2}));p.position.set(l-.7,2.5,d-.85),n.add(p)}const a=new ae({color:1720416,roughness:.9}),s=new wt({color:54527});for(const l of[-10,0,10]){const d=new C(new oe(.08,3,2.2),a);d.position.set(-e+.08,4.5,l),n.add(d);const c=new C(new oe(.04,2.4,.08),s);c.position.set(-e+.1,5.2,l),n.add(c)}const r=new ae({color:6963232,roughness:.9}),o=new ae({color:1728544,roughness:1});for(const[l,d]of[[-e+2,t-2],[-e+2,-t+2]]){const c=new C(new ge(.4,.3,.7,12),r);c.position.set(l,.35,d),n.add(c);const p=new C(new Bn(.7,1.4,8),o);p.position.set(l,1.4,d),n.add(p)}}function Xg(n){const e=new wt({color:52479,transparent:!0,opacity:.65,side:At}),t=new C(new xn(1.1,.2,10,32),e);t.position.set(yn.x,6.2,yn.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(yn.x,7.2,yn.z),a.visible=!1,n.add(a),{idx:0,pos:{x:yn.x,z:yn.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isTerminal:!0}}function qg(n,e){!n||n.done||(n.glowMat.opacity=.4+.3*Math.sin(e*4),n.glowMesh.rotation.z=e*1.5)}const $n=52,Yn=40,wn=new L(0,0,-12);function $g(){const n=new da;n.background=new Ve(1714748),n.fog=new Ba(1450032,.01),n.add(new Hs(11585760,1));const e=new Mn(14741759,1.6);e.position.set(5,18,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.near=.5,e.shadow.camera.far=80,e.shadow.camera.left=-28,e.shadow.camera.right=28,e.shadow.camera.top=28,e.shadow.camera.bottom=-28,n.add(e);const t=new ti(16768384,2.2,22);t.position.set(wn.x,5,wn.z),n.add(t);const i=new Mn(8425664,.7);return i.position.set(-15,8,-5),n.add(i),{scene:n}}function Yg(n){jg(n),Kg(n),Jg(n),Zg(n),Qg(n)}function jg(n){const e=new ae({color:1450030,roughness:.85,metalness:.05}),t=new ae({color:1582132,roughness:.9}),i=new ae({color:924200,roughness:1}),a=$n/2,s=Yn/2,r=9,o=new C(new _t($n,Yn),e);o.rotation.x=-Math.PI/2,o.receiveShadow=!0,n.add(o);const l=new C(new _t($n,Yn),i);l.rotation.x=Math.PI/2,l.position.y=r,n.add(l);const d=[{pos:[0,r/2,-s],rot:[0,0,0],size:[$n,r]},{pos:[0,r/2,s],rot:[0,Math.PI,0],size:[$n,r]},{pos:[-a,r/2,0],rot:[0,Math.PI/2,0],size:[Yn,r]},{pos:[a,r/2,0],rot:[0,-Math.PI/2,0],size:[Yn,r]}];for(const f of d){const h=new C(new _t(...f.size),t);h.position.set(...f.pos),h.rotation.set(...f.rot),n.add(h)}const c=new ua({color:1714746});for(let f=-a;f<=a;f+=3){const h=[new L(f,.01,-s),new L(f,.01,s)];n.add(new Fn(new xt().setFromPoints(h),c))}for(let f=-s;f<=s;f+=3){const h=[new L(-a,.01,f),new L(a,.01,f)];n.add(new Fn(new xt().setFromPoints(h),c))}const p=new wt({color:6334719});for(const[f,h,g,x]of[[0,-s+.1,$n,.1],[0,s-.1,$n,.1],[-a+.1,0,.1,Yn],[a-.1,0,.1,Yn]]){const m=new C(new oe(g,.06,x),p);m.position.set(f,r-.05,h),n.add(m)}}function Kg(n){const e=new ae({color:2635848,roughness:.7}),t=new ae({color:1581104,roughness:.8}),i=[new ae({color:1705216,transparent:!0,opacity:.9}),new ae({color:5908480,transparent:!0,opacity:.8}),new ae({color:8435776,transparent:!0,opacity:.7})],a=new ae({color:8965375,transparent:!0,opacity:.3,roughness:.05,metalness:.05});[[-14,6],[0,6],[14,6]].forEach(([r,o],l)=>{const d=new C(new oe(7,.12,3),e);d.position.set(r,3.1,o),d.castShadow=!0,d.receiveShadow=!0,n.add(d);for(const[g,x]of[[-3,-1.2],[3,-1.2],[-3,1.2],[3,1.2]]){const m=new C(new oe(.12,3.1,.12),t);m.position.set(r+g,1.55,o+x),n.add(m)}for(let g=0;g<3;g++){const x=new C(new ge(.3,.28,.8,12),a);x.position.set(r-1.8+g*1.8,3.56,o-.5),n.add(x);const m=.3+g*.1,u=new C(new ge(.27,.25,m,12),i[g]);u.position.set(r-1.8+g*1.8,3.17+m/2,o-.5),n.add(u)}const c=new ae({color:2113642,roughness:.9}),p=new C(new oe(1.2,.04,.9),c);p.position.set(r+2.5,3.18,o+.5),n.add(p);const f=new ae({color:4243616,roughness:.5,metalness:.3}),h=new C(new ge(.05,.05,1,8),f);h.position.set(r-2.8,3.75,o),h.rotation.z=.3,n.add(h)})}function Jg(n){const e=new ae({color:1579552,roughness:.5,metalness:.5}),t=new ae({color:2107440,roughness:.5,metalness:.6}),i=new ae({color:4227264,roughness:.1,metalness:.8}),a=new ae({color:2113696,roughness:.1,metalness:.9}),s=wn.x,r=wn.z,o=new C(new oe(3.5,.5,3),e);o.position.set(s,.25,r),o.castShadow=!0,n.add(o);const l=new C(new oe(.4,4,.4),t);l.position.set(s-.8,2.25,r),l.castShadow=!0,n.add(l);const d=new C(new oe(1.8,.35,.35),t);d.position.set(s+.1,4.1,r),n.add(d);const c=new C(new ge(.3,.35,1.2,16),i);c.position.set(s+.8,3.4,r),n.add(c);const p=new C(new ge(.1,.2,.5,12),i);p.position.set(s+.8,2.55,r),n.add(p);const f=new C(new ge(.18,.22,.6,12),a);f.position.set(s+.8,4.85,r),n.add(f);const h=new C(new oe(1.2,.06,1),e);h.position.set(s+.8,2.3,r),n.add(h);const g=new wt({color:16763968,transparent:!0,opacity:.7}),x=new C(new cn(.25,16),g);x.rotation.x=-Math.PI/2,x.position.set(s+.8,2.34,r),n.add(x)}function Zg(n){const e=new ae({color:794688,roughness:.9}),t=new wt({color:54527}),i=[new wt({color:16728128}),new wt({color:4259712})],a=new C(new oe(18,5.5,.1),e);a.position.set(0,4.5,-20+.12),n.add(a);const s=new C(new oe(17.6,.35,.08),t);s.position.set(0,6.95,-20+.17),n.add(s);for(let r=0;r<2;r++){const o=new C(new oe(15,.25,.06),i[r]);o.position.set(0,6-r*1.2,-20+.17),n.add(o);const l=r===0?[8,6.4,.4]:[.6,.5,.1];for(let d=0;d<3;d++){const c=new C(new oe(l[d],.55,.06),i[r]);c.position.set(-7.5+l[d]/2+d*5.2,5-r*1.2,-20+.17),n.add(c)}}}function Qg(n){const e=$n/2,t=Yn/2,i=new ae({color:2636344,roughness:.85});for(const s of[-12,0,12]){const r=new C(new oe(1.8,5,2),i);r.position.set(e-1,2.5,s),r.castShadow=!0,n.add(r)}const a=new ae({color:3817520,roughness:.9});for(const s of[-8,8]){const r=new C(new ge(.4,.35,.9,10),a);r.position.set(s,.45,t-2),n.add(r)}}function ex(n){const e=new wt({color:16763904,transparent:!0,opacity:.65,side:At}),t=new C(new xn(1,.2,10,32),e);t.position.set(wn.x+.8,5.8,wn.z),t.rotation.x=Math.PI/2,n.add(t);const i=new ai({color:3066993}),a=new Ai(i);return a.scale.set(1.5,1.5,1.5),a.position.set(wn.x+.8,7,wn.z),a.visible=!1,n.add(a),{idx:0,pos:{x:wn.x+.8,z:wn.z},done:!1,glowMat:e,glowMesh:t,doneSprite:a,isScope:!0}}function tx(n,e){!n||n.done||(n.glowMat.opacity=.4+.28*Math.sin(e*3.8),n.glowMesh.rotation.z=e*1.3)}const nx=.65;function Ie(n,e,t,i){return{minX:n-t,maxX:n+t,minZ:e-i,maxZ:e+i}}const vs=60,zr=40,Fr=70,Br=50,ix=[Ie(0,-20,vs/2+2,1.5),Ie(0,zr/2,vs/2+2,1.5),Ie(-30,0,1.5,zr/2+2),Ie(vs/2,0,1.5,zr/2+2),Ie(-16,5,3.6,1.8),Ie(0,-6,3.6,1.8),Ie(16,5,3.6,1.8),Ie(-28,0,2,11.5),Ie(vs/2-2,0,2,11.5),Ie(-20,-18.4,3.5,1.6)],ax=[Ie(0,-25,Fr/2+2,1.5),Ie(0,Br/2,Fr/2+2,1.5),Ie(-35,0,1.5,Br/2+2),Ie(Fr/2,0,1.5,Br/2+2),Ie(-18,6,2.8,2.8),Ie(0,-12,2,2.5),Ie(18,6,2.5,2.5),Ie(-26,-12,4,6),Ie(28,-13,3,6)],Hr=60,Gr=50,sx=[Ie(0,-25,Hr/2+2,1.5),Ie(0,Gr/2,Hr/2+2,1.5),Ie(-30,0,1.5,Gr/2+2),Ie(Hr/2,0,1.5,Gr/2+2),Ie(0,-8,11.6,.8),Ie(0,8,11.6,.8),Ie(-11,0,.8,8.6),Ie(11,0,.8,8.6),Ie(0,-10,.8,.8)];let sa=ix;function rx(){sa=ax}function ox(){sa=sx}const ya=56,Vr=44,lx=[Ie(0,-22,ya/2+2,1.5),Ie(0,Vr/2,ya/2+2,1.5),Ie(-28,0,1.5,Vr/2+2),Ie(ya/2,0,1.5,Vr/2+2),Ie(-16,2,4.5,2),Ie(0,2,4.5,2),Ie(16,2,4.5,2),Ie(0,-14,1.4,1.4),Ie(-18,-21.5,4.5,.8),Ie(0,-21.5,4.5,.8),Ie(18,-21.5,4.5,.8),Ie(ya/2-1.5,-10,1.5,1.5),Ie(ya/2-1.5,10,1.5,1.5)],Yi=52,Wr=40,cx=[Ie(0,-20,Yi/2+2,1.5),Ie(0,Wr/2,Yi/2+2,1.5),Ie(-26,0,1.5,Wr/2+2),Ie(Yi/2,0,1.5,Wr/2+2),Ie(-14,6,4,2),Ie(0,6,4,2),Ie(14,6,4,2),Ie(.8,-12,1.8,1.8),Ie(Yi/2-1,-12,1.5,1.5),Ie(Yi/2-1,0,1.5,1.5),Ie(Yi/2-1,12,1.5,1.5)];function dx(){sa=lx}function ux(){sa=cx}function px(n,e,t){const i=nx;let a=n.x+e;for(const r of sa)a+i>r.minX&&a-i<r.maxX&&n.z+i>r.minZ&&n.z-i<r.maxZ&&(e>0?a=r.minX-i:a=r.maxX+i,e=a-n.x);let s=n.z+t;for(const r of sa)a+i>r.minX&&a-i<r.maxX&&s+i>r.minZ&&s-i<r.maxZ&&(t>0?s=r.minZ-i:s=r.maxZ+i,t=s-n.z);return{dx:e,dz:t}}const Q={playerName:"",currentLevel:1,totalPoints:0,levelAttempts:0,levelPoints:0,phenomenonIndex:0,answered:!1,wrongAnswers:0,levelBreakdown:[],pointsAtLevelStart:0,stage3:{valveOpened:!1},stage4:{selectedItems:[],reactorResult:null,terminalDone:!1},stage5:{scopeDone:!1},completedRooms:[]};function hx(){Q.levelAttempts=0,Q.levelPoints=0,Q.phenomenonIndex=0,Q.answered=!1,Q.wrongAnswers=0}const fx={1:"Level 1 – Lab Sains",2:"Level 2 – Pabrik Etanol",3:"Level 3 – Kolam Remediasi",4:"Level 4 – Membuat Reaktor Sederhana",5:"Level 5 – Lab Observasi"};function yd(n){const e=Q.totalPoints-Q.pointsAtLevelStart;Q.levelBreakdown.push({level:n,label:fx[n]||`Level ${n}`,points:e})}class mx{constructor(e){this.scene=e,this.group=new jt,this._build(),e.add(this.group),this.group.position.set(0,0,12),this.speed=.12,this.keys={},this._moving=!1,this._walkCycle=0,this._legAngle=0,this._armAngle=0,this._facingAngle=0,this._bindKeys(),this._bindTouch()}_bindKeys(){window.addEventListener("keydown",e=>{this.keys[e.code]=!0}),window.addEventListener("keyup",e=>{this.keys[e.code]=!1})}_bindTouch(){if(this._touchAxis={x:0,y:0},!(/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1))return;const t=document.getElementById("mobile-controls");t&&(t.style.display="block");const i=document.getElementById("joystick-base"),a=document.getElementById("joystick-knob");if(!i||!a)return;const s=32;let r=null,o=null,l=0,d=0;const c=h=>{if(r!==null)return;r=h.changedTouches[0].identifier,o=i.getBoundingClientRect(),l=o.left+o.width/2,d=o.top+o.height/2,h.preventDefault()},p=h=>{for(const g of h.changedTouches){if(g.identifier!==r)continue;const x=g.clientX-l,m=g.clientY-d,u=Math.sqrt(x*x+m*m),v=Math.min(u,s),b=Math.atan2(m,x),_=Math.cos(b)*v,k=Math.sin(b)*v;a.style.transform=`translate(calc(-50% + ${_}px), calc(-50% + ${k}px))`,this._touchAxis.x=_/s,this._touchAxis.y=-k/s,h.preventDefault()}},f=h=>{for(const g of h.changedTouches)g.identifier===r&&(r=null,a.style.transform="translate(-50%, -50%)",this._touchAxis.x=0,this._touchAxis.y=0)};i.addEventListener("touchstart",c,{passive:!1}),window.addEventListener("touchmove",p,{passive:!1}),window.addEventListener("touchend",f,{passive:!1}),window.addEventListener("touchcancel",f,{passive:!1})}_build(){const e=new ae({color:16108455,roughness:.7,metalness:0}),t=new ae({color:2719929,roughness:.6,metalness:.05}),i=new ae({color:2899536,roughness:.65,metalness:.05}),a=new ae({color:2890254,roughness:.8,metalness:0}),s=new ae({color:1710618,roughness:.6,metalness:.1}),r=new ae({color:16448250,roughness:.7,metalness:0}),o=new C(new ge(.48,.52,1.6,16),t);o.position.y=2.2,o.castShadow=!0,this.group.add(o),this._torso=o;const l=new C(new ge(.5,.54,1.58,16),r);l.position.y=2.2,this.group.add(l),this._coat=l;for(const g of[-1,1]){const x=new C(new at(.28,12,10),r);x.position.set(g*.62,2.9,0),this.group.add(x)}const d=new C(new at(.52,20,16),e);d.position.y=3.62,d.scale.set(1,1.05,1),d.castShadow=!0,this.group.add(d),this._head=d;const c=new C(new at(.54,16,10,0,Math.PI*2,0,Math.PI*.55),a);c.position.y=3.85,this.group.add(c);for(const g of[-1,1]){const x=new C(new at(.1,8,8),e);x.position.set(g*.53,3.65,0),this.group.add(x)}const p=new ae({color:1710618});for(const g of[-1,1]){const x=new C(new at(.07,8,8),p);x.position.set(g*.2,3.72,.47),this.group.add(x)}const f=new ae({color:13936778}),h=new C(new at(.05,8,8),f);h.position.set(0,3.58,.52),this.group.add(h),this._legs=[];for(const[g,x]of[[-1,-1],[1,1]]){const m=new jt;m.position.set(x*.3,1.55,0);const u=new C(new ge(.2,.18,.72,12),i);u.position.y=-.36,u.castShadow=!0,m.add(u);const v=new jt;v.position.y=-.72,m.add(v);const b=new C(new ge(.16,.14,.64,12),i);b.position.y=-.32,b.castShadow=!0,v.add(b);const _=new C(new Eo(.13,.3,6,10),s);_.rotation.x=Math.PI/2,_.position.set(0,-.68,.12),v.add(_),this.group.add(m),this._legs.push({pivot:m,kneePivot:v,side:x,i:g===-1?0:1})}this._arms=[];for(const[g,x]of[[-1,-1],[1,1]]){const m=new jt;m.position.set(x*.76,2.92,0);const u=new C(new ge(.16,.14,.62,12),r);u.position.y=-.31,u.castShadow=!0,m.add(u);const v=new jt;v.position.y=-.62,m.add(v);const b=new C(new ge(.13,.12,.56,12),e);b.position.y=-.28,v.add(b);const _=new C(new at(.13,10,8),e);_.position.y=-.6,v.add(_),this.group.add(m),this._arms.push({pivot:m,elbowPivot:v,side:x,i:g===-1?0:1})}this._nameLabel=null}setName(e){if(this._nameLabel&&this.group.remove(this._nameLabel),!e)return;const t=document.createElement("canvas");t.width=256,t.height=64;const i=t.getContext("2d");i.clearRect(0,0,256,64),i.fillStyle="rgba(15,25,40,0.8)",i.roundRect(4,4,248,56,12),i.fill(),i.fillStyle="#2ecc71",i.font="bold 26px Segoe UI, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(e,128,32);const a=new Fs(t),s=new ai({map:a,transparent:!0}),r=new Ai(s);r.scale.set(3.5,.9,1),r.position.y=5.2,this._nameLabel=r,this.group.add(r)}update(e,t=!1,i=null){const a=this.keys;let s=0,r=0;if((a.KeyW||a.ArrowUp)&&(s+=1),(a.KeyS||a.ArrowDown)&&(s-=1),(a.KeyA||a.ArrowLeft)&&(r-=1),(a.KeyD||a.ArrowRight)&&(r+=1),this._touchAxis&&(s+=this._touchAxis.y,r+=this._touchAxis.x,s=Math.max(-1,Math.min(1,s)),r=Math.max(-1,Math.min(1,r))),this._moving=s!==0||r!==0,this._moving&&!t){let o=0,l=0;const d=s<0;if(d&&i){o=i.fwd.x*s+i.right.x*r,l=i.fwd.z*s+i.right.z*r;const h=Math.sqrt(o*o+l*l)||1;o=o/h*this.speed,l=l/h*this.speed}else if(d)o=-Math.sin(this._facingAngle)*this.speed,l=-Math.cos(this._facingAngle)*this.speed;else if(i){o=i.fwd.x*s+i.right.x*r,l=i.fwd.z*s+i.right.z*r;const h=Math.sqrt(o*o+l*l)||1;o=o/h*this.speed,l=l/h*this.speed}else{o=r,l=-s;const h=Math.sqrt(o*o+l*l)||1;o=o/h*this.speed,l=l/h*this.speed}({dx:o,dz:l}=px(this.group.position,o,l)),this.group.position.x+=o,this.group.position.z+=l;const c=Q.currentLevel===2?33:Q.currentLevel===3?27:28,p=Q.currentLevel===2?23:Q.currentLevel===3?22:18;this.group.position.x=Math.max(-c,Math.min(c,this.group.position.x)),this.group.position.z=Math.max(-p,Math.min(p,this.group.position.z)),d||(this._facingAngle=Math.atan2(o,l)),this.group.rotation.y=this._facingAngle,this._walkCycle+=.18;const f=this._walkCycle;for(const{pivot:h,kneePivot:g,i:x}of this._legs){const m=f+x*Math.PI,u=Math.sin(m)*.55;h.rotation.x=u;const v=Math.max(0,-Math.sin(m)*.45);g.rotation.x=v}for(const{pivot:h,elbowPivot:g,side:x,i:m}of this._arms){const u=f+(1-m)*Math.PI,v=Math.sin(u)*.42;h.rotation.x=v,h.rotation.z=x*(.08+Math.sin(u+Math.PI*.5)*.06),g.rotation.x=Math.max(0,Math.sin(u+.4)*.28)}this._torso&&(this._torso.rotation.y=Math.sin(f+Math.PI)*.08),this._coat&&(this._coat.rotation.y=Math.sin(f+Math.PI)*.08),this._head&&(this._head.position.y=3.62+Math.abs(Math.sin(f*2))*.06),this.group.position.y=Math.abs(Math.sin(f*2))*.055}else{this._walkCycle=0;for(const{pivot:o,kneePivot:l}of this._legs)o.rotation.x*=.75,l.rotation.x*=.75;for(const{pivot:o,elbowPivot:l,side:d}of this._arms)o.rotation.x*=.75,o.rotation.z+=(d*.08-o.rotation.z)*.15,l.rotation.x*=.75;this._torso&&(this._torso.rotation.y*=.8),this._coat&&(this._coat.rotation.y*=.8),this._head&&(this._head.position.y=3.62+Math.sin(e*1.2)*.02),this.group.position.y=Math.sin(e*1.4)*.04}return{x:this.group.position.x,z:this.group.position.z}}get position(){return this.group.position}removeFromScene(e){e.remove(this.group)}addToScene(e){this.scene=e,e.add(this.group)}}const gx=[{id:1,title:"Fenomena 1",image:null,tableData:{headers:["Stasiun","Suhu (°C)","pH","DO (mg/L)","COD (mg/L)","TDS (mg/L)"],rows:[{label:"Hulu",values:["30,39","7,26","8,38","635","777"],classes:["","","blue","",""]},{label:"Tengah",values:["31,17","6,96","1,90","775","1.343"],classes:["","","red","","red"]},{label:"Hilir",values:["29,63","7,36","11,12","879","1.300"],classes:["","","","red",""]}],note:"Biru: rata-rata terendah | Merah: rata-rata tertinggi. Sumber: Zahra, 2023"},context:"Seorang peneliti lingkungan mengamati data kualitas air sungai di stasiun berbeda, yaitu: hulu, tengah, dan hilir dari aliran anak Sungai Bengawan solo yang berdekatan dengan pabrik etanol. Data menunjukkan:",question:"Berdasarkan data, Stasiun Tengah menunjukkan nilai TDS melonjak drastis menjadi 1.343 mg/L, namun nilai DO justru berada di angka 1,90 mg/L dengan COD 90.000 mg/L. Jika diketahui sumber pencemar adalah limbah vinasse yang kaya bahan organik, manakah evaluasi paling kritis mengenai data tersebut?",options:[{label:"A",text:"Tingginya TDS disebabkan oleh mineral anorganik, sedangkan seluruh bakteri telah terurai oleh bakteri dari hulu ke tengah.",correct:!1},{label:"B",text:"Masuknya limbah vinasse seharusnya meningkatkan TDS, DO, dan COD secara simultan.",correct:!0},{label:"C",text:"TDS, COD, dan DO memiliki hubungan yang terbalik, semakin banyak zat terlarut, semakin sedikit oksigen yang dibutuhkan.",correct:!1}],correctKey:"B",explanation:"✅ <strong>Jawaban benar!</strong><br>Limbah organik vinasse seharusnya berkontribusi pada TDS dan COD. Jika TDS dan COD naik tajam karena limbah masuk, DO seharusnya tidak turun drastis."},{id:2,title:"Fenomena 2",image:null,tableData:null,standardTable:{title:"Baku Mutu Air Limbah Industri Bir/Etanol (Permen LH No.5/2014)",headers:["Parameter","Kadar Maks (mg/L)","Beban Maks (g/hL)"],rows:[["BOD₅","40","24,0"],["COD","100","60,0"],["TSS","40","24,0"],["pH","6,0 – 9,0","—"],["Debit limbah maks","—","6 hL/hL produk"]]},context:"Berdasarkan data Stasiun Tengah nilai TDS 1.343 mg/L, COD 90.000 mg/L dan DO 1,90 mg/L, komponen apakah yang paling dominan menyusun nilai TDS tersebut?",question:"Berdasarkan data Stasiun Tengah nilai TDS 1.343 mg/L, COD 90.000 mg/L dan DO 1,90 mg/L, komponen apakah yang paling dominan menyusun nilai TDS tersebut?",options:[{label:"A",text:"Adanya bakteri coliform dan mikroorganisme pengurai.",correct:!1},{label:"B",text:"Ion anorganik seperti K, Ca dan Cl yang tidak dapat dioksidasi.",correct:!0},{label:"C",text:"Suspensi padatan lumpur yang belum mengendap.",correct:!1}],correctKey:"B",explanation:"✅ <strong>Jawaban benar!</strong><br>Ion anorganik seperti K, Ca dan Cl yang tidak dapat dioksidasi mendominasi nilai TDS di Stasiun Tengah."},{id:3,title:"Fenomena 3",image:null,riceGraph:!0,tableData:null,context:"Perhatikan grafik produktivitas lahan persawahan padi berikut:",question:"Manakah interpretasi ilmiah yang paling tepat menjelaskan mekanisme penyebab fenomena penurunan hasil panen padi tersebut?",options:[{label:"A",text:"Kenaikan hasil panen di Tahun ke-2 terjadi karena suplai bahan organik berada di bawah ambang batas pencemaran sehingga justru memperkaya hara tanah, namun pada Tahun ke-3 akumulasi pH dan COD telah menyebabkan kerusakan pada jaringan akar padi.",correct:!0},{label:"B",text:"Penurunan hasil panen pada Tahun ke-3 disebabkan oleh kurangnya pasokan air, karena tingginya nilai COD menyebabkan air menjadi kental dan sulit diserap oleh akar tanaman.",correct:!1},{label:"C",text:"Peningkatan hasil panen pada Tahun ke-2 disebabkan oleh bakteri patogen dalam limbah yang memicu mutasi genetik pada padi menjadi varietas unggul, sedangkan penurunan di Tahun ke-3 adalah fase kematian alami bakteri tersebut.",correct:!1}],correctKey:"A",explanation:"✅ <strong>Jawaban benar!</strong><br>Meskipun COD naik menjadi 80, pH tanah sebesar 8,6 masih dalam rentang toleransi padi. Bahan organik dalam limbah vinasse mengandung N, P, dan K. Pada tahap ini, efek negatif belum mendominasi, sehingga tanaman justru merespons positif terhadap tambahan nutrisi tersebut. Ketika COD mencapai >100 mg/L dan pH >9 kondisi tanah menjadi toksik. pH yang tinggi menyebabkan ion logam di tanah menjadi larut dan meracuni akar, serta menghambat penyerapan Fosfor. Hal ini menyebabkan tanaman gagal tumbuh."}],wa={phenomena:gx},xx=879,vx=635,bs=1e3;function bx(n){const e=Math.max(0,Math.min(bs,n)),t=bs-e,i=e/bs,a=Math.round(xx*i),s=Math.round(vx*i),r=Math.pow(10,-3.8),o=Math.pow(10,-7),l=(r*e+o*t)/bs,d=Math.max(3.5,Math.min(7,-Math.log10(l)));return{cod:a,bod:s,ph:parseFloat(d.toFixed(2)),dilutionFactor:i}}function _x(n,e){const t=Math.max(0,Math.min(72,e)),i=Math.round(n.bod*Math.exp(-.08*t)),a=n.bod-i,s=n.cod*.55,r=n.cod*.45,o=s*Math.exp(-.08*t),l=Math.round(o+r),d=parseFloat(Math.min(6.8,n.ph+(6.8-n.ph)*(1-Math.exp(-.08*.5*t))).toFixed(2)),c=n.bod>0?Math.round(a/n.bod*100):0,p=n.cod>0?Math.round((n.cod-l)/n.cod*100):0,f=i<=40&&l<=100;return{cod:l,bod:i,ph:d,bodRemovalPct:c,codRemovalPct:p,compliant:f}}const wd="biovine_scores",Lo="biovine_checkpoint";function yx({playerName:n,totalPoints:e,levelBreakdown:t,completedAt:i,essayAnswer:a}){const s=wx();s.push({playerName:n,totalPoints:e,levelBreakdown:t,completedAt:i,essayAnswer:a}),s.length>200&&s.splice(0,s.length-200);try{localStorage.setItem(wd,JSON.stringify(s))}catch(r){console.warn("[db] saveScore failed:",r)}}function wx(){try{return JSON.parse(localStorage.getItem(wd)||"[]")}catch{return[]}}function Mx({playerName:n,currentLevel:e,totalPoints:t,levelBreakdown:i,completedRooms:a}){const s={playerName:n,currentLevel:e,totalPoints:t,levelBreakdown:i||[],completedRooms:a||[],savedAt:new Date().toISOString()};try{localStorage.setItem(Lo,JSON.stringify(s))}catch(r){console.warn("[db] saveCheckpoint failed:",r)}}function ko(){try{const n=localStorage.getItem(Lo);return n?JSON.parse(n):null}catch{return null}}function Md(){localStorage.removeItem(Lo)}const Co="https://script.google.com/macros/s/AKfycbys_sNNVIFJCQGmvNHUMuiLpZGINttOvNN5LnIJ8z5Gak8h8KQ8BdTo342_K5H05RxbXw/exec";function Sx(n){const{playerName:e,totalPoints:t,levelBreakdown:i,completedRooms:a}=Q,s={1:null,2:null,3:null,4:null,5:null};i.forEach(l=>{s[l.level]=l.points});const r=s[n]??0,o={playerName:e,totalPoints:t,completedLevel:n,thisLevelPoints:r,level1Points:s[1],level2Points:s[2],level3Points:s[3],level4Points:s[4],level5Points:s[5],completedRooms:a,timestamp:new Date().toISOString()};fetch(Co,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(o)}).catch(l=>{console.warn("[sheets] Upload failed (network error):",l)})}function Ex(n){const e={sheet:"Kelompok",...n};return fetch(Co,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(e)}).catch(t=>{throw console.warn("[sheets] Experiment upload failed (network error):",t),t})}function Tx(n){const e={sheet:"Esai",playerName:n.playerName||"",essayAnswer:n.essayAnswer||"",timestamp:n.timestamp||new Date().toISOString()};fetch(Co,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify(e)}).catch(t=>{console.warn("[sheets] Essay upload failed (network error):",t)})}const hn=n=>document.getElementById(n),Ro="experiment-form-overlay",bc="experiment-form-css";function Ax(){if(document.getElementById(bc))return;const n=document.createElement("style");n.id=bc,n.textContent=`
    #${Ro} {
  ...
  `,document.head.appendChild(n)}function Lx(){const n=document.createElement("div");return n.id=Ro,n}function Xr(){var n;(n=document.getElementById(Ro))==null||n.remove()}function _s(n){return["warna","bau","keruh","ph","sal","tds","cod","bod","do"].map(t=>`<td><input type="text" class="exp-cell" id="${n}-${t}" /></td>`).join("")}function Po(){Ax(),Xr();const n=Lx();n.innerHTML=`
    <div class="exp-card">
  ...
  `,document.body.appendChild(n),hn("exp-close").onclick=Xr,n.addEventListener("click",t=>{t.target===n&&Xr()}),hn("exp-submit").onclick=()=>{const t=hn("exp-kelompok").value.trim(),i=hn("exp-kelas").value.trim();if(!t||!i){e("⚠️ Nomor Kelompok dan Kelas wajib diisi!",!1);return}const a=["warna","bau","keruh","ph","sal","tds","cod","bod","do"];function s(l){return Object.fromEntries(a.map(d=>{var c;return[d,((c=hn(`${l}-${d}`))==null?void 0:c.value.trim())||"–"]}))}const r={nomorKelompok:t,kelas:i,namaAnggota:hn("exp-nama").value.trim()||"–",playerName:Q.playerName||"–",timestamp:new Date().toISOString(),mikroorganisme:hn("t1-mikro").value.trim()||"–",intensitasCahaya:hn("t1-cahaya").value.trim()||"–",suhuRuang:hn("t1-suhu").value.trim()||"–",awalDengan:s("awal-dg"),awalTanpa:s("awal-tp"),akhirDengan:s("akhir-dg"),akhirTanpa:s("akhir-tp")},o=hn("exp-submit");o.disabled=!0,o.textContent="⏳ Mengirim…",Ex(r).then(()=>{e("✅ Berhasil! Data percobaan kelompokmu telah dikirimkan.",!0),o.textContent="✅ Terkirim"}).catch(()=>{e("❌ Gagal mengirim. Periksa koneksi internet dan coba lagi.",!1),o.disabled=!1,o.textContent="📤 Kirim Ulang"})};function e(t,i){const a=hn("exp-status");a.className="exp-status "+(i?"ok":"err"),a.innerHTML=t,a.scrollIntoView({behavior:"smooth",block:"nearest"})}}const be=n=>document.getElementById(n);let lo=null,qr=null;function kx(n,e){lo=n,qr=e||null;const t=ko(),i=be("resume-section");if(t&&i&&qr){const a=new Date(t.savedAt),s=a.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})+" "+a.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"});i.classList.remove("hidden"),i.innerHTML=`
    ...
    `,document.getElementById("btn-resume-game").onclick=()=>{Sd(),qr(t)},document.getElementById("btn-discard-checkpoint").onclick=()=>{Md(),i.classList.add("hidden")}}else i&&i.classList.add("hidden");be("profile-screen").classList.remove("hidden")}function Sd(){be("profile-screen").classList.add("hidden")}function Cx(n){const e=be("synopsis-screen");e.classList.remove("hidden");const t=[{tag:"Bagian 1 dari 3",title:"Industri Etanol di Desa Bekonang",text:"Industri etanol di Desa Bekonang, Sukoharjo, adalah warisan <strong>turun-temurun</strong> yang sudah ada sejak zaman kolonial. Banyak pabrik di sini memproduksi minuman keras tradisional bernama <strong>ciu</strong> dibuat dari tetes tebu, tape singkong, atau nira aren melalui proses fermentasi dan penyulingan.<br><br>Seiring waktu, industri ini berkembang menjadi produksi <strong>etanol medis</strong> yang digunakan untuk kebutuhan rumah sakit dan dunia kesehatan."},{tag:"Bagian 2 dari 3",title:"Masalah: Limbah Vinasse",text:"Proses produksi etanol menghasilkan limbah cair bernama <strong>vinasse</strong>. Setiap harinya, satu pabrik bisa menghasilkan <strong>150–200 liter</strong> limbah ini tanpa sistem pengolahan yang memadai.<br><br>Vinasse berwarna <strong>hitam pekat</strong>, berbau menyengat, dan sangat berbahaya jika dibuang langsung ke sungai. Vinasse <strong>menyerap oksigen</strong> di dalam air, menyebabkan ikan-ikan mati dan sungai tercemar parah."},{tag:"Bagian 3 dari 3",title:"Solusi: Vinasse → Pupuk Organik Cair",text:"Kabar baiknya, limbah vinasse bisa diolah menjadi <strong>Pupuk Organik Cair (POC)</strong>! Caranya dengan menambahkan <strong>mikroorganisme berupa ragi</strong> ke dalam vinasse yang sudah diaerasi minimal 24 jam.<br><br>Setelah ditumbuhkan selama <strong>15 hari</strong> dalam bak terbuka beraeasi, limbah berubah menjadi pupuk: tidak berbau asam, berwarna coklat muda. Diaplikasikan ke tanaman dengan perbandingan <strong>1 : 10</strong> (POC : air). Ukur kadar COD, BOD, dan pH untuk memastikan kualitasnya!"}];let i=0,a=!1,s=null;const r=be("syn-seg-tag"),o=be("syn-seg-title"),l=be("syn-seg-text"),d=be("syn-dots"),c=be("btn-syn-prev"),p=be("btn-syn-next"),f=be("btn-syn-skip"),h=be("synopsis-content-panel"),g=be("syn-mouth");function x(){m(),s=setInterval(()=>{a=!a,g&&g.setAttribute("d",a?"M84 124 Q100 144 116 124":"M84 126 Q100 138 116 126")},280)}function m(){s&&(clearInterval(s),s=null),g&&g.setAttribute("d","M84 126 Q100 138 116 126")}function u(){m(),e.classList.add("hidden"),n()}function v(b){const _=t[b];h.classList.remove("synopsis-slide"),h.offsetWidth,h.classList.add("synopsis-slide"),r.textContent=_.tag,o.textContent=_.title,l.innerHTML=_.text,d.innerHTML=t.map((k,M)=>`<span class="synopsis-dot ${M===b?"active":""}"></span>`).join(""),c.style.display=b===0?"none":"",p.textContent=b===t.length-1?"🚀 Mulai Petualangan →":"Lanjutkan →",x()}v(0),c.onclick=()=>{i>0&&v(--i)},p.onclick=()=>{i<t.length-1?v(++i):u()},f.onclick=()=>u()}const ys=[{id:"c4gsn1rkK1g",title:"Video Edukasi: Limbah Vinasse & Dampak Lingkungan",subtitle:"Pelajari dampak pencemaran vinasse terhadap lingkungan sekitar"}];let Ed=!1;const Td=[];window.onYouTubeIframeAPIReady=()=>{Ed=!0,Td.splice(0).forEach(n=>n())};function Rx(){return new Promise(n=>{if(Ed){n();return}if(Td.push(n),!document.getElementById("yt-api-script")){const e=document.createElement("script");e.id="yt-api-script",e.src="https://www.youtube.com/iframe_api",document.head.appendChild(e)}})}function Px(n){const e=be("youtube-screen");e.classList.remove("hidden");let t=0,i=null;function a(){const r=e.querySelector(".youtube-frame-wrap");r.innerHTML='<div id="yt-player-container"><div class="yt-loading">Memuat video…</div></div>'}function s(r){const o=ys[r];be("yt-title").textContent=o.title,be("yt-subtitle").textContent=o.subtitle,be("yt-counter").textContent=`${r+1} / ${ys.length}`;const l=be("btn-yt-next");l.textContent=r<ys.length-1?"Video Berikutnya →":"Lanjutkan ke Simulasi →",l.disabled=!1,l.title="",i&&(i.destroy(),i=null),a(),Rx().then(()=>{i=new YT.Player("yt-player-container",{videoId:o.id,playerVars:{rel:0,modestbranding:1,playsinline:1},events:{}})})}s(0),be("btn-yt-next").onclick=()=>{t+=1,t<ys.length?s(t):(i&&(i.destroy(),i=null),e.classList.add("hidden"),n())}}function Dx(n){const e=be("intro-video-screen");e.classList.remove("hidden"),qx(),$x();const t=be("intro-3d-canvas"),i=window.innerWidth,a=window.innerHeight,s=new yo({canvas:t,antialias:!0});s.setPixelRatio(Math.min(window.devicePixelRatio,2)),s.setSize(i,a,!1),s.shadowMap.enabled=!0,s.shadowMap.type=fo;const r=new da;r.background=new Ve(8900331),r.fog=new Ha(12114160,90,210);const o=new Kt(50,i/a,.1,300);o.position.set(0,65,75),o.lookAt(0,0,0),r.add(new fd(10409208,5929536,1.2));const l=new Mn(16775136,2.8);l.position.set(40,80,50),l.castShadow=!0,l.shadow.mapSize.setScalar(2048),l.shadow.camera.left=l.shadow.camera.bottom=-90,l.shadow.camera.right=l.shadow.camera.top=90,l.shadow.camera.far=220,r.add(l);const d=new Mn(11587839,.45);d.position.set(-30,25,-20),r.add(d),r.add(new C(new at(190,16,8),new wt({color:6991584,side:Ht})));function c(D,ie=.78,_e=0,Ae,Te){const ee={color:D,roughness:ie,metalness:_e};return Ae!==void 0&&(ee.emissive=Ae,ee.emissiveIntensity=Te||.2),new ae(ee)}function p(D,ie,_e,Ae,Te,ee,R){const de=new C(new oe(Ae,Te,ee),R);return de.position.set(D,ie+Te*.5,_e),de.castShadow=!0,de.receiveShadow=!0,r.add(de),de}function f(D,ie,_e,Ae,Te,ee,R,de){const he=new C(new ge(Ae,Te,ee,R),de);return he.position.set(D,ie+ee*.5,_e),he.castShadow=!0,he.receiveShadow=!0,r.add(he),he}function h(D,ie,_e,Ae,Te,ee=.84){const R=new C(new _t(_e,Ae),new ae({color:Te,transparent:!0,opacity:ee,roughness:.04,metalness:.18}));return R.rotation.x=-Math.PI/2,R.position.set(D,.22,ie),r.add(R),R}function g(D,ie,_e,Ae,Te,ee,R=5596791,de=.24){const he=new L(D,ie,_e),j=new L(Ae,Te,ee),pe=j.clone().sub(he),nt=pe.length();if(nt<.05)return;const it=new C(new ge(de,de,nt,8),c(R,.45,.65));it.position.copy(he.clone().add(j).multiplyScalar(.5)),it.quaternion.setFromUnitVectors(new L(0,1,0),pe.normalize()),r.add(it)}const x=new C(new _t(260,260),c(8033368,.95));x.rotation.x=-Math.PI/2,x.receiveShadow=!0,r.add(x),p(6,-.05,1,82,.1,68,c(11708816,.88));const m=7,u=13,v=5,b=7,_=1.4,k=.36,M=D=>-21+D*b,E=[8008464,6965782,4872744,2977352,2127994,1608346,960716],I=[],y=[];for(let D=0;D<m;D++){const ie=M(D),_e=E[D],Ae=c(8028272,.78);p(0,0,ie-v/2,u*2+k*2,_,k,Ae),p(0,0,ie+v/2,u*2+k*2,_,k,Ae),p(-u,0,ie,k,_,v,Ae),p(u,0,ie,k,_,v,Ae),p(0,-.25,ie,u*2,.28,v,c(10524800,.88));const Te=.76+D*.015,ee=h(0,ie,u*2-.1,v-.12,_e,Te);if(I.push({mesh:ee,baseOp:Te}),D===3||D===4)for(let R=-1;R<=1;R++){const de=f(R*7,.25,ie,.75,.75,.28,12,c(11189196,.4,.55,3381708,.3));y.push(de),p(R*7,.28,ie,.14,1,.14,c(8948121,.5,.5))}}const T=c(12761250,.88);for(let D=0;D<=m;D++){const ie=-21-b/2+D*b;p(6,0,ie,82,.12,2,T)}p(-20,0,1,2.2,.12,70,T),p(32,0,1,2.2,.12,70,T);for(let D=0;D<m-1;D++){const ie=D%2===0?u+.5:-13.5,_e=M(D),Ae=M(D+1);p(ie,0,(_e+Ae)*.5,2.2,_,Math.abs(Ae-_e)+.5,c(6977672,.65,.3))}p(-28,0,-30,12,5.5,8,c(5924984,.62,.1)),p(-28,5.5,-30,12.5,.55,8.5,c(3819608,.5));for(let D=-1.5;D<=1.5;D+=.65)p(-22.8,0,-30+D,.1,2.4,.1,c(3359829,.4,.7));p(-27,2,-33.7,1.8,1.2,.08,c(8969727,.08,0,13141,.9)),p(-29.5,2,-33.7,1.8,1.2,.08,c(8969727,.08,0,13141,.9));const N=-34,H=-30;f(N,0,H,1.1,.9,14,16,c(8952234,.38,.55)),f(N,14,H,1.2,1.2,.3,16,c(11189196,.35,.5)),[2,4.5,7.5,10.5,13].forEach(D=>{f(N,D,H,1.18,1.18,.18,16,c(10070715,.42,.6))}),g(N+1.1,1.2,H,-22,1.2,-30,4478310,.28),p(N-2.2,6,H,2.8,1.4,1.4,c(6977672,.55,.3)),g(N-1.1,6.5,H,N-1.8,6.5,H,5596791,.22);const se=-24,P=-14,z=12,X=9;p(se,0,P,z,1.5,X,c(7241328,.75)),p(se,0,P,z-k*2,.24,X-k*2,c(10129544,.88));const ne=h(se,P,z-.8,X-.8,5926976,.82);g(-22,.9,-28,-22,.9,-14,4478310,.3),g(-18.2,.9,-14,-13.2,.9,-21,4478310,.3),p(-28,0,8,8,4.5,6.5,c(6975600,.65,.1)),p(-28,4.5,8,8.5,.42,7,c(3817552,.5)),f(-25.5,4.9,6,.34,.34,4.5,10,c(8947864,.5,.3));for(let D=0;D<3;D++)g(-18.5,.8,-21+D*14,-21,.8,-21+D*14,4478310,.2);[-14,-6,2].forEach(D=>{p(-32+D*.3,0,32,6,.42,9.5,c(10522720,.93))});const $=30,K=18,J=10;f($,0,K,J+.55,J+.55,1.6,48,c(8030328,.7)),f($,0,K,J,J,1.6,48,c(8030328,.7)),f($,-.25,K,J,J,.28,48,c(10127472,.88));const V=new C(new cn(J-.08,48),new ae({color:3057848,transparent:!0,opacity:.86,roughness:.04,metalness:.2}));V.rotation.x=-Math.PI/2,V.position.set($,.22,K),r.add(V),f($,1.6,K,.58,.58,3.8,10,c(5925495,.5,.5)),p($,1.6,K,J*2-.3,.22,.38,c(8952234,.45,.4));const Z=new C(new Bn(4.5,2.8,32),c(5911312,.85));Z.rotation.x=Math.PI,Z.position.set($,.9,K),r.add(Z),g(u+.4,.9,M(6),$-J-.6,.9,K,4482696,.3),[[44,-10],[52,-10]].forEach(([D,ie])=>{p(D,0,ie,6.5,1.1,10,c(7899288,.7)),h(D,ie,6,9.5,6728396,.82)}),f(58,0,-5,.95,.95,3.4,14,c(14544639,.32,.28,8930559,.4)),g($+J+.5,.9,K,44,.9,-10,4482696,.28),g(48,.9,-10,52,.9,-10,4482696,.25),g(55.5,.9,-10,58,.9,-5,4482696,.25),p(58,0,16,.36,9,.36,c(10066602,.4,.6)),p(58,9,16,1.6,.9,1,c(13378082,.5,.3,16711680,.55));const O=new C(new at(.32,8,8),new ae({color:16720418,emissive:16711680,emissiveIntensity:2.5}));O.position.set(58,10.2,16),r.add(O);const te=[];for(let D=0;D<4;D++){const ie=new C(new at(.22,6,6),new ae({color:2293691,emissive:52360,emissiveIntensity:1.8,transparent:!0,opacity:.9}));ie.userData.i=D,r.add(ie),te.push(ie)}const Y=h(72,8,18,60,2263227,.78);g(58,.9,-5,66,.9,0,4482696,.3);const me=new ae({color:7027210,roughness:.95}),fe=[c(2981178,.9),c(3837764,.88),c(4888896,.85),c(2263098,.92),c(5474352,.87),c(1992226,.93)],Ce=[];for(let D=-58;D<=78;D+=6.5)Ce.push([D,-42]),Ce.push([D,44]);for(let D=-40;D<=42;D+=6.5)Ce.push([-58,D]),Ce.push([78,D]);[[-44,-22],[-46,-8],[-44,18],[-44,30],[56,-28],[58,-12],[56,10],[56,30],[-36,38],[-18,40],[2,40],[20,40],[38,40],[-36,-36],[-18,-38],[2,-38],[22,-38],[42,-36],[52,-36]].forEach(D=>Ce.push(D)),Ce.forEach(([D,ie])=>{const _e=.85+Math.random()*.75,Ae=new C(new ge(.18*_e,.3*_e,2.2*_e,7),me);Ae.position.set(D,1.1*_e,ie),Ae.castShadow=!0,r.add(Ae);const Te=fe[Math.floor(Math.random()*fe.length)];if(Math.random()>.42){const ee=new C(new at(1.5*_e,8,7),Te);ee.position.set(D,3.8*_e,ie),ee.castShadow=!0,r.add(ee)}else for(let ee=0;ee<3;ee++){const R=new C(new Bn((1.3-ee*.28)*_e,1.3*_e,8),Te);R.position.set(D,(2.5+ee*1.2)*_e,ie),R.castShadow=!0,r.add(R)}});const Ue=new cd([new L(-23,.7,-30),new L(-23,.7,-21),new L(se,.7,P),new L(-13,.7,-21),new L(0,.7,-21),new L(13,.7,-21),new L(14,.7,-17.5),new L(13,.7,-14),new L(0,.7,-14),new L(-13,.7,-14),new L(-14,.7,-10.5),new L(-13,.7,-7),new L(0,.7,-7),new L(13,.7,-7),new L(14,.7,-3.5),new L(13,.7,0),new L(0,.7,0),new L(-13,.7,0),new L(-14,.7,3.5),new L(-13,.7,7),new L(0,.7,7),new L(13,.7,7),new L(14,.7,10.5),new L(13,.7,14),new L(0,.7,14),new L(-13,.7,14),new L(-14,.7,17.5),new L(-13,.7,21),new L(0,.7,21),new L(13,.7,21),new L(22,.7,21),new L($,.7,K),new L(44,.7,-10),new L(58,.7,-5),new L(66,.7,0)]);function Ne(D,ie,_e){const Ae=D>>16&255,Te=D>>8&255,ee=D&255,R=ie>>16&255,de=ie>>8&255,he=ie&255;return Math.round(Ae+(R-Ae)*_e)<<16|Math.round(Te+(de-Te)*_e)<<8|Math.round(ee+(he-ee)*_e)}const et=90,F=[];for(let D=0;D<et;D++){const ie=D/et,_e=Ne(8005632,1091800,ie),Ae=D%3!==0,Te=Ae?new To(.1+D%6*.04,.28+D%5*.07,20):new cn(.16+D%7*.03,12),ee=new C(Te,new ae({color:_e,emissive:_e,emissiveIntensity:Ae?.65:.3,roughness:.04,metalness:.1,transparent:!0,opacity:Ae?.72:.52,side:At}));ee.rotation.x=-Math.PI/2,ee.userData.t=ie,ee.userData.ph=D*.618033%1,r.add(ee),F.push(ee)}const Rt=[],De=50,Be=[[-7,0],[0,0],[7,0],[-7,7],[0,7],[7,7]];for(let D=0;D<De;D++){const ie=Be[D%Be.length],_e=new C(new at(.07+Math.random()*.09,5,5),new ae({color:12118271,transparent:!0,opacity:.72}));_e.userData.phase=D/De*Math.PI*2,_e.userData.ox=ie[0]+(Math.random()-.5)*10,_e.userData.oz=ie[1]+(Math.random()-.5)*(v-1),r.add(_e),Rt.push(_e)}const Le=[],pt=28;for(let D=0;D<pt;D++){const ie=new C(new at(.14,5,5),new ae({color:7025425,transparent:!0,opacity:.78}));ie.userData.phase=D/pt,ie.userData.ang=Math.random()*Math.PI*2,ie.userData.r=1.5+Math.random()*(J-3),r.add(ie),Le.push(ie)}const Xe=[],A=36;for(let D=0;D<A;D++){const ie=new C(new at(.3+Math.random()*.22,7,7),new ae({color:15661311,emissive:11197934,emissiveIntensity:.18,transparent:!0,opacity:.55,roughness:.85}));ie.userData.life=D/A,ie.userData.ox=(Math.random()-.5)*1.2,ie.userData.oz=(Math.random()-.5)*1.2,r.add(ie),Xe.push(ie)}const w=[],B=22;for(let D=0;D<B;D++){const ie=new C(new at(.26,5,5),new ae({color:11184810,transparent:!0,opacity:.38}));ie.userData.life=D/B,ie.userData.ox=(Math.random()-.5)*.6,ie.userData.oz=(Math.random()-.5)*.6,r.add(ie),w.push(ie)}const ue=[],ce=12;for(let D=0;D<ce;D++){const ie=new C(new at(.13,5,5),new ae({color:14548872,transparent:!0,opacity:.88}));ie.userData.phase=D/ce,ie.userData.ox=(Math.random()-.5)*3.5,r.add(ie),ue.push(ie)}const re=[{tag:"Tahap 1 dari 5",title:"Penampungan Awal (Bak Ekualisasi)",subtitle:"Equalization Basin",waterQuality:5,camPos:[-40,32,-36],camLook:[-24,0,-24],desc:"Limbah vinasse yang pekat dari industri etanol dialirkan dan ditampung terlebih dahulu di bak penampungan awal IPAL Ciunik. Pada tahap ini, dilakukan penyamaan atau stabilisasi debit, suhu, dan tingkat keasaman (pH) limbah agar kondisinya ideal dan tidak merusak sistem pengolahan di tahap selanjutnya."},{tag:"Tahap 2 dari 5",title:"Proses Aerasi (Injeksi Oksigen)",subtitle:"Aeration Process",waterQuality:28,camPos:[-10,28,-10],camLook:[0,0,0],desc:"Setelah stabil, limbah dialirkan ke dalam bak aerasi. Di dalam bak ini, air limbah dipompa dan disuplai dengan gelembung udara (oksigen) secara terus-menerus menggunakan mesin aerator. Oksigen ini sangat krusial untuk menjaga agar kondisi air tetap kaya oksigen terlarut."},{tag:"Tahap 3 dari 5",title:"Penambahan Mikroorganisme (Bakteri Pengurai)",subtitle:"Biological Treatment",waterQuality:55,camPos:[8,32,16],camLook:[6,0,2],desc:"Bersamaan dengan suplai oksigen yang melimpah, ditambahkan mikroorganisme aerobik (bakteri pengurai) ke dalam bak aerasi. Mikroorganisme ini bekerja dengan cara menguraikan polutan serta zat-zat organik berbahaya yang terkandung dalam vinasse, mengubahnya menjadi pupuk organik cair."},{tag:"Tahap 4 dari 5",title:"Pengendapan (Clarifier)",subtitle:"Secondary Clarifier",waterQuality:80,camPos:[32,28,28],camLook:[30,0,18],desc:"Setelah zat organik hancur terurai, campuran air limbah dan mikroorganisme dialirkan ke bak pengendap. Gumpalan bakteri dan sisa kotoran akan dibiarkan mengendap ke dasar bak, sementara air yang sudah jernih akan terpisah dan naik ke permukaan."},{tag:"Tahap 5 dari 5",title:"Pelepasan Air Bersih (Output)",subtitle:"Clean Water Discharge",waterQuality:100,camPos:[62,30,30],camLook:[54,0,14],desc:"Air hasil pemisahan tersebut kini memiliki kadar polutan (seperti BOD dan COD) yang sangat rendah dan sudah memenuhi standar baku mutu lingkungan. Air ini dapat dikembalikan atau dilepas ke alam tanpa mencemari ekosistem sekitarnya atau dimanfaatkan menjadi pupuk organik cair."}],ke=be("intro-stage-label");let ye=-1;const Ee=11,Oe=Ee*re.length;function $e(D){return D<.5?2*D*D:-1+(4-2*D)*D}function le(D,ie,_e){return[D[0]+(ie[0]-D[0])*_e,D[1]+(ie[1]-D[1])*_e,D[2]+(ie[2]-D[2])*_e]}let st=null;const Ke=new gd,He=be("btn-intro-continue");He.disabled=!1;function Pe(){st=requestAnimationFrame(Pe);const D=Ke.getElapsedTime(),_e=D%Oe/Ee,Ae=Math.min(Math.floor(_e),re.length-1),Te=_e-Math.floor(_e),ee=(Ae+re.length-1)%re.length,R=.15;let de,he;if(Te<R){const j=$e(Te/R);de=le(re[ee].camPos,re[Ae].camPos,j),he=le(re[ee].camLook,re[Ae].camLook,j)}else{const j=re[Ae].camPos,pe=re[Ae].camLook;de=[j[0]+Math.sin(D*.26)*1.4,j[1]+Math.sin(D*.19)*.6,j[2]+Math.cos(D*.22)*1.1],he=[...pe]}if(o.position.set(de[0],de[1],de[2]),o.lookAt(he[0],he[1],he[2]),Ae!==ye&&ke){ye=Ae;const j=re[Ae],pe=j.waterQuality,nt=pe<40?"#e05020":pe<75?"#d4aa20":"#22bb55";ke.innerHTML=`<div class="sl-tag">${j.tag}</div><div class="sl-title">${j.title}</div><div class="sl-subtitle">${j.subtitle}</div><div class="sl-desc">${j.desc}</div><div class="sl-wq"><span style="font-size:11px;opacity:.75;margin-right:6px">Kualitas Air</span><div class="sl-wq-bar"><div class="sl-wq-fill" style="width:${pe}%;background:${nt}"></div></div><span class="sl-wq-val" style="color:${nt}">${pe}%</span></div><div class="sl-dots">${re.map((it,Et)=>`<span class="sl-dot${Et===Ae?" active":""}"></span>`).join("")}</div>`}F.forEach(j=>{j.userData.t=(j.userData.t+.00145)%1;const pe=j.userData.t;j.position.copy(Ue.getPoint(pe)),j.position.y=.27;const nt=(j.userData.ph+D*.32)%1;j.scale.setScalar(.4+nt*2.2),j.material.opacity=Math.max(0,.8-nt*.88);const it=Ne(8005632,1091800,pe);j.material.color.setHex(it),j.material.emissive.setHex(it)}),Rt.forEach(j=>{const pe=(D*.82+j.userData.phase)%(Math.PI*2)/(Math.PI*2);j.position.set(j.userData.ox,.22+pe*1.55,j.userData.oz),j.material.opacity=pe<.72?.7:(1-pe)*4.5}),Le.forEach(j=>{const pe=(D*.22+j.userData.phase)%1;j.position.set($+Math.cos(j.userData.ang+D*.04)*j.userData.r,1.3-pe*1.2,K+Math.sin(j.userData.ang+D*.04)*j.userData.r),j.material.opacity=pe>.75?(1-pe)*5:.72}),y.forEach((j,pe)=>{j.rotation.y=D*(1.5+pe%3*.4)}),Xe.forEach(j=>{j.userData.life=(j.userData.life+.0048)%1;const pe=j.userData.life;j.position.set(N+j.userData.ox+Math.sin(pe*4.2+D*.7)*.55,14.3+pe*8,H+j.userData.oz+Math.cos(pe*3.5+D*.5)*.55),j.scale.setScalar(.5+pe*2.8),j.material.opacity=Math.max(0,.55-pe*.62)}),w.forEach(j=>{j.userData.life=(j.userData.life+.0036)%1;const pe=j.userData.life;j.position.set(-25.5+j.userData.ox+Math.sin(pe*3.5+D)*.5,4.9+pe*5.5,6+j.userData.oz+Math.cos(pe*2.8+D*.6)*.4),j.material.opacity=Math.max(0,(1-pe)*.4),j.scale.setScalar(.18+pe*1.25)}),ue.forEach(j=>{const pe=(D*1.05+j.userData.phase)%1;j.position.set(58+j.userData.ox,3.8-pe*4.5,-5),j.material.opacity=.88*(1-pe)}),O.material.emissiveIntensity=1.2+1.5*Math.sin(D*5.8),te.forEach(j=>{const pe=(D*.58+j.userData.i*.25)%1;j.position.set(58+pe*14,10.2+Math.sin(pe*Math.PI)*5,16+pe*6),j.material.opacity=(1-pe)*.88}),I.forEach(j=>{j.mesh.material.opacity=j.baseOp+.03*Math.sin(D*.75+j.baseOp*14)}),V.material.opacity=.84+.05*Math.sin(D*1.05),ne.material.opacity=.8+.04*Math.sin(D*.68),Y.material.opacity=.75+.06*Math.sin(D*.88),s.render(r,o)}Pe(),be("btn-intro-continue").onclick=()=>{cancelAnimationFrame(st),s.dispose(),e.classList.add("hidden"),n()}}function Ad(n){be("instructions-screen").classList.remove("hidden");const e=/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1,t=be("instr-controls-text");t&&(t.innerHTML=e?"Gunakan <strong>joystick virtual</strong> di kiri bawah layar untuk bergerak. Dekati objek bercahaya lalu ketuk tombol <strong>E</strong> di kanan bawah untuk berinteraksi.":"Gunakan <kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd> atau tombol panah untuk bergerak. Dekati objek bercahaya lalu tekan <kbd>E</kbd> untuk berinteraksi.");const i=be("instr-level-guide");if(i){const a=[{num:1,icon:"🔬",name:"Lab Sains",desc:"Amati 3 fenomena pencemaran vinasse di laboratorium dan jawab pertanyaan ilmiah."},{num:2,icon:"🏭",name:"Pabrik Etanol",desc:"Kunjungi 3 stasiun pabrik, lakukan simulasi pengolahan COD/BOD/pH secara interaktif."},{num:3,icon:"🌿",name:"Kolam Remediasi",desc:"Pilih mikroorganisme yang tepat di toko, hitung dosis, lalu buka kran vinasse."},{num:4,icon:"🔧",name:"Membuat Reaktor Sederhana",desc:"Rancang prototype reaktor IPAL: pilih alat & bahan, ikuti prosedur, evaluasi hasilnya."},{num:5,icon:"🔭",name:"Lab Observasi",desc:"Analisis kegagalan reaktor dari Level 4 dan jawab soal evaluasi mikroskop."}];i.innerHTML=a.map(s=>`
    ...
    `).join("")}be("btn-start-game").onclick=()=>{be("instructions-screen").classList.add("hidden"),n()}}function _c(){Ad(()=>{});const n=be("btn-start-game");n.textContent="✕ Tutup Petunjuk"}function Ix(){Gt(),be("btn-glossary").onclick=()=>co(),be("btn-instructions-hud").onclick=()=>_c();const n=document.getElementById("btn-instructions-hud-mobile"),e=document.getElementById("btn-glossary-mobile"),t=document.getElementById("btn-pause-menu-mobile");n&&n.addEventListener("touchstart",i=>{i.preventDefault(),_c()},{passive:!1}),e&&e.addEventListener("touchstart",i=>{i.preventDefault(),co()},{passive:!1}),t&&t.addEventListener("touchstart",i=>{i.preventDefault(),be("btn-pause-menu").click()},{passive:!1})}function Ux(n,e,t){const i=be("pause-menu-overlay");be("btn-pause-menu").onclick=()=>{const a=ko(),s=be("pause-checkpoint-info"),r=be("btn-pm-resume");if(a){const o=new Date(a.savedAt),l=o.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})+" "+o.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"});s.innerHTML=`💾 Checkpoint tersimpan: <strong>${a.playerName}</strong> · Level ${a.currentLevel} · ${a.totalPoints} poin<br><small style="color:#aaa">${l}</small>`,r.disabled=!1,r.title=""}else s.innerHTML='<span style="color:#aaa">Belum ada checkpoint tersimpan.</span>',r.disabled=!0,r.title="Tidak ada checkpoint tersimpan";i.classList.remove("hidden")},be("btn-pm-continue").onclick=()=>{i.classList.add("hidden")},be("btn-pm-resume").onclick=()=>{i.classList.add("hidden"),n()},be("btn-pm-newgame").onclick=()=>{confirm("Yakin ingin memulai ulang? Semua progres sesi ini akan hilang.")&&(i.classList.add("hidden"),e())},be("btn-pm-experiment").onclick=()=>{i.classList.add("hidden"),Po()},be("btn-pm-change-level").onclick=()=>{i.classList.add("hidden"),zx(a=>{t&&t(a)})},i.addEventListener("click",a=>{a.target===i&&i.classList.add("hidden")})}function Gt(){be("hud-player").textContent=Q.playerName||"Pemain",be("hud-level").textContent=`Level ${Q.currentLevel}`,be("hud-points").textContent=Q.totalPoints;const n=be("hud-attempts");n.innerHTML="";for(let e=0;e<3;e++){const t=document.createElement("div");t.className="attempt-dot"+(e<Q.levelAttempts?" used":""),n.appendChild(t)}}function Do(n){const e=/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1;let t=be("interact-prompt");t||(t=document.createElement("div"),t.id="interact-prompt",t.style.cssText=`
  ...
  `,i.textContent="✕ Batal",i.onmouseover=()=>{i.style.background="rgba(255,60,60,.18)",i.style.color="#fff"},i.onmouseout=()=>{i.style.background="rgba(255,255,255,.08)",i.style.color="#ccc"},i.onclick=()=>e.remove(),e.appendChild(i)}function Fx(n){const e=document.getElementById("room-select-overlay");e.classList.remove("hidden");function t(){const i=document.getElementById("room-select-grid");i.innerHTML=Ox.map(s=>{const r=Q.completedRooms.includes(s.level);return`
    ...
    `,a.querySelector("#btn-room-upload-exp").onmouseenter=function(){this.style.background="rgba(21,101,192,.22)"},a.querySelector("#btn-room-upload-exp").onmouseleave=function(){this.style.background="rgba(21,101,192,.12)"},a.querySelector("#btn-room-upload-exp").onclick=()=>{e.classList.add("hidden"),Po()}}t(),e._refresh=t}function Bx(){var t;yd(Q.currentLevel),yx({playerName:Q.playerName,totalPoints:Q.totalPoints,levelBreakdown:Q.levelBreakdown,completedAt:new Date().toISOString(),essayAnswer:((t=Q.stage5)==null?void 0:t.essayAnswer)||""}),Md();const n=Q.levelBreakdown.map(i=>`
    <tr>
  ...
  `,document.body.appendChild(e),e.querySelector("#btn-gc-close").onclick=()=>{e.remove(),Gt()},e.querySelector("#btn-gc-restart").onclick=()=>{e.remove(),window.location.reload()},e.querySelector("#btn-gc-experiment").onclick=()=>{Po()}}function Ld(n,e,t,i=!1){const a=wa.phenomena[n],s=be("stage-screen");Q.wrongAnswers=0;const r=s.querySelector(".stage-panel");r&&r.remove();const o=document.createElement("div");o.className="stage-panel fade-in",o.innerHTML=`
  ...
  `,be("btn-profile-start").onclick=()=>{const t=be("input-name").value.trim();if(!t){be("input-name").style.borderColor="#e74c3c",be("input-name").focus();return}Q.playerName=t,Sd(),lo&&lo(t)},be("input-name").addEventListener("keydown",t=>{t.key==="Enter"&&be("btn-profile-start").click()}),setTimeout(()=>{const t=be("btn-close-glossary");t&&(t.onclick=()=>co());let i=1;const a=2;function s(){be("glossary-page-1").classList.toggle("hidden",i!==1),be("glossary-page-2").classList.toggle("hidden",i!==2),be("glossary-page-indicator").textContent=`${i} / ${a}`,be("btn-glossary-prev").disabled=i===1,be("btn-glossary-next").disabled=i===a;const l=be("glossary-modal").querySelector(".glossary-card");l&&(l.scrollTop=0)}be("btn-glossary-next").onclick=()=>{i<a&&(i++,s())},be("btn-glossary-prev").onclick=()=>{i>1&&(i--,s())};const r=be("glossary-modal");new MutationObserver(()=>{r.classList.contains("hidden")||(i=1,s())}).observe(r,{attributes:!0,attributeFilter:["class"]})},100)}function qx(){if(be("intro-ipal-labels-styles"))return;const n=`
  ...
  `,e=document.createElement("style");e.id="intro-ipal-labels-styles",e.textContent=n,document.head.appendChild(e)}function $x(){if(be("intro-ipal-labels-panel"))return;const n=document.createElement("div");n.id="intro-ipal-labels-panel",n.className="intro-ipal-labels-panel",n.innerHTML=`
  ...
  `;const e=be("intro-video-screen");e?e.appendChild(n):document.body.appendChild(n);const t=be("btn-close-intro-ipal-labels");t&&(t.onclick=()=>{n.style.animation="slideInTop 0.3s ease-out reverse",setTimeout(()=>n.remove(),300)})}const Fe=n=>document.getElementById(n);function Yx(n){tv();const e=Fe("sim-overlay");e&&e.remove();const t=document.createElement("div");t.id="sim-overlay",t.className="sim-overlay",t.innerHTML=jx(),document.body.appendChild(t),requestAnimationFrame(()=>{Kx(t,n)})}function jx(){return`
    <div class="sim-card">
      <!-- Header -->
  ...
  `}function Kx(n,e){let t=0,i=null,a=null,s=!1,r=null;{let se=function(){document.getElementById("vol-display-num").textContent=t,document.getElementById("vol-display-water").textContent=1e3-t},P=function(Y){const me=document.getElementById(`vglass-liq-${Y}`),fe=document.getElementById(`vglass-${Y}`);!me||!fe||(me.style.height=E[Y]/200*100+"%",E[Y]<=0&&(fe.classList.add("empty"),fe.classList.remove("dragging")))},z=function(){const Y=document.getElementById("beaker-drops");if(!Y)return;const me=document.createElement("div");me.className="sim-drop",me.style.setProperty("--spread",(Math.random()-.5)*10+"px"),me.style.setProperty("--dur",.28+Math.random()*.24+"s"),Y.appendChild(me),setTimeout(()=>me.remove(),600)},X=function(){T||y===null||(T=setInterval(()=>{if(y===null||E[y]<=0||t>=1e3){ne();return}const Y=Math.min(25,E[y],1e3-t);E[y]-=Y,t=Math.min(1e3,t+Y),Yr(t),se(),Fe("btn-titrate").disabled=!1;const me=document.getElementById("vg-ghost-liquid");me&&(me.style.height=E[y]/200*100+"%"),P(y)},80),N=setInterval(z,55))},ne=function(){clearInterval(T),clearInterval(N),T=N=null},$=function(Y,me){I.style.left=Y-18+"px",I.style.top=me-64+"px";const fe=document.getElementById("beaker-drop-zone");if(!fe)return;const Ce=fe.getBoundingClientRect(),Ue=Y>=Ce.left&&Y<=Ce.right&&me>=Ce.top&&me<=Ce.bottom;Ue!==H&&(H=Ue,fe.classList.toggle("active",Ue),I.classList.toggle("tilting",Ue),Ue?X():ne())},K=function(Y,me,fe){var Ue;if(E[Y]<=0)return;y=Y,H=!1,(Ue=document.getElementById(`vglass-${Y}`))==null||Ue.classList.add("dragging"),I.classList.remove("hidden");const Ce=document.getElementById("vg-ghost-liquid");Ce&&(Ce.style.height=E[Y]/200*100+"%"),$(me,fe)},J=function(){var me,fe;if(y===null)return;ne(),P(y),(me=document.getElementById(`vglass-${y}`))==null||me.classList.remove("dragging"),y=null,H=!1,I.classList.add("hidden"),I.classList.remove("tilting"),(fe=document.getElementById("beaker-drop-zone"))==null||fe.classList.remove("active");const Y=document.getElementById("beaker-drop-label");Y&&(Y.textContent=t>0?`✓ ${t} mL dituang — seret gelas lagi untuk menambah`:"Jatuhkan di sini")},V=function(Y){y!==null&&$(Y.clientX,Y.clientY)},Z=function(){J()},O=function(Y){y!==null&&($(Y.touches[0].clientX,Y.touches[0].clientY),Y.preventDefault())},te=function(){J()};var o=se,l=P,d=z,c=X,p=ne,f=$,h=K,g=J,x=V,m=Z,u=O,v=te;const E=Array(5).fill(200);t=0,Yr(0);const I=document.createElement("div");I.id="vg-ghost",I.className="vg-ghost hidden",I.innerHTML='<div class="vg-ghost-liquid" id="vg-ghost-liquid"></div>',document.body.appendChild(I);let y=null,T=null,N=null,H=!1;for(let Y=0;Y<5;Y++){const me=document.getElementById(`vglass-${Y}`);me&&(me.addEventListener("mousedown",fe=>{K(Y,fe.clientX,fe.clientY),fe.preventDefault()}),me.addEventListener("touchstart",fe=>{K(Y,fe.touches[0].clientX,fe.touches[0].clientY),fe.preventDefault()},{passive:!1}))}window.addEventListener("mousemove",V),window.addEventListener("mouseup",Z),window.addEventListener("touchmove",O,{passive:!1}),window.addEventListener("touchend",te),document.getElementById("btn-reset-pour").onclick=()=>{var me;J(),t=0;for(let fe=0;fe<5;fe++)E[fe]=200,P(fe),(me=document.getElementById(`vglass-${fe}`))==null||me.classList.remove("empty");Yr(0),se(),Fe("btn-titrate").disabled=!0;const Y=document.getElementById("beaker-drop-label");Y&&(Y.textContent="Jatuhkan di sini")},r=()=>{J(),window.removeEventListener("mousemove",V),window.removeEventListener("mouseup",Z),window.removeEventListener("touchmove",O),window.removeEventListener("touchend",te);const Y=document.getElementById("vg-ghost");Y&&Y.remove()}}Fe("btn-titrate").onclick=()=>{r&&(r(),r=null),i=bx(t),Ma("sim-step-1","sim-step-2"),Jx(t)},Fe("btn-go-aerate").onclick=()=>{Ma("sim-step-2","sim-step-3"),Zx(i)},Fe("btn-back-meter").onclick=()=>{Ma("sim-step-2","sim-step-1"),Fe("btn-go-aerate").classList.add("hidden"),Fe("btn-back-meter").classList.add("hidden")},Fe("aerator-toggle").onchange=function(){s=this.checked;const b=Fe("aerator-status");b.textContent=s?"NYALA":"MATI",b.className=s?"status-on":"status-off",Fe("aerator-machine").classList.toggle("running",s),Qx(s),s?Fe("duration-wrap").classList.remove("locked"):(Fe("duration-wrap").classList.add("locked"),a=null,n.querySelectorAll(".dur-btn").forEach(_=>_.classList.remove("active")),Fe("btn-calc-result").classList.add("hidden"))},n.querySelectorAll(".dur-btn").forEach(b=>{b.onclick=()=>{s&&(n.querySelectorAll(".dur-btn").forEach(_=>_.classList.remove("active")),b.classList.add("active"),a=parseInt(b.dataset.hours),Fe("btn-calc-result").classList.remove("hidden"),Fe("btn-back-aerate").classList.remove("hidden"))}}),Fe("btn-calc-result").onclick=()=>{const b=_x(i,a);Ma("sim-step-3","sim-step-4"),ev(i,b,t,a),Fe("btn-sim-finish").classList.remove("hidden"),Fe("btn-sim-finish").onclick=()=>{Fe("sim-overlay").remove(),e&&e()}},Fe("btn-back-aerate").onclick=()=>{Ma("sim-step-3","sim-step-2"),Fe("btn-calc-result").classList.add("hidden"),Fe("btn-back-aerate").classList.add("hidden"),Fe("btn-go-aerate").classList.remove("hidden"),Fe("btn-back-meter").classList.remove("hidden")}}const ws={200:{doVal:1.8,tds:22,ph:2.2,sal:13},400:{doVal:2.3,tds:26,ph:2.8,sal:13.8},600:{doVal:3.2,tds:27,ph:3,sal:14},800:{doVal:4,tds:30.1,ph:3.7,sal:15}};function kd(n){const e=[200,400,600,800];if(n<=200)return{...ws[200]};if(n>=800)return{...ws[800]};let t=200,i=800;for(let o=0;o<e.length-1;o++)if(n>e[o]&&n<=e[o+1]){t=e[o],i=e[o+1];break}const a=(n-t)/(i-t),s=ws[t],r=ws[i];return{doVal:parseFloat((s.doVal+(r.doVal-s.doVal)*a).toFixed(1)),tds:parseFloat((s.tds+(r.tds-s.tds)*a).toFixed(1)),ph:parseFloat((s.ph+(r.ph-s.ph)*a).toFixed(1)),sal:parseFloat((s.sal+(r.sal-s.sal)*a).toFixed(1))}}function Jx(n,e){const t=n/1e3*100,i=Fe("meter-bk-vinasse");i&&(i.style.height=t+"%");const a=Fe("meter-vol-label");a&&(a.textContent=n+" mL");const s=Fe("meter-bk-ripple"),r=kd(n),o=Fe("meter-probe-stick"),l=Fe("meter-beaker");let d=!1,c=null;function p(){c&&(c.remove(),c=null),window.removeEventListener("mousemove",h),window.removeEventListener("mouseup",x),window.removeEventListener("touchmove",g),window.removeEventListener("touchend",x)}function f(v){return v.changedTouches?{x:v.changedTouches[0].clientX,y:v.changedTouches[0].clientY}:v.touches?{x:v.touches[0].clientX,y:v.touches[0].clientY}:{x:v.clientX,y:v.clientY}}function h(v){if(!c)return;const{x:b,y:_}=f(v);c.style.left=b-15+"px",c.style.top=_-12+"px";const k=l.getBoundingClientRect();l.classList.toggle("drop-hover",b>=k.left&&b<=k.right&&_>=k.top&&_<=k.bottom)}function g(v){v.preventDefault(),h(v)}function x(v){if(!c)return;const{x:b,y:_}=f(v),k=l.getBoundingClientRect(),M=b>=k.left&&b<=k.right&&_>=k.top&&_<=k.bottom;p(),l.classList.remove("drop-hover"),M&&!d?(d=!0,o.classList.add("probe-dipped"),u()):o.style.opacity="1"}function m(v){if(d)return;v.preventDefault(),o.style.opacity="0.35",c=document.createElement("div"),c.className="meter-probe-ghost",c.innerHTML='<div class="mps-handle">⊕</div><div class="mps-shaft"></div><div class="mps-tip"></div>';const{x:b,y:_}=f(v);c.style.left=b-15+"px",c.style.top=_-12+"px",document.body.appendChild(c),window.addEventListener("mousemove",h),window.addEventListener("mouseup",x),window.addEventListener("touchmove",g,{passive:!1}),window.addEventListener("touchend",x)}function u(){Fe("meter-instruction").textContent="Sensor mendeteksi parameter larutan…",setTimeout(()=>{s&&(s.classList.remove("ripple-active"),s.offsetWidth,s.classList.add("ripple-active"))},300),setTimeout(()=>{Ms("mr-do",r.doVal,1200,1),Ms("mr-tds",r.tds,1200,1),Ms("mr-ph",r.ph,1200,2),Ms("mr-sal",r.sal,1200,1)},500),setTimeout(()=>{Fe("meter-instruction").textContent="✅ Pengukuran selesai — catat hasil parameter!";const v=Fe("meter-result-grid");v.innerHTML=[{icon:"💧",label:"DO",value:r.doVal.toFixed(1)+" ppm",sub:"Dissolved Oxygen",status:r.doVal<2?"danger":r.doVal<4?"warn":"good"},{icon:"📊",label:"TDS",value:r.tds.toFixed(1)+" ppm",sub:"Total Dissolved Solids",status:r.tds>30?"danger":r.tds>25?"warn":"good"},{icon:"⚗️",label:"pH",value:r.ph.toFixed(1),sub:r.ph<4?"Sangat Asam ⚠️":r.ph<6?"Asam":"Mendekati Netral",status:r.ph<4?"danger":r.ph<6?"warn":"good"},{icon:"🧂",label:"Salinometer",value:r.sal.toFixed(1)+" ‰",sub:"Kadar salinitas",status:r.sal>15?"danger":r.sal>13?"warn":"good"}].map(_=>`
      ...
      `).join(""),v.classList.remove("hidden");const b=Fe("meter-note");b.innerHTML=`⚗️ <strong>Interpretasi:</strong> Dengan ${n} mL vinasse,
        ...
        <div class="meter-source">📄 Sumber: Irmanto, et al. (2013)</div>`,b.classList.remove("hidden"),Fe("btn-go-aerate").classList.remove("hidden"),Fe("btn-back-meter").classList.remove("hidden"),setTimeout(()=>Fe("btn-go-aerate").scrollIntoView({behavior:"smooth",block:"nearest"}),100)},1800)}o.addEventListener("mousedown",m),o.addEventListener("touchstart",m,{passive:!1})}function Ms(n,e,t,i){const a=Fe(n);if(!a)return;const s=performance.now(),r=l=>1-(1-l)**2;function o(l){const d=Math.min(1,(l-s)/t);a.textContent=(e*r(d)).toFixed(i),d<1&&requestAnimationFrame(o)}requestAnimationFrame(o)}function Yr(n){const t=n/1e3*100,i=100-t,a=Fe("beaker-vinasse"),s=Fe("beaker-water");a.style.height=t+"%",a.style.bottom="0%",s.style.height=i+"%",s.style.bottom=t+"%"}function Zx(n){const e=Fe("aerator-liquid");if(!e)return;const t=Math.min(1,n.cod/45e3),i=Math.round(60+t*60),a=Math.round(20+t*5),s=0;e.style.background=`rgb(${i},${a},${s})`}function Qx(n){const e=Fe("bubble-container");if(e&&(e.innerHTML="",!!n))for(let t=0;t<14;t++){const i=document.createElement("div");i.className="bubble",i.style.left=5+Math.random()*85+"%",i.style.animationDuration=1.2+Math.random()*2+"s",i.style.animationDelay=Math.random()*2+"s",i.style.width=i.style.height=4+Math.random()*8+"px",e.appendChild(i)}}function ev(n,e,t,i){const a=Fe("results-grid"),s=Fe("compliance-banner"),r=Fe("sim-conclusion"),o=kd(t);a.innerHTML=`
  ...
  `}function Ma(n,e){const t=Fe(n),i=Fe(e);t.classList.add("step-exit"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("step-exit"),i.classList.remove("hidden"),i.classList.add("step-enter"),setTimeout(()=>i.classList.remove("step-enter"),400)},300)}function tv(){if(document.getElementById("sim-styles"))return;const n=`
    /* ── Simulation overlay ───────────────────────────── */
    .sim-overlay {
  ...
  `,document.body.appendChild(e),xe("s3-ctx").innerHTML=Ss.context,xe("s3-q").innerHTML=`<strong>❓ Pertanyaan:</strong><br>${Ss.question}`;const t=xe("s3-opts");let i=!1;Ss.options.forEach(a=>{const s=document.createElement("button");s.className="s3-option",s.innerHTML=`<strong>${a.label}.</strong> ${a.text}`,s.onclick=()=>{if(!i)if(a.correct){i=!0,s.classList.add("correct"),t.querySelectorAll(".s3-option").forEach(l=>l.disabled=!0);const r=Q.wrongAnswers??0,o=r===0?100:r<=2?50:25;Q.totalPoints+=o,Q.levelAttempts++,Gt(),wc("s3-fb",!0,Ss.explanation+`<br><br>🎉 +${o} poin tambahan!`),xe("s3-next-challenge").classList.remove("hidden")}else s.classList.add("wrong"),s.disabled=!0,Q.wrongAnswers=(Q.wrongAnswers??0)+1,Gt(),wc("s3-fb",!1,"❌ Kurang tepat. Coba pilihan lain!")},t.appendChild(s)}),xe("s3-next-challenge").onclick=()=>{Ga(),n()}}function sv(n){const e=Gs("s3-overlay");e.innerHTML=`
  ...
  `,document.body.appendChild(e);let t=null;function i(){const a=xe("s3-shop-grid");a.innerHTML="",Ca.forEach(s=>{const r=document.createElement("div");r.className="s3-micro-card",t&&s.id===t&&r.classList.add("chosen");const o=Q.totalPoints>=s.price;r.innerHTML=`
      ...
      `,a.appendChild(r)})}i(),xe("s3-shop-pts").textContent=Q.totalPoints+" poin",xe("s3-shop-grid").addEventListener("click",a=>{const s=a.target.closest(".s3-buy-btn");if(!s||s.disabled||t)return;const r=Ca.find(l=>l.id===s.dataset.id);if(!r)return;Q.totalPoints-=r.price,Gt(),xe("s3-shop-pts").textContent=Q.totalPoints+" poin";const o=xe("s3-shop-result");o.classList.remove("hidden"),r.outcome==="punishment"?(o.className="s3-shop-result punishment",o.innerHTML=r.punishmentText+"<br><br>💡 <b>Coba lagi</b> — pilih mikroorganisme yang lebih tepat!",i(),xe("s3-shop-pts").textContent=Q.totalPoints+" poin",Ca.filter(d=>d.outcome!=="punishment").some(d=>Q.totalPoints>=d.price)||(o.innerHTML+="<br><br>⛔ <b>Poin kamu tidak cukup</b> untuk membeli mikroorganisme yang tepat.",xe("s3-btn-restart").classList.remove("hidden"))):(t=r.id,o.className="s3-shop-result "+(r.outcome==="reward_high"?"reward-high":"reward-mid"),o.innerHTML=r.rewardText,i(),setTimeout(()=>xe("s3-btn-to-lab").classList.remove("hidden"),800))}),xe("s3-btn-to-lab").onclick=()=>{Ga(),n(t)},xe("s3-btn-restart").onclick=()=>{window.location.reload()}}function rv(n,e){const t=Ca.find(_=>_.id===n)||Ca[0],i=Gs("s3-overlay");i.innerHTML=`
    <div class="s3-card">
      <div class="s3-header">
  ...
  `,document.body.appendChild(i);let a=null,s=0,r=!1,o=null,l=0,d=[],c=null,p=null,f=null,h=!1,g=null;const x=6,u={azolla:"#4ecb47",nannochloropsis:"#c8b820",spirulina:"#2ab8d8",chlorella:"#38d878"}[t.id]||"#80e880";i.querySelectorAll(".s3-vol-btn").forEach(_=>{_.onclick=()=>{i.querySelectorAll(".s3-vol-btn").forEach(V=>V.classList.remove("active")),_.classList.add("active"),a=parseInt(_.dataset.vol);const k=yc(n,a);g&&(g(),g=null),s=0,r=!1,xe("s3-lab-result").classList.add("hidden"),xe("s3-btn-to-valve").classList.add("hidden"),xe("s3-spk-micro-layer").style.transition="none",xe("s3-spk-micro-layer").style.height="0%",xe("s3-pour-counter").classList.add("hidden"),xe("s3-pour-progress-wrap").classList.add("hidden"),xe("s3-pour-feedback").classList.add("hidden"),xe("s3-btn-confirm-pour").classList.add("hidden"),xe("s3-pour-hint").classList.remove("hidden"),xe("s3-poured-amt").textContent="0.0",xe("s3-pour-bar-fill").style.width="0%",k?(xe("s3-target-amt").textContent=k.total,xe("s3-target-unit").textContent=k.unit,xe("s3-poured-unit").textContent=k.unit,xe("s3-spk-target-line").style.display=""):xe("s3-spk-target-line").style.display="none",xe("s3-spk-dose-label").innerHTML=k?`Dosis yang dibutuhkan: <b>${k.total} ${k.unit}</b> untuk ${a} L vinasse`:`⛔ ${t.name} tidak cocok untuk vinasse ini`,o=k;const M=k?parseFloat(k.total):0;l=M*.25,d=Array(x).fill(l),c=null;const E=xe("s3-glass-row");if(E.innerHTML="",k)for(let V=0;V<x;V++){const Z=document.createElement("div");Z.className="s3-micro-glass",Z.id=`s3-mg-${V}`,Z.dataset.idx=String(V),Z.innerHTML=`<div class="s3-mg-liquid" id="s3-mg-liq-${V}" style="background:${u};height:85%"></div><div class="s3-mg-label">¼</div>`,E.appendChild(Z)}const I=document.getElementById("s3-mg-ghost");I&&I.remove();const y=document.createElement("div");y.id="s3-mg-ghost",y.className="s3-mg-ghost hidden",y.innerHTML=`<div class="s3-mg-ghost-liquid" id="s3-mg-ghost-liquid" style="background:${u}"></div>`,document.body.appendChild(y);function T(V){const Z=document.getElementById(`s3-mg-liq-${V}`),O=document.getElementById(`s3-mg-${V}`);!Z||!O||(Z.style.height=l>0?d[V]/l*100+"%":"0%",d[V]<=0&&(O.classList.add("empty"),O.classList.remove("dragging")))}function N(){const V=document.getElementById("s3-tank-drops");if(!V)return;const Z=document.createElement("div");Z.className="s3-mg-drop",Z.style.background=u,Z.style.setProperty("--spread",(Math.random()-.5)*10+"px"),Z.style.setProperty("--dur",.26+Math.random()*.26+"s"),V.appendChild(Z),setTimeout(()=>Z.remove(),600)}function H(){if(p||c===null||!o)return;const V=M*1.5;p=setInterval(()=>{if(c===null||d[c]<=0||s>=V){se();return}const Z=Math.max(M*.01,.001),O=Math.min(Z,d[c],V-s);d[c]-=O,s=Math.min(s+O,V),T(c),xe("s3-poured-amt").textContent=s.toFixed(1);const te=document.getElementById("s3-mg-ghost-liquid");te&&(te.style.height=l>0?d[c]/l*100+"%":"0%");const Y=Math.min(s/V,1)*30;xe("s3-spk-micro-layer").style.transition="none",xe("s3-spk-micro-layer").style.height=Y+"%",xe("s3-spk-micro-layer").style.background=u;const me=Math.min(s/V,1)*100;xe("s3-pour-bar-fill").style.width=me+"%";const fe=M>0?s/M:0;xe("s3-pour-bar-fill").style.background=fe<.7?"#20a0d0":fe<.8?"#60d060":fe<=1.2?"#00e870":fe<=1.5?"#e8a020":"#e04020"},80),f=setInterval(N,55)}function se(){clearInterval(p),clearInterval(f),p=f=null}function P(V,Z){y.style.left=V-18+"px",y.style.top=Z-60+"px";const O=document.getElementById("s3-tank-drop-zone");if(!O)return;const te=O.getBoundingClientRect(),Y=V>=te.left&&V<=te.right&&Z>=te.top&&Z<=te.bottom;Y!==h&&(h=Y,O.classList.toggle("active",Y),y.classList.toggle("tilting",Y),Y?H():se())}function z(V,Z,O){var Y;if(d[V]<=0)return;c=V,h=!1,(Y=document.getElementById(`s3-mg-${V}`))==null||Y.classList.add("dragging"),y.classList.remove("hidden");const te=document.getElementById("s3-mg-ghost-liquid");te&&(te.style.height=l>0?d[V]/l*100+"%":"85%"),r||(r=!0,xe("s3-pour-hint").classList.add("hidden"),xe("s3-pour-counter").classList.remove("hidden"),xe("s3-pour-progress-wrap").classList.remove("hidden"),xe("s3-btn-confirm-pour").classList.remove("hidden")),P(Z,O)}function X(){var Z,O;if(c===null)return;se(),T(c),(Z=document.getElementById(`s3-mg-${c}`))==null||Z.classList.remove("dragging"),c=null,h=!1,y.classList.add("hidden"),y.classList.remove("tilting"),(O=document.getElementById("s3-tank-drop-zone"))==null||O.classList.remove("active");const V=document.getElementById("s3-tank-drop-lbl");V&&(V.textContent=s>0&&o?`✓ ${s.toFixed(1)} ${o.unit} dituang`:"Jatuhkan di sini")}for(let V=0;V<x;V++){const Z=document.getElementById(`s3-mg-${V}`);Z&&(Z.addEventListener("mousedown",O=>{z(V,O.clientX,O.clientY),O.preventDefault()}),Z.addEventListener("touchstart",O=>{z(V,O.touches[0].clientX,O.touches[0].clientY),O.preventDefault()},{passive:!1}))}function ne(V){c!==null&&P(V.clientX,V.clientY)}function $(){X()}function K(V){c!==null&&(P(V.touches[0].clientX,V.touches[0].clientY),V.preventDefault())}function J(){X()}window.addEventListener("mousemove",ne),window.addEventListener("mouseup",$),window.addEventListener("touchmove",K,{passive:!1}),window.addEventListener("touchend",J),g=()=>{X(),window.removeEventListener("mousemove",ne),window.removeEventListener("mouseup",$),window.removeEventListener("touchmove",K),window.removeEventListener("touchend",J);const V=document.getElementById("s3-mg-ghost");V&&V.remove()},xe("s3-sprinkler-scene").classList.remove("hidden"),xe("s3-sprinkler-scene").scrollIntoView({behavior:"smooth",block:"nearest"})}});function v(_){const k=xe("s3-calc-grid"),M=xe("s3-lab-notes");_?(k.innerHTML=[{icon:"⚗️",label:"Volume Vinasse",value:`${a} L`},{icon:"🧫",label:"Dosis Mikro",value:`${_.total} ${_.unit}`},{icon:"⏱️",label:"Durasi Perlakuan",value:_.duration}].map(E=>`
        ...
        </div>`,M.innerHTML="⚠️ Pilihan mikroorganisme tidak valid untuk kondisi vinasse ini."),xe("s3-lab-result").classList.remove("hidden"),xe("s3-btn-to-valve").classList.remove("hidden"),xe("s3-lab-result").scrollIntoView({behavior:"smooth",block:"nearest"})}function b(){setTimeout(()=>{if(s=0,r=!1,l>0)for(let k=0;k<x;k++){d[k]=l;const M=document.getElementById(`s3-mg-liq-${k}`),E=document.getElementById(`s3-mg-${k}`);M&&(M.style.height="85%"),E&&E.classList.remove("empty","dragging")}xe("s3-spk-micro-layer").style.transition="none",xe("s3-spk-micro-layer").style.height="0%",xe("s3-poured-amt").textContent="0.0",xe("s3-pour-bar-fill").style.width="0%",xe("s3-pour-counter").classList.add("hidden"),xe("s3-pour-progress-wrap").classList.add("hidden"),xe("s3-btn-confirm-pour").classList.add("hidden"),xe("s3-pour-hint").classList.remove("hidden"),xe("s3-pour-feedback").classList.add("hidden");const _=document.getElementById("s3-tank-drop-lbl");_&&(_.textContent="Jatuhkan di sini")},2500)}xe("s3-btn-confirm-pour").onclick=()=>{const _=yc(n,a),k=xe("s3-pour-feedback");if(k.classList.remove("hidden"),xe("s3-btn-confirm-pour").classList.add("hidden"),!_){k.className="s3-pour-feedback punishment",k.innerHTML="⚠️ Mikroorganisme ini tidak cocok — hasilnya tidak optimal.",setTimeout(()=>v(null),1200);return}const M=parseFloat(_.total),E=s/M;E<.8?(k.className="s3-pour-feedback wrong",k.innerHTML=`⚠️ <b>Kurang!</b> Kamu menuangkan <b>${s.toFixed(1)} ${_.unit}</b>,
        ...
        target hanya <b>${_.total} ${_.unit}</b>. Coba lagi!`,b()):(k.className="s3-pour-feedback correct",k.innerHTML=`✅ <b>Tepat!</b> <b>${s.toFixed(1)} ${_.unit}</b> — sesuai dosis bioremediasi!`,xe("s3-spk-micro-layer").style.transition="height 1.2s ease",xe("s3-spk-micro-layer").style.height="30%",setTimeout(()=>v(_),1500))},xe("s3-btn-to-valve").onclick=()=>{g&&(g(),g=null),Ga(),e()}}function ov(n){const e=Gs("s3-overlay");e.innerHTML=`
  ...
  `,document.body.appendChild(e);let t=!1;xe("s3-btn-open-valve").onclick=()=>{if(t)return;t=!0;const i=xe("s3-valve-wheel");i.style.animation="valveSpin 0.8s ease forwards";const a=xe("s3-flow");a.innerHTML="";for(let s=0;s<8;s++){const r=document.createElement("div");r.className="s3-drop",r.style.animationDelay=s*.12+"s",r.style.left=30+Math.random()*30+"%",a.appendChild(r)}a.classList.add("flowing"),setTimeout(()=>{xe("s3-tank-liquid").style.height="75%"},600),xe("s3-btn-open-valve").disabled=!0,xe("s3-btn-open-valve").textContent="✅ Kran Terbuka",xe("s3-valve-instr").textContent="Vinasse mengalir ke reaktor bioremediasi…",setTimeout(()=>{xe("s3-level-complete").classList.remove("hidden"),xe("s3-final-pts").textContent=Q.totalPoints+" poin"},1800)},xe("s3-btn-finish").onclick=()=>{Ga(),n&&n()}}function Gs(n){const e=document.createElement("div");return e.id=n,e.className="s3-overlay",e}function Ga(){const n=xe("s3-overlay");n&&n.remove()}function wc(n,e,t){const i=xe(n);i&&(i.className="s3-feedback "+(e?"correct":"wrong"),i.innerHTML=t,i.classList.remove("hidden"))}function lv(){if(xe("s3-styles"))return;const n=`
    /* ── Overlay ─────────────────────────────────────── */
    .s3-overlay {
      position: fixed; inset: 0;
  ...
  `,e=document.createElement("style");e.id="s3-styles",e.textContent=n,document.head.appendChild(e)}function cv(){if(xe("ipal-labels-styles"))return;const n=`
    .ipal-labels-panel {
      position: fixed;
      bottom: 20px;
      left: 20px;
  ...
  `,e=document.createElement("style");e.id="ipal-labels-styles",e.textContent=n,document.head.appendChild(e)}function dv(){if(xe("ipal-labels-panel"))return;const n=document.createElement("div");n.id="ipal-labels-panel",n.className="ipal-labels-panel",n.innerHTML=`
  ...
  `,document.body.appendChild(t);const i=new Set(e.filter(r=>r.required).map(r=>r.id));function a(){const r=tt("s4-builder-grid");r.innerHTML="";for(const o of["alat","bahan"]){const l=document.createElement("div");l.className="s4-cat-label",l.textContent=o==="alat"?"🔩 ALAT":"🧪 BAHAN",r.appendChild(l),e.filter(c=>c.category===o).forEach(c=>{const p=i.has(c.id),f=document.createElement("div");f.className=`s4-item-card${p?" selected":""}`,f.dataset.id=c.id;const h=c.id.startsWith("aerator_");f.innerHTML=`
        ...
        `,f.onclick=()=>{c.required||(h&&["aerator_1","aerator_2","aerator_3"].forEach(g=>i.delete(g)),i.has(c.id)?i.delete(c.id):i.add(c.id),s(),a())},r.appendChild(f)})}}function s(){tt("s4-sel-count").textContent=`${i.size} item dipilih`;const r=i.has("aerator_3")?3:i.has("aerator_2")?2:i.has("aerator_1")?1:0,o=tt("s4-sel-aerator");r>0?(o.textContent=`💨 Aerasi: ${r} unit`,o.classList.remove("hidden")):o.classList.add("hidden")}a(),s(),tt("s4-btn-build").onclick=()=>{ra(),n([...i])}}function gv(n,e){const t=Ws();t.innerHTML=`
    <div class="s4-card">
      <div class="s4-header">
  ...
  `,document.body.appendChild(t);const i=[10,50,100],a=[...i],s=tt("s4-conc-sliders");function r(){tt("s4-conc-preview").innerHTML=a.map((h,g)=>{const x=(200*h/100).toFixed(1);return`<div class="s4-conc-pill">
    ...
    `,s.appendChild(g),document.getElementById(`s4-slider-${h}`).addEventListener("input",x=>{a[h]=parseInt(x.target.value),tt(`s4-slval-${h}`).textContent=a[h]+"%",r()})}r();let o=3;const l={1:"⚠️ 1 ulangan tidak memenuhi syarat validitas statistik.",2:"⚠️ 2 ulangan cukup minimal.",3:"✅ 3 ulangan — standar minimum penelitian ilmiah.",4:"✅ 4 ulangan — lebih baik, data makin valid.",5:"✅ 5 ulangan — sangat baik untuk replikasi!"};function d(){tt("s4-rep-feedback").innerHTML=l[o]||"",tt("s4-rep-feedback").className="s4-rep-feedback "+(o>=3?"good":"warn")}tt("s4-rep-btns").querySelectorAll(".s4-rep-btn").forEach(h=>{h.onclick=()=>{tt("s4-rep-btns").querySelectorAll(".s4-rep-btn").forEach(g=>g.classList.remove("active")),h.classList.add("active"),o=parseInt(h.dataset.rep),d()}}),d();let c=7;const p={3:"⚠️ 3 hari terlalu singkat untuk degradasi Azolla yang signifikan.",5:"🟡 5 hari: penurunan mulai terlihat tetapi belum optimal.",7:"✅ 7 hari: sesuai rekomendasi literatur (Rizky et al., 2017).",10:"✅ 10 hari: lebih optimal, terutama jika aerasi sedang.",14:"✅ 14 hari: maksimal untuk hasil terbaik pada dosis rendah."};function f(){tt("s4-dur-feedback").innerHTML=p[c]||"",tt("s4-dur-feedback").className="s4-dur-feedback "+(c>=7?"good":c>=5?"warn":"bad")}tt("s4-dur-btns").querySelectorAll(".s4-dur-btn").forEach(h=>{h.onclick=()=>{tt("s4-dur-btns").querySelectorAll(".s4-dur-btn").forEach(g=>g.classList.remove("active")),h.classList.add("active"),c=parseInt(h.dataset.day),f()}}),f(),tt("s4-btn-cfg-done").onclick=()=>{ra(),e({concentrations:[...a],repetitions:o,duration:c})}}function xv(n,e){var s;const t=Ws();t.innerHTML=`
    <div class="s4-card">
      <div class="s4-header">
  ...
  `,document.body.appendChild(t);const i=(s=Q.stage4)==null?void 0:s.concentrationCfg;i&&(tt("s4-cfg-summary").innerHTML=`
      ...
      </div>`);const a=tt("s4-proc-list");hv.forEach(r=>{const o=document.createElement("div");o.className="s4-proc-step",o.innerHTML=`
    ...
    `,a.appendChild(o)}),tt("s4-btn-proc-done").onclick=()=>{ra(),e()}}function vv(n,e){var s;const t=Ws(),i=((s=Q.stage4)==null?void 0:s.concentrationCfg)||{repetitions:3,duration:7};if(t.innerHTML=`
    <div class="s4-card">
      <div class="s4-header">
  ...
  `,document.body.appendChild(t),!n.success){tt("s4-btn-finish").onclick=()=>{ra(),Cd(e)};return}let a=!1;tt("s4-run-sim").onclick=()=>{if(a)return;a=!0,tt("s4-run-sim").disabled=!0,tt("s4-run-sim").textContent="⏳ Simulasi berjalan…";const r=tt("s4-rd-liquid"),o=tt("s4-rd-azolla");tt("s4-rd-bubbles").classList.add("active"),r.classList.add("treating"),o.classList.add("growing"),setTimeout(()=>{tt("s4-run-sim").textContent="✅ Simulasi Selesai",tt("s4-sim-results").classList.remove("hidden");const d=tt("s4-conc-tbody");d.innerHTML="",n.perConcentration.forEach((c,p)=>{const f=document.createElement("tr");f.innerHTML=`
    ...
    `).join("")}
  </div>`}function Ws(){const n=document.createElement("div");return n.id="s4-overlay",n.className="s4-overlay",n}function ra(){const n=tt("s4-overlay");n&&n.remove()}function bv(){if(tt("s4-styles"))return;const n=document.createElement("style");n.id="s4-styles",n.textContent=`
    .s4-overlay {
  ...
  `,document.body.appendChild(i),t.length>0){const s=((a=Q.stage4)==null?void 0:a.concentrationCfg)||null,r=Mi("s5-scen-list");t.forEach((o,l)=>{const d=typeof o.symptom=="function"?o.symptom(s):o.symptom,c=document.createElement("div");c.className="s5-scenario-card",c.innerHTML=`
      ...
      `,l===0&&c.classList.add("open"),r.appendChild(c)})}Mi("s5-btn-to-mcq").onclick=()=>{Xs(),n()}}function Mv(n){const e=`Dalam proyek yang telah kalian buat, limbah vinasse dari industri etanol di Bekonang memiliki karakteristik pH yang sangat asam, kadar COD dan BOD yang sangat tinggi, serta mengandung pigmen melanoidin dan senyawa fenol.
Berdasarkan konsep bioremediasi yang telah kalian pelajari, analisislah mengapa penggunaan bakteri pengurai seringkali gagal dalam memulihkan limbah vinasse ini? Selanjutnya, jelaskan mekanisme pemilihan agen biologis dapat secara efektif menurunkan kadar polutan dalam proses valorisasi limbah tersebut menjadi Pupuk Organik Cair (POC) yang aman bagi lingkungan`,t=Uo();t.innerHTML=`
  ...
  `,document.body.appendChild(t);const i=Mi("s5-essay-input"),a=Mi("s5-btn-essay-submit");i.oninput=()=>{a.disabled=i.value.trim().length<10},a.onclick=()=>{Q.stage5=Q.stage5||{},Q.stage5.essayAnswer=i.value.trim(),Tx({playerName:Q.playerName||"",essayAnswer:Q.stage5.essayAnswer,timestamp:new Date().toISOString()}),Xs(),n()}}function Sv(n){var s,r;const e=Q.stage4.reactorResult||{},t=((s=Q.stage4)==null?void 0:s.concentrationCfg)||null,i=(e.perConcentration||[]).map((o,l)=>`
    <tr>
      <td>T${l+1}</td>
      <td>${o.conc}%</td>
  ...
  `,document.body.appendChild(a),Mi("s5-btn-finish").onclick=()=>{Xs(),n&&n()}}function Io(n){return`<div class="s5-step-indicator">
    ...
    `).join("")}
  </div>`}function Uo(){const n=document.createElement("div");return n.id="s5-overlay",n.className="s5-overlay",n}function Xs(){const n=Mi("s5-overlay");n&&n.remove()}function Ev(){if(Mi("s5-styles"))return;const n=document.createElement("style");n.id="s5-styles",n.textContent=`
    .s5-overlay {
  ...
  `,document.head.appendChild(n)}const qs=document.getElementById("game-canvas"),Hn=new yo({canvas:qs,antialias:!0});Hn.setPixelRatio(Math.min(window.devicePixelRatio,2));Hn.setSize(window.innerWidth,window.innerHeight);Hn.shadowMap.enabled=!0;Hn.shadowMap.type=fo;Hn.toneMapping=Rc;Hn.toneMappingExposure=1.1;Hn.outputColorSpace=It;let si=null;const{scene:Jt}=og();lg(Jt);const{scene:Si}=gg();xg(Si);const{scene:Un}=Tg();Ag(Un);const{scene:Nn}=zg();Fg(Nn);const{scene:On}=$g();Yg(On);si=Jt;const lt=new Kt(60,window.innerWidth/window.innerHeight,.1,1e3);lt.position.set(0,18,38);lt.lookAt(0,0,0);const dt=new mx(Jt);let Oa=xd(Jt),Ra=null,Pa=null,Da=null,ri=Oa;function No(n,e){var t,i;n&&(n.glowMesh&&(e.remove(n.glowMesh),(t=n.glowMesh.geometry)==null||t.dispose()),n.glowMat&&n.glowMat.dispose(),n.doneSprite&&(e.remove(n.doneSprite),(i=n.doneSprite.material)==null||i.dispose()))}const Mc=22,Sc=26,Ec=24,Tc=22,Ac=21,Lc=14,jr=.08;let oa=!1,Ea=null,uo=!1,Ia=0,hi=Math.PI,kc=Math.PI,Kr=0,Ei=27,Ti=17;function Tv(n,e){Ei=n,Ti=e}function Av(n){if(!oa){Kr+=.0012,lt.position.x=Math.sin(Kr)*38,lt.position.z=Math.cos(Kr)*38,lt.position.y=18+Math.sin(n*.3)*1.5,lt.lookAt(0,2,0);return}const e=dt.position.x,t=dt.position.z;if(uo&&Ea){Ia=Math.min(1,Ia+.04);const l=1-Math.pow(1-Ia,3),d=Ea.x,c=Ea.z,p=Ea.y??4,f=d+(e-d)*.35,h=c+(t-c)*.35,g=p+6,x=Q.currentLevel===2?Sc:Q.currentLevel===3?Ec:Q.currentLevel===4?Tc:Q.currentLevel===5?Ac:Mc,m=e+Math.sin(hi)*x,u=t+Math.cos(hi)*x,v=Lc;lt.position.x=m+(f-m)*l,lt.position.y=v+(g-v)*l,lt.position.z=u+(h-u)*l,lt.fov=60-20*l,lt.updateProjectionMatrix(),lt.lookAt(d,p,c);return}Math.abs(lt.fov-60)>.5&&(lt.fov+=(60-lt.fov)*.1,lt.updateProjectionMatrix()),kc=(dt.group?dt.group.rotation.y:hi)+Math.PI;let a=kc-hi;for(;a>Math.PI;)a-=Math.PI*2;for(;a<-Math.PI;)a+=Math.PI*2;hi+=a*.04;const s=Q.currentLevel===2?Sc:Q.currentLevel===3?Ec:Q.currentLevel===4?Tc:Q.currentLevel===5?Ac:Mc;let r=e+Math.sin(hi)*s,o=t+Math.cos(hi)*s;r=Math.max(-Ei,Math.min(Ei,r)),o=Math.max(-Ti,Math.min(Ti,o)),lt.position.x+=(r-lt.position.x)*jr,lt.position.z+=(o-lt.position.z)*jr,lt.position.y+=(Lc-lt.position.y)*jr,lt.lookAt(e,3,t)}function Lv(){const n=new L(dt.position.x-lt.position.x,0,dt.position.z-lt.position.z).normalize(),e=new L().crossVectors(n,new L(0,1,0)).normalize();return{fwd:n,right:e}}const kv=6.5;let Ot=null,on=!1;function Cv(){if(on)return;let n=null,e=1/0;for(const t of ri){if(t.done)continue;const i=dt.position.x-t.pos.x,a=dt.position.z-t.pos.z,s=Math.sqrt(i*i+a*a);s<kv&&s<e&&(e=s,n=t)}if(n!==Ot){Ot=n;const t=Q.currentLevel===2?`Tekan <kbd>E</kbd> &nbsp;— 🏭 Stasiun ${n?n.idx+1:""}`:Q.currentLevel===3?"Tekan <kbd>E</kbd> &nbsp;— 🚰 Buka Kran Vinasse":Q.currentLevel===4?"Tekan <kbd>E</kbd> &nbsp;— 💻 IPAL Builder Terminal":Q.currentLevel===5?"Tekan <kbd>E</kbd> &nbsp;— 🔬 Analisis Mikroskop":`Tekan <kbd>E</kbd> &nbsp;— ❓ Fenomena ${n?n.idx+1:""}`;Do(n?t:null)}}window.addEventListener("keydown",n=>{n.code==="KeyE"&&Ot&&!on&&oa&&Rd(Ot)});document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("btn-interact-mobile");n&&n.addEventListener("touchstart",e=>{e.preventDefault(),Ot&&!on&&oa&&Rd(Ot)},{passive:!1})});function Rd(n){on=!0,Do(null),Ea=n.pos?{x:n.pos.x,y:3,z:n.pos.z}:{x:0,y:3,z:0},uo=!0,Ia=0;function e(){uo=!1,Ia=0}if(Q.currentLevel===3&&n.isValve){iv(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,Q.stage3.valveOpened=!0,setTimeout(()=>Sa(()=>Ta(3)),600)});return}if(Q.currentLevel===4&&n.isTerminal){Cd(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,Q.stage4.terminalDone=!0,setTimeout(()=>Sa(()=>Ta(4)),600)});return}if(Q.currentLevel===5&&n.isScope){yv(()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.opacity=.3,e(),on=!1,Ot=null,Q.stage5.scopeDone=!0,setTimeout(()=>Sa(()=>Ta(5)),600)});return}Nx(n.idx,()=>{n.done=!0,n.doneSprite.visible=!0,n.glowMat.color.set(3066993),n.glowMat.emissive.set(3066993),n.glowMat.emissiveIntensity=.2,e(),on=!1,Ot=null,ri.every(i=>i.done)&&Q.currentLevel===1&&setTimeout(()=>Sa(()=>Ta(1)),600)},()=>{e(),on=!1,Ot=null})}function Ta(n){if(Q.completedRooms.includes(n)||Q.completedRooms.push(n),Sx(n),Mx({playerName:Q.playerName,currentLevel:n,totalPoints:Q.totalPoints,levelBreakdown:Q.levelBreakdown,completedRooms:Q.completedRooms}),Q.completedRooms.length>=5){Bx();return}po()}function po(){on=!0,Ot=null,Do(null),Fx(n=>{on=!1,Pd(n)})}function Pd(n){Q.currentLevel=n,Q.pointsAtLevelStart=Q.totalPoints,n===1?Rv():n===2?Pv():n===3?Dv():n===4?Iv():n===5&&Uv()}function Rv(){[Jt,Si,Un,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Jt),dt.position.set(0,0,12),si=Jt,Oa=xd(Jt),ri=Oa,Tv(27,17),Ot=null,Gt()}function Pv(){si=Si,rx(),Ei=30,Ti=20,[Jt,Un,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Si),dt.position.set(0,0,18),ri=[],Ot=null,Gt(),setTimeout(()=>Yx(()=>{setTimeout(()=>Sa(()=>Ta(2)),600)}),400)}function Dv(){si=Un,ox(),Ei=26,Ti=21,[Jt,Si,Nn,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Un),dt.position.set(0,0,16),No(Ra,Un),Ra=Ng(Un),ri=[Ra],Ot=null,Gt()}function Iv(){si=Nn,dx(),Ei=24,Ti=18,[Jt,Si,Un,On].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(Nn),dt.position.set(0,0,14),No(Pa,Nn),Pa=Xg(Nn),ri=[Pa],Ot=null,Gt()}function Uv(){si=On,ux(),Ei=22,Ti=16,[Jt,Si,Un,Nn].forEach(n=>{try{dt.removeFromScene(n)}catch{}}),dt.addToScene(On),dt.position.set(0,0,12),No(Da,On),Da=ex(On),ri=[Da],Ot=null,Gt()}window.addEventListener("resize",()=>{Hn.setSize(window.innerWidth,window.innerHeight),lt.aspect=window.innerWidth/window.innerHeight,lt.updateProjectionMatrix()});qs.addEventListener("touchstart",n=>n.preventDefault(),{passive:!1});qs.addEventListener("touchmove",n=>n.preventDefault(),{passive:!1});qs.addEventListener("touchend",n=>n.preventDefault(),{passive:!1});Xx();function Dd(){oa=!0,document.getElementById("hud").style.display="block",Ix(),Gt(),Ux(()=>{const n=ko();n&&(Q.completedRooms=n.completedRooms||[],Q.totalPoints=n.totalPoints,Q.levelBreakdown=n.levelBreakdown||[],Gt()),po()},()=>{location.reload()},Pd),dt.addToScene(Jt),dt.position.set(0,0,12),si=Jt,ri=Oa,po()}function Nv(n){Q.playerName=n.playerName,Q.totalPoints=n.totalPoints,Q.levelBreakdown=n.levelBreakdown||[],Q.completedRooms=n.completedRooms||[],Q.pointsAtLevelStart=n.totalPoints,dt.setName(Q.playerName),Dd()}kx(n=>{dt.setName(n),Cx(()=>{Px(()=>{Dx(()=>{Ad(()=>{Dd()})})})})},n=>{Nv(n)});const Ov=new gd;function Id(){requestAnimationFrame(Id);const n=Ov.getElapsedTime();Av(n),dt.update(n,on||!oa,Lv()),oa&&Cv(),Q.currentLevel===1?mg(Oa,n):Q.currentLevel===3&&Ra?Og(Ra,n):Q.currentLevel===4&&Pa?qg(Pa,n):Q.currentLevel===5&&Da&&tx(Da,n),Hn.render(si,lt)}Id();
